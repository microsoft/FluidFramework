...
|  [IDocHeadingParameters](docs/api-markdown-documenter#idocheadingparameters-TypeAlias) |  | Constructor parameters for [DocHeading](docs/api-markdown-documenter/docheading)<!-- -->. |
...
|  [getHeadingForApiItem(apiItem, config, headingLevel)](docs/api-markdown-documenter#getheadingforapiitem-Function) |  | [Heading](docs/api-markdown-documenter/heading) | Generates a [Heading](docs/api-markdown-documenter/heading) for the specified API item. |
