...
import type * as old from "@fluidframework/fluid-runner-previous/legacy";

import type * as current from "@fluidframework/fluid-runner/legacy";
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Function_createFluidRunnerContainerAndExecute": {"backCompat": false}
 */
declare type current_as_old_for_Function_createFluidRunnerContainerAndExecute = requireAssignableTo<TypeOnly<typeof current.createFluidRunnerContainerAndExecute>, TypeOnly<typeof old.createFluidRunnerContainerAndExecute>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Function_createFluidRunnerLogger": {"backCompat": false}
 */
declare type current_as_old_for_Function_createFluidRunnerLogger = requireAssignableTo<TypeOnly<typeof current.createFluidRunnerLogger>, TypeOnly<typeof old.createFluidRunnerLogger>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IFileLoggerTelemetryOptions": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IFileLoggerTelemetryOptions = requireAssignableTo<TypeOnly<old.IFileLoggerTelemetryOptions>, TypeOnly<current.IFileLoggerTelemetryOptions>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IFileLoggerTelemetryOptions": {"backCompat": false}
 */
declare type current_as_old_for_Interface_IFileLoggerTelemetryOptions = requireAssignableTo<TypeOnly<current.IFileLoggerTelemetryOptions>, TypeOnly<old.IFileLoggerTelemetryOptions>>
