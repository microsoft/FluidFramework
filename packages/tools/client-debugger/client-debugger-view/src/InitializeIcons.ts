 ...
 * FluentUI reports errors if this is called more than once, but as this library exports multiple entry-points, it is impossible to say which module needs to call this.
 */
