...
class DataStructureAnalyzer implements IMessageAnalyzer {
    ...
    private readonly chunkMap = new Map<string, [string[], number]>();
...
function processOp(
    ...
    chunkMap: Map<string, [string[], number]>) {
