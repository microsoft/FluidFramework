...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/devtools-core`.

Import the `beta` APIs from `@fluidframework/devtools-core/beta`.

Import the `alpha` APIs from `@fluidframework/devtools-core/alpha`.

## API Documentation

Read the **@fluidframework/devtools-core** API documentation at <https://fluidframework.com/docs/apis/devtools-core>.
