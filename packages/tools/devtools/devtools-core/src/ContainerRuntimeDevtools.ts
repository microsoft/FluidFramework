...
export interface ContainerRuntimeProps {
	...
	/**
	 * Optional label for the container runtime replacing the guid generated by
	 * {@link @fluidframework/container-runtime#IContainerRuntime.generateDocumentUniqueId}.
	 */
	label?: string;
}
...
/**
 * Implementation of {@link DecomposedContainer} that wraps an
 * {@link @fluidframework/container-runtime-definitions/internal#IContainerRuntime}.
 * @remarks
 * This class provides a bridge between
 * {@link @fluidframework/container-runtime-definitions/internal#IContainerRuntime} and the devtools system
 * by exposing runtime properties and events.
 */
