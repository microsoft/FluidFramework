...
import type * as old from "@fluidframework/devtools-core-previous/alpha";

import type * as current from "@fluidframework/devtools-core/alpha";
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Function_initializeDevtoolsAlpha": {"backCompat": false}
 */
declare type current_as_old_for_Function_initializeDevtoolsAlpha = requireAssignableTo<TypeOnly<typeof current.initializeDevtoolsAlpha>, TypeOnly<typeof old.initializeDevtoolsAlpha>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_FluidContainerDevtoolsProps": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_FluidContainerDevtoolsProps = requireAssignableTo<TypeOnly<old.FluidContainerDevtoolsProps>, TypeOnly<current.FluidContainerDevtoolsProps>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_FluidDevtoolsAlpha": {"backCompat": false}
 */
declare type current_as_old_for_Interface_FluidDevtoolsAlpha = requireAssignableTo<TypeOnly<current.FluidDevtoolsAlpha>, TypeOnly<old.FluidDevtoolsAlpha>>
