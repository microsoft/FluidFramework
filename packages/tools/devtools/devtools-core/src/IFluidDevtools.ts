...
export interface IFluidDevtools extends IDisposable {
	 ...
	 *
	 * @throws Will throw if devtools have already been registered for the specified id generated by {@link @fluidframework/datastore-definitions#IFluidDataStoreContext.generateDocumentUniqueId}.
	 */
	registerContainerRuntime(props: ContainerRuntimeProps): void;
