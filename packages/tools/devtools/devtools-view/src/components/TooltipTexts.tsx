...
/**
 * Description of the "Status" property in the summary view.
 * @param label - The label for the devtools instance (e.g., "Container", "Container Runtime")
 */
...
/**
 * Description of what Container Runtime is.
 */
export const containerRuntimeInfoTooltipText = (
	<div>
		{
			"Container Runtime is the collaborative runtime environment within a Container. It provides the infrastructure for data synchronization and manages the lifecycle of collaborative components."
		}
	</div>
);
