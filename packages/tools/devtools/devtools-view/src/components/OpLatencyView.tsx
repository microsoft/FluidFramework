	...
	React.useEffect(() => {
		...
		const inboundMessageHandlers: InboundHandlers = {
			[TelemetryEvent.MessageType]: async (untypedMessage) => {
				...
				// We skip telemetry events that are not related to op roundtrip time and ignore events from the summarizer, since op latency is focused on ops generated by the user
