...
export function LandingView(): React.ReactElement {
	return (
		<div>
			...
			<p>
				The <b>Telemetry</b> page lets you look at the telemetry events being generated by
			...
			<p>
				The <b>Op Latency</b> page shows a chart with latency statistics for every op
				generated by the local client.
			</p>
