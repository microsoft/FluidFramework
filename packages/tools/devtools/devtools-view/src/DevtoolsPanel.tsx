...
export interface DevtoolsPanelProps {
	...
	/**
	 * The version of the devTools extension to be passed into the logger. Optional because this prop is not required
	 * in the devtools-example app, just the extension.
	 */
...
export function DevtoolsPanel(props: DevtoolsPanelProps): React.ReactElement {
	const { usageTelemetryLogger, messageRelay, extensionVersion } = props;

	return (
		<MessageRelayContext.Provider value={messageRelay}>
			<DevtoolsView
				usageTelemetryLogger={usageTelemetryLogger}
