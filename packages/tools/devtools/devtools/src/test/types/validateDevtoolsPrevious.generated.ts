 ...
 */
import type * as old from "@fluidframework/devtools-previous";
...
declare function use_current_RemovedClassDeclaration_DevtoolsLogger(
    use: TypeOnly<current.DevtoolsLogger>): void;
use_current_RemovedClassDeclaration_DevtoolsLogger(
...
*/
declare function get_current_RemovedClassDeclaration_DevtoolsLogger():
...
use_old_ClassDeclaration_DevtoolsLogger(
    get_current_RemovedClassDeclaration_DevtoolsLogger());
