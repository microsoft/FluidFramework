...
export function useMyClientId(clientDebugger: IFluidClientDebugger): string | undefined {
    const [myClientId, setMyClientId] = React.useState<string | undefined>(clientDebugger.getMyClientId());
...
export function useMyAudienceData(clientDebugger: IFluidClientDebugger): IClient | undefined {
    ...
    const [audienceMembers, setAudienceMembers] = React.useState<Map<string, IClient>>(clientDebugger.getAudienceMembers());
