...
/**
 * React-agnostic entrypoint that takes in the target html element and append a DOM element on it,
 * then does the work of mounting the rendered component into that DOM element. Will fast return false
