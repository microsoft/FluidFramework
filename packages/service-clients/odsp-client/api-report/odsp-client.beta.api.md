...
export class OdspClient {
    ...
    createContainer<T extends ContainerSchema>(containerSchema: T, oldestSupportedClient: Exclude<OldestSupportedClientVersion, `1.${string}`>): Promise<{
    ...
    getContainer<T extends ContainerSchema>(id: string, containerSchema: T, oldestSupportedClient: Exclude<OldestSupportedClientVersion, `1.${string}`>): Promise<{
        container: IOdspFluidContainer<T>;
        services: OdspContainerServices;
    }>;
    // @deprecated
