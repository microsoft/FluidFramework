...
export class OdspClient {
    ...
    createContainer<T extends ContainerSchema>(containerSchema: T, oldestSupportedClient: OldestSupportedClientVersion): Promise<{
    ...
    getContainer<T extends ContainerSchema>(id: string, containerSchema: T, oldestSupportedClient: OldestSupportedClientVersion): Promise<{
        container: IOdspFluidContainer<T>;
        services: OdspContainerServices;
    }>;
    // @deprecated
