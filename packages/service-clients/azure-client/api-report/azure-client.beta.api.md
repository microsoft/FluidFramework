...
export class AzureClient {
    ...
    createContainer<const TContainerSchema extends ContainerSchema>(containerSchema: TContainerSchema, minDocumentRuntimeVersion: MinDocumentRuntimeVersion): Promise<{
    ...
    viewContainerVersion<TContainerSchema extends ContainerSchema>(id: string, containerSchema: TContainerSchema, version: AzureContainerVersion, minDocumentRuntimeVersion: MinDocumentRuntimeVersion): Promise<{
        container: IFluidContainer<TContainerSchema>;
    }>;
    // @deprecated
