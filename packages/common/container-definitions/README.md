...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/container-definitions`.

Import the `legacy` APIs from `@fluidframework/container-definitions/legacy`.
