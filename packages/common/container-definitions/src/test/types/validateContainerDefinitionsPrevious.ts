...
declare function use_current_RemovedInterfaceDeclaration_ICodeLoader(
    use: TypeOnly<current.ICodeLoader>);
use_current_RemovedInterfaceDeclaration_ICodeLoader(
...
*/
declare function get_current_RemovedInterfaceDeclaration_ICodeLoader():
...
use_old_InterfaceDeclaration_ICodeLoader(
    get_current_RemovedInterfaceDeclaration_ICodeLoader());
