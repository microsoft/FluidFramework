 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Enum_BindState": {"forwardCompat": false}
 */
declare type old_as_current_for_Enum_BindState = requireAssignableTo<TypeOnly<old.BindState>, TypeOnly<current.BindState>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Enum_BindState": {"backCompat": false}
 */
declare type current_as_old_for_Enum_BindState = requireAssignableTo<TypeOnly<current.BindState>, TypeOnly<old.BindState>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_ICodeAllowList": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_ICodeAllowList = requireAssignableTo<TypeOnly<old.ICodeAllowList>, TypeOnly<current.ICodeAllowList>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_ICodeAllowList": {"backCompat": false}
 */
declare type current_as_old_for_Interface_ICodeAllowList = requireAssignableTo<TypeOnly<current.ICodeAllowList>, TypeOnly<old.ICodeAllowList>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_ICodeLoader": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_ICodeLoader = requireAssignableTo<TypeOnly<old.ICodeLoader>, TypeOnly<current.ICodeLoader>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_ICodeLoader": {"backCompat": false}
 */
declare type current_as_old_for_Interface_ICodeLoader = requireAssignableTo<TypeOnly<current.ICodeLoader>, TypeOnly<old.ICodeLoader>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IDeltaHandlerStrategy": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IDeltaHandlerStrategy = requireAssignableTo<TypeOnly<old.IDeltaHandlerStrategy>, TypeOnly<current.IDeltaHandlerStrategy>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IDeltaHandlerStrategy": {"backCompat": false}
 */
declare type current_as_old_for_Interface_IDeltaHandlerStrategy = requireAssignableTo<TypeOnly<current.IDeltaHandlerStrategy>, TypeOnly<old.IDeltaHandlerStrategy>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IDeltaManager": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IDeltaManager = requireAssignableTo<TypeOnly<old.IDeltaManager<never,never>>, TypeOnly<current.IDeltaManager<never,never>>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IDeltaManagerEvents": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IDeltaManagerEvents = requireAssignableTo<TypeOnly<old.IDeltaManagerEvents>, TypeOnly<current.IDeltaManagerEvents>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IDeltaQueue": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IDeltaQueue = requireAssignableTo<TypeOnly<old.IDeltaQueue<never>>, TypeOnly<current.IDeltaQueue<never>>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IDeltaQueueEvents": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IDeltaQueueEvents = requireAssignableTo<TypeOnly<old.IDeltaQueueEvents<never>>, TypeOnly<current.IDeltaQueueEvents<never>>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IDeltaSender": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IDeltaSender = requireAssignableTo<TypeOnly<old.IDeltaSender>, TypeOnly<current.IDeltaSender>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IFluidTokenProvider": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IFluidTokenProvider = requireAssignableTo<TypeOnly<old.IFluidTokenProvider>, TypeOnly<current.IFluidTokenProvider>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IFluidTokenProvider": {"backCompat": false}
 */
declare type current_as_old_for_Interface_IFluidTokenProvider = requireAssignableTo<TypeOnly<current.IFluidTokenProvider>, TypeOnly<old.IFluidTokenProvider>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IProvideFluidTokenProvider": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IProvideFluidTokenProvider = requireAssignableTo<TypeOnly<old.IProvideFluidTokenProvider>, TypeOnly<current.IProvideFluidTokenProvider>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IProvideFluidTokenProvider": {"backCompat": false}
 */
declare type current_as_old_for_Interface_IProvideFluidTokenProvider = requireAssignableTo<TypeOnly<current.IProvideFluidTokenProvider>, TypeOnly<old.IProvideFluidTokenProvider>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Variable_IFluidTokenProvider": {"backCompat": false}
 */
declare type current_as_old_for_Variable_IFluidTokenProvider = requireAssignableTo<TypeOnly<typeof current.IFluidTokenProvider>, TypeOnly<typeof old.IFluidTokenProvider>>
