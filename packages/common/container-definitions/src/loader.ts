...
export interface IContainer extends IEventProvider<IContainerEvents> {
	 ...
	 * container. This string should not be inspected or modified, as we make no grantees about the stability of its content.
	 * That said, we will support strings generated by pervious versions, we just do not support the content itself being leveraged.
	 *
