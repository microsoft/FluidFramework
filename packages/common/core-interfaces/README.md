...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/core-interfaces`.

Import the `legacy` APIs from `@fluidframework/core-interfaces/legacy`.

## API Documentation

Read the **@fluidframework/core-interfaces** API documentation at <https://fluidframework.com/docs/apis/core-interfaces>.
