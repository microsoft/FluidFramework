 ...
 */
/*
 * THIS *WAS* AN AUTOGENERATED FILE. DO NOT EDIT THIS FILE DIRECTLY.
 *
 * Automatic generation has been disabled as fluid-type-test-generator
 * has no support for BindingElement_s. The introduction of
 *   import events_pkg from "events_pkg";
 *   export const { EventEmitter } = events_pkg;
 * in typedEventEmitter.ts is leading to:
 *    Error: Unknown Export Kind: BindingElement
 * While events_pkg is in place change above lines to
 *    import { EventEmitter } from "events_pkg";
 * temporary to allow regeneration.
 *
