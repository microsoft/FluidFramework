...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/odsp-doclib-utils`.

Import the `legacy` APIs from `@fluidframework/odsp-doclib-utils/legacy`.

## API Documentation

Read the **@fluidframework/odsp-doclib-utils** API documentation at <https://fluidframework.com/docs/apis/odsp-doclib-utils>.
