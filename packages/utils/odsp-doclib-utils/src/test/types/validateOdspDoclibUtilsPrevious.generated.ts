...
import type * as old from "@fluidframework/odsp-doclib-utils-previous";
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IClientConfig": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IClientConfig = requireAssignableTo<TypeOnly<old.IClientConfig>, TypeOnly<current.IClientConfig>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IClientConfig": {"backCompat": false}
 */
declare type current_as_old_for_Interface_IClientConfig = requireAssignableTo<TypeOnly<current.IClientConfig>, TypeOnly<old.IClientConfig>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IFacetCodes": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IFacetCodes = requireAssignableTo<TypeOnly<old.IFacetCodes>, TypeOnly<current.IFacetCodes>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IFacetCodes": {"backCompat": false}
 */
declare type current_as_old_for_Interface_IFacetCodes = requireAssignableTo<TypeOnly<current.IFacetCodes>, TypeOnly<old.IFacetCodes>>
