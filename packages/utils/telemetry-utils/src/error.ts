...
/**
 * A subset of {@link ISequencedDocumentMessage} properties that are safe to log for telemetry.
 */
...
export class DataProcessingError extends LoggingError implements IErrorBase, IFluidErrorBase {
	 ...
	 *
	 * @remarks See {@link wrapOrAnnotateError} for details on wrapping behavior.
	 *
