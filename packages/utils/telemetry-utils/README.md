...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/telemetry-utils`.

Import the `legacy` APIs from `@fluidframework/telemetry-utils/legacy`.

## API Documentation

Read the **@fluidframework/telemetry-utils** API documentation at <https://fluidframework.com/docs/apis/telemetry-utils>.
