...
export declare function getDriveItemByRootFileName(server: string, account: string, path: string, authRequestInfo: IOdspAuthRequestInfo, create: boolean): Promise<IOdspDriveItem>;
