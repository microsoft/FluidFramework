...
import { IRequestResult } from "./odspRequest";
 ...
 */
export declare function authRequestWithRetry(authRequestInfo: IOdspAuthRequestInfo, requestCallback: (config: AxiosRequestConfig) => Promise<any>): Promise<IRequestResult>;
