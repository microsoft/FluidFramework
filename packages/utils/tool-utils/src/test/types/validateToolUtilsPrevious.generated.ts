 ...
 */
declare type old_as_current_for_Class_OdspTokenManager = requireAssignableTo<
 ...
 */
declare type current_as_old_for_Class_OdspTokenManager = requireAssignableTo<
	TypeOnly<current.OdspTokenManager>,
	TypeOnly<old.OdspTokenManager>
>;
 ...
 */
declare type current_as_old_for_ClassStatics_OdspTokenManager =
	requireAssignableTo<
		TypeOnly<typeof current.OdspTokenManager>,
		TypeOnly<typeof old.OdspTokenManager>
	>;
 ...
 */
declare type current_as_old_for_Function_getNormalizedSnapshot =
	requireAssignableTo<
 ...
 */
declare type current_as_old_for_Function_loadRC = requireAssignableTo<
 ...
 */
declare type current_as_old_for_Function_lockRC = requireAssignableTo<
 ...
 */
declare type current_as_old_for_Function_saveRC = requireAssignableTo<
 ...
 */
declare type old_as_current_for_Interface_IAsyncCache = requireAssignableTo<
	TypeOnly<old.IAsyncCache<never, never>>,
	TypeOnly<current.IAsyncCache<never, never>>
>;
 ...
 */
declare type current_as_old_for_Interface_IAsyncCache = requireAssignableTo<
	TypeOnly<current.IAsyncCache<never, never>>,
	TypeOnly<old.IAsyncCache<never, never>>
>;
 ...
 */
declare type old_as_current_for_Interface_IOdspTokenManagerCacheKey =
	requireAssignableTo<
 ...
 */
declare type current_as_old_for_Interface_IOdspTokenManagerCacheKey =
	requireAssignableTo<
		TypeOnly<current.IOdspTokenManagerCacheKey>,
		TypeOnly<old.IOdspTokenManagerCacheKey>
	>;
 ...
 */
declare type old_as_current_for_Interface_ISnapshotNormalizerConfig =
	requireAssignableTo<
 ...
 */
declare type current_as_old_for_Interface_ISnapshotNormalizerConfig =
	requireAssignableTo<
		TypeOnly<current.ISnapshotNormalizerConfig>,
		TypeOnly<old.ISnapshotNormalizerConfig>
	>;
 ...
 */
declare type old_as_current_for_TypeAlias_OdspTokenConfig = requireAssignableTo<
 ...
 */
declare type current_as_old_for_TypeAlias_OdspTokenConfig = requireAssignableTo<
	TypeOnly<current.OdspTokenConfig>,
	TypeOnly<old.OdspTokenConfig>
>;
 ...
 */
declare type current_as_old_for_Variable_gcBlobPrefix = requireAssignableTo<
 ...
 */
declare type current_as_old_for_Variable_getMicrosoftConfiguration =
	requireAssignableTo<
 ...
 */
declare type current_as_old_for_Variable_odspTokensCache = requireAssignableTo<
