...
import type * as current from "@fluidframework/tool-utils/internal";
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_LoginCredentials": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_LoginCredentials = requireAssignableTo<TypeOnly<old.LoginCredentials>, TypeOnly<current.LoginCredentials>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_LoginCredentials": {"backCompat": false}
 */
declare type current_as_old_for_Interface_LoginCredentials = requireAssignableTo<TypeOnly<current.LoginCredentials>, TypeOnly<old.LoginCredentials>>
