 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "TypeAlias_LoginCredentials": {"backCompat": false}
 */
declare type current_as_old_for_TypeAlias_LoginCredentials = requireAssignableTo<TypeOnly<current.LoginCredentials>, TypeOnly<old.LoginCredentials>>
