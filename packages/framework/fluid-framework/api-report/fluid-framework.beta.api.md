...
// @public
type ImplicitAllowedTypesUnsafe = AllowedTypesUnsafe | TreeNodeSchemaUnsafe;
...
// @public @sealed
export interface ReadonlyArrayNode<out T = TreeNode | TreeLeafValue> extends ReadonlyArray<T>, TreeNode {
}
...
export class SchemaFactory<out TScope extends string | undefined = string | undefined, TName extends number | string = string> {
    ...
    arrayRecursive<const Name extends TName, const T extends Unenforced<ImplicitAllowedTypes>>(name: Name, allowedTypes: T): TreeNodeSchemaClassUnsafe<ScopedSchemaName<TScope, Name>, NodeKind.Array, TreeArrayNodeUnsafe<T> & WithTypeUnsafe<ScopedSchemaName<TScope, Name>, NodeKind.Array, unknown>, {
...
// @public
export interface WithTypeUnsafe<out TName extends string = string, out TKind extends NodeKind = NodeKind, out TInfo = unknown> {
    // @deprecated
    get [typeNameSymbol](): TName;
    get [typeSchemaSymbol](): TreeNodeSchemaClassUnsafe<TName, TKind, TreeNode | TreeLeafValue, never, boolean, TInfo>;
}
