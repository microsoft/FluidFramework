...
export class SchemaFactoryAlpha<out TScope extends string | undefined = string | undefined, TName extends number | string = string> extends SchemaFactory<TScope, TName> {
    ...
    static readonly leaves: readonly [LeafSchema<"string", string> & SimpleLeafNodeSchema_2, LeafSchema<"number", number> & SimpleLeafNodeSchema_2, LeafSchema<"boolean", boolean> & SimpleLeafNodeSchema_2, LeafSchema<"null", null> & SimpleLeafNodeSchema_2, LeafSchema<"handle", IFluidHandle_2<unknown>> & SimpleLeafNodeSchema_2];
    readonly leaves: readonly [LeafSchema<"string", string> & SimpleLeafNodeSchema_2, LeafSchema<"number", number> & SimpleLeafNodeSchema_2, LeafSchema<"boolean", boolean> & SimpleLeafNodeSchema_2, LeafSchema<"null", null> & SimpleLeafNodeSchema_2, LeafSchema<"handle", IFluidHandle_2<unknown>> & SimpleLeafNodeSchema_2];
