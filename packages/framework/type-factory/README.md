...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/type-factory`.

Import the `alpha` APIs from `@fluidframework/type-factory/alpha`.

## API Documentation

Read the **@fluidframework/type-factory** API documentation at <https://fluidframework.com/docs/apis/type-factory>.
