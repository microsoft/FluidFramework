...
```bash
npm i @fluid-experimental/oldest-client-observer
```
...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluid-experimental/oldest-client-observer`.

Import the `legacy` APIs from `@fluid-experimental/oldest-client-observer/legacy`.

## API Documentation

Read the **@fluid-experimental/oldest-client-observer** API documentation at <https://fluidframework.com/docs/apis/oldest-client-observer>.
