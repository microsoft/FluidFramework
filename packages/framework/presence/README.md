...
The StateFactory.latest and .latestMap APIs accept a `validator` function property and is recommended to ensure data from other attendees conforms to expectations.
