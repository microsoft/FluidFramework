...
const r11sEndpointName = undefined;

/**
 * This function will determine if local or remote mode is required (based on FLUID_CLIENT), and return a new
 * {@link TinyliciousClient} instance based on the mode by setting the Connection config accordingly.
 */
...
/**
 * Copy of {@link createTinyliciousClient} with legacy (LTS) AzureClient APIs.
 */
