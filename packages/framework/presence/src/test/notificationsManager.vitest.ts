...
/**
 * A map of presence signals used for testing, indexed by a friendly string.
 */
	...
	describe("NotificationsManager", () => {
		...
		beforeEach(() => {
			...
			runtime.signalsExpected.push(
				// The first signal, the join signal, is from the prepareConnectedPresence call
				// eslint-disable-next-line @typescript-eslint/no-non-null-assertion
				knownSignals.get("PresenceJoin")!,
			);

			// Process the client join signal; we do this before each test
