 ...
 * notified of) components that implement IComponentHTMLRender. Then, using these patterns,
 * it will be notified of all loaded components that implement that type on load, and
 * of all new components that are loaded during that session that implement IComponentHTMLRender.
 *
