...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/agent-scheduler`.

Import the `legacy` APIs from `@fluidframework/agent-scheduler/legacy`.

## API Documentation

Read the **@fluidframework/agent-scheduler** API documentation at <https://fluidframework.com/docs/apis/agent-scheduler>.
