 ...
 *
 * `compatibilityMode` (deprecated) selects the runtime defaults. `minVersionForCollab` is an
 * optional overlay; when provided, it overrides the version derived from `compatibilityMode`.
 *
 * @internal
 */
