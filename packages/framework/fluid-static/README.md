...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/fluid-static`.

Import the `alpha` APIs from `@fluidframework/fluid-static/alpha`.

Import the `legacy` APIs from `@fluidframework/fluid-static/legacy`.

## API Documentation

Read the **@fluidframework/fluid-static** API documentation at <https://fluidframework.com/docs/apis/fluid-static>.
