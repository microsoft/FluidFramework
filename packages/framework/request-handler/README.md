...
```bash
npm i @fluidframework/request-handler
```
...
To access the `public` ([SemVer](https://semver.org/)) APIs, import via `@fluidframework/request-handler` like normal.

To access the `legacy` APIs, import via `@fluidframework/request-handler/legacy`.
...
Detailed instructions for working in the repo can be found in the repo [Wiki](https://github.com/microsoft/FluidFramework/blob/main/docs/content/Home.md).
