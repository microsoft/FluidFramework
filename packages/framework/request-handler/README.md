...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/request-handler`.

Import the `legacy` APIs from `@fluidframework/request-handler/legacy`.
