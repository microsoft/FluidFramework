...
export interface IIdCompressor {
	...
	/**
	 * Attempts to decompress a previously compressed ID into a UUID.
	 * @param id - the compressed ID to be decompressed.
	 * @returns the UUID associated with the compressed ID, or undefined if the ID was not generated by this compressor.
	 */
