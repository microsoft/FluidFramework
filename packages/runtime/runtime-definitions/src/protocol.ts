...
export interface IRuntimeMessagesContent {
	 ...
	 * @remarks
	 * This will be `undefined` for messages that were not originally generated by the client processing them, see {@link IRuntimeMessageCollection.local}.
	 * Note that this can be undefined for local ops as well if they specify undefined as the metadata.
	 */
