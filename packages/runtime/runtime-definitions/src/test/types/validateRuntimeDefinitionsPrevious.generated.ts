...
import type * as old from "@fluidframework/runtime-definitions-previous/legacy";

import type * as current from "@fluidframework/runtime-definitions/legacy";
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_StageControls": {"backCompat": false}
 */
declare type current_as_old_for_Interface_StageControls = requireAssignableTo<TypeOnly<current.StageControls>, TypeOnly<old.StageControls>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "TypeAlias_StagingModeChangedEvent": {"forwardCompat": false}
 */
declare type old_as_current_for_TypeAlias_StagingModeChangedEvent = requireAssignableTo<TypeOnly<old.StagingModeChangedEvent>, TypeOnly<current.StagingModeChangedEvent>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "TypeAlias_StagingModeChangedEvent": {"backCompat": false}
 */
declare type current_as_old_for_TypeAlias_StagingModeChangedEvent = requireAssignableTo<TypeOnly<current.StagingModeChangedEvent>, TypeOnly<old.StagingModeChangedEvent>>
