 ...
 *
 * The framework uses this value to select write formats and features that are supported by
 * clients using this version or newer. Clients using older versions may still be able to access
 * a document if no incompatible data has been written.
 *
 ...
 *
 * @deprecated 2.115.0. Removed in 4.0.0. Use {@link OldestSupportedClientVersion} instead.
