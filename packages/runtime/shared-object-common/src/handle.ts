...
export class SharedObjectComponentHandle implements IComponentHandle {
    ...
    public get isAttached(): boolean {
        ...
        // It tells if the shared object is attached to parent component. Parent component could itself be
        ...
        // isLocal is just maintained just to ensure we does not break something. It will be removed in next iterations.
        return this.value.isAttached !== undefined ? this.value.isAttached() : !this.value.isLocal();
    }
