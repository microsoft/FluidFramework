...
export abstract class LocalChannelContextBase implements IChannelContext {
    ...
    public rollback(content: any, localOpMetadata: unknown) {
        assert(this.isLoaded,0x2e6 /* "Channel should be loaded to rollback ops" */);
        assert(this.globallyVisible,0x2e7 /* "Local channel must be globally visible when rolling back op" */);
