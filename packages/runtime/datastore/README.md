...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/datastore`.

Import the `legacy` APIs from `@fluidframework/datastore/legacy`.

## API Documentation

Read the **@fluidframework/datastore** API documentation at <https://fluidframework.com/docs/apis/datastore>.
