...
```bash
npm i @fluidframework/datastore
```
...
To access the `public` ([SemVer](https://semver.org/)) APIs, import via `@fluidframework/datastore` like normal.

To access the `legacy` APIs, import via `@fluidframework/datastore/legacy`.
