...
export const shortCodeMap = {
	...
	"0xc56": "Branch summary must have a base",
	"0xc57": "Expected branch to already exist",
	"0xc58": "Cannot remove main branch",
	"0xc59": "Expected branch to exist",
	...
	"0xc63": "Duplicate shared branch id",
	"0xc64": "Only commit messages are supported",
	"0xc65": "Only commit messages to main are supported",
	"0xc66": "Commit messages must have a revision",
	"0xc67": "Can only rollback latest commit",
	"0xc68": "Branch already registered",
	"0xc69": "Branches must be related"
};
