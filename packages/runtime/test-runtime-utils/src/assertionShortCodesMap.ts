...
export const shortCodeMap = {
	...
	"0x87a": "start is undefined",
	"0x87b": "end is undefined",
	"0x87c": "properties is undefined",
	"0x87d": "Metadata is undefined",
	...
	"0x887": "Leaf must have value",
	"0x888": "invalid schema",
	...
	"0x8aa": "Could not find expected sub-directory.",
	"0x8ab": "\"key\" property is missing from edit operation.",
	"0x8ac": "\"key\" property in edit operation is misconfigured. Expected a string.",
	"0x8ad": "\"subdirName\" property is missing from \"createSubDirectory\" operation.",
	"0x8ae": "\"subdirName\" property in \"createSubDirectory\" operation is misconfigured. Expected a string.",
	"0x8af": "\"subdirName\" property is missing from \"deleteSubDirectory\" operation.",
	"0x8b0": "\"subdirName\" property in \"deleteSubDirectory\" operation is misconfigured. Expected a string.",
	"0x8b1": "Cannot dispose already disposed revertible",
	"0x8b2": "unexpected implementation",
	"0x8b3": "Use after free",
	"0x8b4": "should be in fields mode",
	"0x8b5": "time should be positive",
	"0x8b6": "Protocol and App summary trees should be present",
	"0x8b7": "Summarizer never reconnects so should never resubmit"
};
