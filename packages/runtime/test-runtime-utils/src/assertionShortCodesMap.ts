...
export const shortCodeMap = {
	...
	"0x5a7": "IContainerRuntime entryPoint was not initialized",
	...
	"0x880": "leaf value for non leaf",
	"0x881": "array for non field node",
	...
	"0x988": "Transaction not committed",
	...
	"0x9e8": "next1 should not be undefined",
	"0x9e9": "next2 should not be undefined",
	"0x9ea": "next1 should not be undefined",
	"0x9eb": "next2 should not be undefined",
	"0x9ec": "a should not be undefined if aIndex === bIndex",
	"0x9ed": "b should not be undefined if aIndex === bIndex",
	"0x9ee": "a should not be undefined if aIndex < bIndex",
	"0x9ef": "b should not be undefined if aIndex > bIndex",
	...
	"0x9fa": "emptyBatchSequenceNumber must be defined",
