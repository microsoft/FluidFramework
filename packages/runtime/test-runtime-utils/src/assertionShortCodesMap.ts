...
export const shortCodeMap = {
    ...
    "0x305": "shouldClientJoinWrite should imply this is a writeConnection",
    "0x306": "Must have a valid protocol handler instance",
    "0x307": "Id cannot contain slashes",
    "0x308": "Id cannot contain slashes",
    "0x309": "Id cannot contain slashes. DataStoreContext should have validated this.",
    "0x30a": "Channel context ID cannot contain slashes",
    "0x30b": "Channel context ID cannot contain slashes"
};
