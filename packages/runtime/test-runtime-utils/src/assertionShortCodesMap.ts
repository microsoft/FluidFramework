...
export const shortCodeMap = {
	...
	"0x90b": "must be hierBlock",
	"0x90c": "must be hier block",
	...
	"0x912": "Expected array schema",
	"0x913": "Expected array schema",
	"0x914": "Expected array schema",
	"0x915": "invalid flex schema",
	"0x916": "invalid value",
	"0x917": "invalid flex schema",
	"0x918": "Node instantiated from multiple bases.",
	"0x919": "invalid flex schema",
	...
	"0x925": "Keys must not be duplicated",
