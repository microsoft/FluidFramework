...
export const shortCodeMap = {
    ...
    "0x347": "Unexpected segmentGroup in segment",
    "0x348": "offset cannot be beyond segment length",
    "0x349": "this.mc and/or this.logger has not been set",
    "0x34a": "Unsupported navigation result",
    "0x34b": "Unexpected indexStack.length",
    "0x34c": "Unexpected keyStack.length",
    "0x34d": "pending not supported in mapCursorField",
    "0x34e": "expected enumeration to end at end of field",
    "0x34f": "cannot forget unknown Anchor",
    "0x350": "PathNode.parent is an UpPath API and thus should never be called on the root PathNode.",
    "0x351": "PathNode Refcount should not be negative.",
    "0x352": "child must be parented to be removed",
    "0x353": "JSON arrays must be dense / contain no 'undefined' items.",
    "0x354": "expected navigation ok",
    "0x355": "expected navigation ok",
    "0x356": "unexpected type",
    "0x357": "new range must not already exist",
    "0x358": "can not attach range to itself",
    "0x359": "detached range's end must be after it's start",
    "0x35a": "root field can not be deleted",
    "0x35b": "deleted range must exist in forest",
    "0x35c": "No cursors can be current when modifying forest",
    "0x35d": "Expected to find anchor",
    "0x35e": "index must be an integer",
    "0x35f": "index must be non-negative",
    "0x360": "index must be less than or equal to length",
    "0x361": "index must be less than length",
    "0x362": "Unexpected indexStack.length",
    "0x363": "Unexpected keyStack.length",
    "0x364": "relayServiceTenantAndSessionId should be present",
    "0x365": "Cannot wait for seqNumber below last processed sequence number",
    "0x366": "catchUpMonitor should always be set if pendingClientId is set",
    "0x367": "Must have a valid protocol handler instance",
    "0x368": "reentrancy?",
    "0x369": "reentrancy?",
    "0x36a": "processDeltas() should run async",
    "0x36b": "'redirectTable' must contain only undefined while detached / defined values while attached",
    "0x36c": "requesting unknown blobs",
    "0x36d": "requesting handle for unknown blob",
    "0x36e": "For clarity and paranoid defense against adding future attachment states",
    "0x36f": "Must have pending blob entry for uploaded blob",
    "0x370": "Must have pending blob entry for blob which failed to upload",
    "0x371": "Must only transition to offline flow while runtime is disconnected",
    "0x372": "No pending blob entry",
    "0x373": "Blob must be in online flow to transition to offline flow",
    "0x374": "Resubmitted ops must have metadata",
    "0x375": "Submitted BlobAttach ops must have a blobId or localId",
    "0x376": "blob must be uploaded before resubmitting BlobAttach op",
    "0x377": "local online BlobAttach op with no pending blob",
    "0x378": "local online BlobAttach op with no pending blob entry",
    "0x379": "Must be attached to get GC data",
    "0x37a": "Redirect table size must match BlobManager's local ID count",
    "0x37b": "Connect event delay must be canceled before subsequent connect event",
    "0x37c": "Must have clientId when connecting",
    "0x37d": "connect event delay must be cleared before propagating connect event",
    "0x37e": "it's one and the same thing",
    "0x37f": "Unexpected summary stage"
};
