...
export const shortCodeMap = {
    ...
    "0x052": "Missing reference segment!",
    "0x053": "Missing reference segment!",
    ...
    "0x2c3": "Content type should be application/ms-fluid",
    ...
    "0x27d": "Setting loaded state to false is not supported",
    ...
    "0x0d9": "Attempting to setAutoReconnect() a closed DeltaManager",
    ...
    "0x128": "Container should not already be paused before applying stashed ops",
    ...
    "0x28c": "different message type",
    "0x28d": "client sequence number doesn't match",
    "0x28e": "datastore ID doesn't match",
    "0x28f": "address doesn't match",
