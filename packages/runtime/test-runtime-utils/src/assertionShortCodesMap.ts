...
export const shortCodeMap = {
    ...
    "0x424": "The session ID should only be set once",
    "0x425": "Clients with local changes cannot be used to generate summaries",
    "0x426": "The session ID should be set before processing changes",
    "0x427": "The session ID should be set before processing changes",
    "0x428": "EditManager data is required in summary",
    "0x429": "There should not already be stored EditManager data when loading from summary",
    "0x42a": "Navigation to detached fields should never fail",
    "0x42b": "Cursor must be current to be used",
    "0x42c": "Cursor must be current to be used",
    "0x42d": "Cursor must be current to be used",
