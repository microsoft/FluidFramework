...
export const shortCodeMap = {
    ...
    "0x347": "offset cannot be beyond segment length",
    "0x348": "this.mc and/or this.logger has not been set",
    "0x349": "No cursors can be current when modifying forest",
    "0x34a": "Must have a valid protocol handler instance",
    "0x34b": "reentrancy?",
    "0x34c": "reentrancy?",
    "0x34d": "processDeltas() should run async",
    "0x34e": "Unexpected summary stage"
};
