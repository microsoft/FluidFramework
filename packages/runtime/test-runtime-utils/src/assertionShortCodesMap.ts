...
export const shortCodeMap = {
	...
	"0x24c":
		'"Cannot call `flush()` while manually accumulating a batch (e.g. under orderSequentially)',
	...
	"0x5c9":
		"Incremental Schema during update should allow a superset of the final schema",
	...
	"0x66d":
		"Cannot close a transaction that has already failed. Use abortEdit instead.",
	...
	"0x6e4":
		"Runtime IdCompressor must be available to generate local node identifiers",
	...
	"0xaba":
		"Local client was in removed client ids but segment has no local seq for either",
	...
	"0xac2": "missing function for union member",
	"0xac3": "Unexpected siblingStack.length",
	"0xac4": "Unexpected indexStack.length",
	"0xac5": "Unexpected siblingStack.length",
	"0xac6": "Unexpected indexStack.length",
	"0xac8": "Invalid document root length",
	"0xac9": "missing schema for type in cursor",
	...
	"0xad2": "Expected branch to be related to main",
	"0xad3": "Expected branch to be related to main",
	"0xad4": "Expected branch to be tracked",
	"0xad5": "Expected metadata for trunk commit",
	"0xad6": "Expected branch to be based on trunk",
	...
	"0xada": "Messages must have a session ID",
	"0xadb": "Proxy should intercept length",
	"0xadc": "Index is out of bounds",
	"0xadd": "missing proxy",
	"0xade": "invalid FieldKind",
	"0xadf": "invalid field kind",
	"0xae3": "Invalid field kind",
	"0xae4": "Schema must override buildRawNode",
	"0xae5": "Missing oneTimeSetup",
	"0xae6": "Should not allocate IDs",
	"0xae7": "missing field",
	...
	"0xaef": "nested cursors should not be root",
	"0xaf0": "Unexpected siblingStack.length",
	...
	"0xaf9": "missing schema",
	"0xafa": "missing FieldKind",
	"0xafb": "cannot navigate above root",
	"0xafc": "cannot navigate above root",
	"0xafd": "empty cursor has no nodes",
	"0xafe": "empty cursor has no nodes",
	"0xaff": "empty cursor has no nodes",
	"0xb00": "empty cursor has no nodes",
	"0xb01": "empty cursor has no nodes",
	"0xb02": "empty cursor has no nodes",
	"0xb03": "empty cursor has no nodes",
	"0xb04": "empty cursor has no nodes",
	"0xb05": "empty cursor has no nodes",
	"0xb06": "empty cursor has no nodes",
	...
	"0xb0f": "missing field implementation",
	"0xb10": "missing anchor",
	"0xb11": "parent anchor node should always exist since field is under a node",
	"0xb12":
		"cursor should point to a node that is not the root of the AnchorSet",
	"0xb13": "tree should only be cleaned up once",
	"0xb14": "missing schema",
	"0xb15": "requested schema that does not exist",
	"0xb16": "expected anchor node",
	"0xb17": "missing expected field",
	"0xb18": "missing expected field",
	"0xb19": "missing expected field",
	"0xb1a": "missing expected field",
	"0xb1b": "missing kind",
	...
	"0xb4c": "missing shape",
	"0xb4d": "Empty array should not encode any nodes",
	"0xb4e": "missing shape",
	"0xb4f": "index for shape not found in table",
	"0xb50": "missing shape",
	"0xb51": "missing shape",
	...
	"0xb5a": "Missing schema",
	"0xb5b": "Missing schema",
	...
	"0xb6d": "Local seq must be defined",
	...
	"0xb85":
		"Pending state mismatch, ack came in but next pending message is staged",
	...
	"0xb9a": "colliding properties",
	"0xb9b": "methods returning thisWrap should return this",
	"0xb9c": "use after dispose",
	"0xb9d": "unsupported field kind",
	...
	"0xba7": "must match",
	"0xba8": "only sets supported",
	"0xba9": "must have pending",
	...
	"0xc03": "key should exist in sequenced or pending data",
	...
	"0xc0b": "Unexpected delete rollback",
	...
	"0xc2f": "Subdirectory should exist in pending data",
	...
	"0xc5a": "Main branch must exist",
	"0xc5b": "Cannot remove main branch",
	"0xc5c": "Expected branch to exist",
	...
	"0xc61": "Expected base revision to be in trunk cache",
	...
	"0xc6b": "Can only rollback latest commit",
