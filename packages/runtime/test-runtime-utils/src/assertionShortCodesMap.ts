...
export const shortCodeMap = {
    ...
    "0x3f9": "Invalid interleaving of before/after slide",
    ...
    "0x424": "localSeq greater than collab window",
    "0x425": "No segment found",
    "0x426": "Invalid offset",
    ...
    "0x459": "The node does not exist.",
    "0x45a": "transactionCheckout` is required to edit the EditableTre",
    "0x45b": "The value is not primitive",
    "0x45c": "Expected string",
    "0x45d": "Expected number",
    "0x45e": "Expected boolean",
    ...
    "0x464": "Cannot remove event from empty lineage",
    "0x465": "Lineage event not found",
    ...
    "0x46e": "No data store retrieved with specified id",
    ...
    "0x476": "Unable to revert to undefined revision",
    "0x477": "Unable to revert to undefined revision",
    "0x478": "The repair data store should only ask for the current forest state",
    "0x479": "No repair data found",
    "0x47a": "No repair data found",
    "0x47b": "No repair data found",
    "0x47c": "No repair data found",
    "0x47d": "No repair data found",
    "0x47e": "Keys in map must be sorted.",
    "0x47f": "Values in map must be sorted.",
    "0x480": "Clusters must have a positive capacity",
    "0x481": "Clusters must not exceed max cluster size",
    "0x482": "reservedIdCount must be non-negative",
    "0x483": "Attempted to create duplicate session",
    "0x484": "Inconsistent local ID state",
    "0x485": "Inconsistent override state",
    "0x486": "Inconsistent override state",
    "0x487": "Non-empty range must properly consume local IDs",
    "0x488": "Ranges finalized out of order.",
    "0x489": "Cannot finalize an empty range.",
    "0x48a": "The number of allocated final IDs must not exceed the JS maximum safe integer.",
    "0x48b": "Cluster already exists for session but there is no finalized local ID",
    "0x48c": "The number of unfinalized locals should only be positive",
    "0x48d": "The number of allocated final IDs must not exceed the JS maximum safe integer.",
    "0x48e": "Override IDs must be in sorted order.",
    "0x48f": "Ranges finalized out of order.",
    "0x490": "Malformed range: override ID ahead of range start.",
    "0x491": "No cluster was created when overflow occurred.",
    "0x492": "No cluster exists but IDs were finalized.",
    "0x493": "Cannot have multiple local IDs with identical overrides.",
    "0x494": "Cannot add a second override for final id",
    "0x495": "Session ID Normalizer produced unexpected local ID",
    "0x496": "Session ID Normalizer produced unexpected local ID",
    "0x497": "session not serialized",
    "0x498": "Cannot resume existing session.",
    "0x499": "Inconsistent last finalized state when deserializing",
    "0x49a": "malformed IdCreationRange",
    "0x49b": "Unexpectedly large upper number when incrementing UUID",
    "0x49c": "Unexpectedly large variant number when incrementing UUID",
    "0x49d": "Local ID space must start at -1.",
    "0x49e": "Local ID space must be contiguous.",
    "0x49f": "Gaps in final space must align to a local.",
    "0x4a0": "Empty range should not be reified.",
    "0x4a1": "Expected an UuidString",
    "0x4a2": "Expected a StableId",
    "0x4a3": "SparseNode.parent is an UpPath API and thus should never be called on the root SparseNode.",
    "0x4a4": "child must be parented to be removed",
    "0x4a5": "Field not present in sparse node",
    "0x4a6": "Child not present in sparse node field",
    "0x4a7": "Number of changes should be constant when normalizing",
    "0x4a8": "Inverting inverse changes is currently not supported",
    "0x4a9": "Only existing nodes can have their value restored",
    "0x4aa": "Unable to revert to undefined revision",
    "0x4ab": "Inverse marks should be the same length",
    "0x4ac": "Should not be called when connection is already present!",
    "0x4ad": "Connection should be disposed by now",
    "0x4ae": "Received message from user not in the audience",
    "0x4af": "Encoded timestamps should be an array of nummbers",
    "0x4b0": "serialized attribution columns should have the same length",
    "0x4b1": "new client has different payload from existing one",
    "0x4b2": "have connection",
    "0x4b3": "all callers call here with active connection",
    "0x4b4": "Audience is subset of quorum",
    "0x4b5": "Audience is subset of quorum",
    "0x4b6": "mismatch",
    "0x4b7": "shouldn't have multiple active batches",
    "0x4b8": "lz4 is currently the only supported compression algorithm",
    "0x4b9": "shouldn't receive compressed message in middle of a batch"
};
