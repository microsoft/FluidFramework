...
export const shortCodeMap = {
	...
	"0x347": "Summarizer must not have locally pending changes",
	"0x348": "this.mc and/or this.logger has not been set",
	"0x349": "No cursors can be current when modifying forest",
	"0x34a": "reentrancy?",
	"0x34b": "reentrancy?",
	"0x34c": "processDeltas() should run async",
	"0x34d": "Refresh Summary Ack - Caller is responsible for checking lock"
};
