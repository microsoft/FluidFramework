...
export const shortCodeMap = {
	...
	"0xcba": "New commits must have a parent.",
	"0xcbb": "Missing enriched commit.",
	"0xcbc": "New commits must have a parent.",
	"0xcbd": "Missing enriched commit.",
	"0xcbe": "Unsupported modular change codec version",
	"0xcbf": "updatableError should only be called in test mode",
	"0xcc0": "expected compatibility errors for missing min collab version snapshot"
};
