...
export const shortCodeMap = {
	...
	"0x784":
		"There is no explicit schema for this node type. Ensure that the type is correct and the schema for it was added to the TreeStoredSchema",
	...
	"0x8cb": "should be in fields mode",
	...
	"0x926": "Expected an Object schema.",
