...
class OpPerfTelemetry {
    ...
    #opSendTimeForLatencyStatisticsForMsnStatistics: number | undefined;

    // To track round trip time for every %1000 client message.
    #opSendTimeForLatencyStatistics: number | undefined;
    #clientSequenceNumberForLatencyStatistics: number | undefined;

    #firstConnection = true;
    #connectionOpSeqNumber: number | undefined;
    readonly #bootTime = performance.now();
