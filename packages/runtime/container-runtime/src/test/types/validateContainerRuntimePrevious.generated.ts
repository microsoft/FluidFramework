...
import type * as old from "@fluidframework/container-runtime-previous/legacy";

import type * as current from "@fluidframework/container-runtime/legacy";
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IVersionMarkResolver": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IVersionMarkResolver = requireAssignableTo<TypeOnly<old.IVersionMarkResolver>, TypeOnly<current.IVersionMarkResolver>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IVersionMarkResolver": {"backCompat": false}
 */
declare type current_as_old_for_Interface_IVersionMarkResolver = requireAssignableTo<TypeOnly<current.IVersionMarkResolver>, TypeOnly<old.IVersionMarkResolver>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "TypeAlias_ResolveResult": {"backCompat": false}
 */
declare type current_as_old_for_TypeAlias_ResolveResult = requireAssignableTo<TypeOnly<current.ResolveResult>, TypeOnly<old.ResolveResult>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "TypeAlias_VersionMarkCapture": {"backCompat": false}
 */
declare type current_as_old_for_TypeAlias_VersionMarkCapture = requireAssignableTo<TypeOnly<current.VersionMarkCapture>, TypeOnly<old.VersionMarkCapture>>
