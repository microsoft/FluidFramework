...
export enum ContainerMessageType {
	...
	/**
	 * External Ops submitted by features implemented outside container runtime which requires to send Ops.
	 */
 ...
 * @legacy
 */
export type ContainerRuntimeExternalOp = TypedContainerRuntimeMessage<
	ContainerMessageType.ExternalOp,
	IExternalContainerRuntimeMessage
>;
