...
/**
 * A {@link InternalUtilityTypes.TypedContainerRuntimeMessage} that has been generated by the container runtime but is not yet being sent to the server.
...
/**
 * A {@link InternalUtilityTypes.TypedContainerRuntimeMessage} that is being sent to the server from the container runtime.
 */
