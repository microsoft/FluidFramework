...
| -------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `VersionMarkResolver:Resolve` **(implemented)**            | end of `resolve()` (via `finally`, so a thrown scan is still reported) | `outcome` (`resolved`\|`pending`\|`unresolvable`\|`error`), `path` (`session`\|`history`\|`noReader`), `historyAttempted`, `sequenceNumberLowerBound`, `duration`, `sequenceNumber` (when resolved), `reason` (the diagnostic string when the result carries one) | success rate; whether retained op history was attempted; final resolution source/path; latency; `unresolvable` = data-loss KPI; `error` = the scan threw; `reason` = why a mark did not resolve. |
