		...
		IProvideFluidHandleContext
{
	...
	/**
	 * Processes an influx of batch messages. It calls schedule manager according to the location in the batch of the influx.
