...
import { SharedDataStores } from "./sharedDataStores";
        ...
        ISummarizerInternalsProvider
{
    ...
    public get IFluidDataStoreRegistry(): IFluidDataStoreRegistry {
        return this.dataStores.IFluidDataStoreRegistry;
    }
    ...
    private readonly dataStores: SharedDataStores;
    ...
    private constructor(
        ...
        this.dataStores = new SharedDataStores(
            this.context.baseSnapshot,
            this,
            (type: ContainerMessageType, content: any) => this.submit(type, content),
            registry,
            this.summaryTracker,
            this.summarizerNode,
            this.logger);
    ...
    public async resolveHandle(request: IRequest): Promise<IResponse> {
        ...
        if (id === BlobManager.basePath && requestParser.isLeaf(2)) {
            ...
            return this.dataStores.request(request);
        }
    ...
    public async snapshot(): Promise<ITree> {
        const root: ITree = await this.dataStores.snapshot();
    ...
    public async createDataStore(pkg: string | string[]): Promise<IFluidRouter> {
        return this.dataStores.createDataStore(pkg);
    }

    public async createRootDataStore(pkg: string | string[], rootDataStoreId: string): Promise<IFluidRouter> {
        return this.dataStores.createRootDataStore(pkg, rootDataStoreId);
    }
    ...
    {
        return this.dataStores.createDetachedRootDataStore(pkg, rootDataStoreId);
    }

    public createDetachedDataStore(pkg: Readonly<string[]>): IFluidDataStoreContextDetached {
        return this.dataStores.createDetachedDataStore(pkg);
    }

    public async _createDataStoreWithProps(pkg: string | string[], props?: any, id = uuid()):
        Promise<IFluidDataStoreChannel> {
        return this.dataStores._createDataStoreWithProps(pkg, props,id);
    }
