...
export class ContainerRuntime extends EventEmitter
    ...
    /**
     * {@deprecated} Load the stores from a snapshot and returns the runtime.
    ...
    public static async load(
        ...
        const runtime = new ContainerRuntime(context, realProps, chunks);
    ...
    public get scope(): IFluidObject {
        return this.props.containerScope;
    }
    ...
    private constructor(
        ...
        private readonly props: InternalContainerRuntimeProps,
        ...
        this.summaryManager = new SummaryManager(
            context,
            this.props.runtimeOptions.generateSummaries !== false,
            !!this.props.runtimeOptions.enableWorker,
            this.logger,
            (summarizer) => { this.nextSummarizerP = summarizer; },
            this.previousState.nextSummarizerP,
            !!this.previousState.reload,
            this.props.runtimeOptions.initialSummarizerDelayMs);
    ...
    public async request(request: IRequest): Promise<IResponse> {
        ...
        return this.props.requestHandler(request, this);
    }
