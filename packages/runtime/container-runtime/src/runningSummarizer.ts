...
export class RunningSummarizer implements IDisposable {
    ...
    private constructor(
        ...
        if (configuration.state !== "disableHeuristics") {
            assert(this.configuration.state === "enabled", 0x2e2 /* "Configuration state should be enabled" */);
        ...
        assert (this.configuration.state !== "disabled", 0x2e3 /* "Summary not supported with configuration disabled" */);
