...
export abstract class FluidDataStoreContext extends TypedEventEmitter<IFluidDataStoreContextEvents> implements
    ...
    public updateUsedRoutes(usedRoutes: string[]) {
        ...
        /**
         * If the data store has not been realized yet, we need the used routes to update used routes of the channel
         * when it realizes. It's safe to keep only the last used routes because if something changes because of this GC
         ...
         */
        this.lastUsedRoutes = Array.from(usedRoutes);
