...
export class PendingStateManager implements IDisposable {
    ...
    public getLocalState(): IPendingLocalState | undefined {
        // TODO: does this need to be back compat and return flush messages?
        ...
        if (!this.pendingMessages.isEmpty()) {
            return {
                pendingStates: this.pendingMessages.toArray().map(
                    ...
                    (state) => ({ ...state, localOpMetadata: undefined })),
            };
        }
    }
    ...
    public async applyStashedOpsAt(seqNum?: number) {
        ...
        while (!this.initialMessages.isEmpty()) {
            ...
            if (seqNum !== undefined) {
                ...
                } else if (nextMessage.referenceSequenceNumber < seqNum) {
    ...
    public replayPendingStates() {
        ...
        let pendingStatesCount = this.pendingMessages.length;
