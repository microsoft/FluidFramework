...
export class PendingStateManager implements IDisposable {
    readonly #pendingStates = new Deque<IPendingState>();
    readonly #initialStates: Deque<IPendingState>;
    readonly #previousClientIds = new Set<string>();
    readonly #firstStashedCSN: number = -1;
    ...
    #pendingBatchBeginMessage: ISequencedDocumentMessage | undefined;
