...
import { GarbageCollector, IGarbageCollector, IGCResult } from "../garbageCollector";
...
describe("Garbage Collector", () => {
    ...
    beforeEach(() => {
        // Error events generated by GarbageCollector will be added to the errorEvents array.
    ...
    function runGCAndValidateResults(referenceGraph: IGraphNode[], startingIds: string[], deletedNodes: IGraphNode[]) {
        ...
        const gcResult: IGCResult = garbageCollector.runGC(referenceGraph, startingIds);
