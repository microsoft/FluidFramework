...
```bash
npm i @fluidframework/garbage-collector
```

## API Documentation

API documentation for **@fluidframework/garbage-collector** is available at <https://fluidframework.com/docs/apis/garbage-collector>.
