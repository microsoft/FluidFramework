...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/container-runtime-definitions`.

Import the `legacy` APIs from `@fluidframework/container-runtime-definitions/legacy`.

## API Documentation

Read the **@fluidframework/container-runtime-definitions** API documentation at <https://fluidframework.com/docs/apis/container-runtime-definitions>.
