...
declare function use_current_RemovedInterfaceDeclaration_IDataStoreWithBindToContext_Deprecated(
    use: TypeOnly<current.IDataStoreWithBindToContext_Deprecated>);
use_current_RemovedInterfaceDeclaration_IDataStoreWithBindToContext_Deprecated(
...
*/
declare function get_current_RemovedInterfaceDeclaration_IDataStoreWithBindToContext_Deprecated():
...
use_old_InterfaceDeclaration_IDataStoreWithBindToContext_Deprecated(
    get_current_RemovedInterfaceDeclaration_IDataStoreWithBindToContext_Deprecated());
