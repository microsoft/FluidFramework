 ...
 */
import * as old from "@fluidframework/container-runtime-definitions-0.58.1000";
import * as current from "../../index";

/*
* Validate forward compat by using old type in place of current type
* If breaking change required, add in package.json under typeValidation.broken.0.58.1000:
...
declare function use_current_InterfaceDeclaration_IDataStoreWithBindToContext_Deprecated(
    use: current.IDataStoreWithBindToContext_Deprecated);
...
declare function get_current_InterfaceDeclaration_IDataStoreWithBindToContext_Deprecated():
    current.IDataStoreWithBindToContext_Deprecated;
