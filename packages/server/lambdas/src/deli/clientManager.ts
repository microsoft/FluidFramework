...
const SequenceNumberComparer: IComparer<IClientSequenceNumber> = {
    compare: (a, b) => {
        ...
        // treat undefined as the maximun possible value
        if (a === undefined) {
            return 1;
        }
        if (b === undefined) {
        ...
        return a.referenceSequenceNumber - b.referenceSequenceNumber;
    },
    min: {
        canEvict: true,
        clientId: undefined,
...
export class ClientManager {
    ...
    public getMinimumSequenceNumber(): number {
        if (this.clientSeqNumbers.count() > 0) {
            ...
            if (client.value.referenceSequenceNumber === undefined) {
                return -1;
            }
