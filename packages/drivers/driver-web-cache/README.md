...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/driver-web-cache`.

Import the `legacy` APIs from `@fluidframework/driver-web-cache/legacy`.
