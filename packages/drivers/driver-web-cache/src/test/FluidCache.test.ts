...
[true, false].forEach((immediateClose) => {
	...
	describe(`Fluid Cache tests: immediateClose: ${immediateClose}`, () => {
		beforeEach(() => {
			...
			// eslint-disable-next-line import/no-internal-modules, import-x/no-internal-modules, @typescript-eslint/no-require-imports, @typescript-eslint/no-var-requires
