...
// eslint-disable-next-line import/no-unassigned-import, import-x/no-unassigned-import, @typescript-eslint/no-require-imports, import/no-internal-modules, import-x/no-internal-modules
...
describe("getFluidCacheIndexedDbInstance", () => {
	beforeEach(() => {
		...
		// eslint-disable-next-line @typescript-eslint/no-require-imports, @typescript-eslint/no-var-requires, import/no-internal-modules, import-x/no-internal-modules
