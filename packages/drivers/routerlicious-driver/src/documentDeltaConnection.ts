...
import { errorObjectFromSocketError, IR11sSocketError, R11sErrorType } from "./errorUtils";
 ...
 */
export class R11sDocumentDeltaConnection extends DocumentDeltaConnection<R11sErrorType>
{
     ...
     */
    protected createErrorObject(handler: string, error?: any, canRetry = true): DriverError<R11sErrorType> {
