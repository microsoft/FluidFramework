...
export class DeltaStorageService implements IDeltaStorageService {
    constructor(
        ...
        private readonly getRestWrapper: () => Promise<RestWrapper> =
            async (): Promise<RestWrapper> => this.restWrapper,
        private readonly getDeltaStorageUrl: () => string = (): string => this.url,
    ) {
    }
