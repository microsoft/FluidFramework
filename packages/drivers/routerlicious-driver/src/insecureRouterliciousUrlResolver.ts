...
export const defaultRouterliciousPort = 7070;

/**
 * InsecureRouterliciousUrlResolver knows how to get the URLs to the service (in this case Routerlicious) to use
...
export class InsecureRouterliciousUrlResolver implements IUrlResolver {
    public constructor(private readonly tinyliciousPort = defaultRouterliciousPort) { }
