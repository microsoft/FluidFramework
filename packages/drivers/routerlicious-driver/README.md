...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/routerlicious-driver`.

Import the `legacy` APIs from `@fluidframework/routerlicious-driver/legacy`.
