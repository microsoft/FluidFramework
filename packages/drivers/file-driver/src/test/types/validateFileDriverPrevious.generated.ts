 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Class_FileDocumentService": {"forwardCompat": false}
 */
declare type old_as_current_for_Class_FileDocumentService = requireAssignableTo<TypeOnly<old.FileDocumentService>, TypeOnly<current.FileDocumentService>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Class_FileDocumentService": {"backCompat": false}
 */
declare type current_as_old_for_Class_FileDocumentService = requireAssignableTo<TypeOnly<current.FileDocumentService>, TypeOnly<old.FileDocumentService>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "ClassStatics_FileDocumentService": {"backCompat": false}
 */
declare type current_as_old_for_ClassStatics_FileDocumentService = requireAssignableTo<TypeOnly<typeof current.FileDocumentService>, TypeOnly<typeof old.FileDocumentService>>
