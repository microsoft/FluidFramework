 ...
 * "Enum_OdspErrorType": {"forwardCompat": false}
 */
declare type old_as_current_for_Enum_OdspErrorType = requireAssignableTo<TypeOnly<old.OdspErrorType>, TypeOnly<current.OdspErrorType>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Enum_OdspErrorType": {"backCompat": false}
 */
declare type current_as_old_for_Enum_OdspErrorType = requireAssignableTo<TypeOnly<current.OdspErrorType>, TypeOnly<old.OdspErrorType>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Enum_ShareLinkTypes": {"forwardCompat": false}
 */
declare type old_as_current_for_Enum_ShareLinkTypes = requireAssignableTo<TypeOnly<old.ShareLinkTypes>, TypeOnly<current.ShareLinkTypes>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Enum_ShareLinkTypes": {"backCompat": false}
 */
declare type current_as_old_for_Enum_ShareLinkTypes = requireAssignableTo<TypeOnly<current.ShareLinkTypes>, TypeOnly<old.ShareLinkTypes>>
