...
import type * as current from "@fluidframework/tinylicious-driver/internal";
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Class_TinyliciousServiceContainer": {"forwardCompat": false}
 */
declare type old_as_current_for_Class_TinyliciousServiceContainer = requireAssignableTo<TypeOnly<old.TinyliciousServiceContainer<never>>, TypeOnly<current.TinyliciousServiceContainer<never>>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Class_TinyliciousServiceContainer": {"backCompat": false}
 */
declare type current_as_old_for_Class_TinyliciousServiceContainer = requireAssignableTo<TypeOnly<current.TinyliciousServiceContainer<never>>, TypeOnly<old.TinyliciousServiceContainer<never>>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "ClassStatics_TinyliciousServiceContainer": {"backCompat": false}
 */
declare type current_as_old_for_ClassStatics_TinyliciousServiceContainer = requireAssignableTo<TypeOnly<typeof current.TinyliciousServiceContainer>, TypeOnly<typeof old.TinyliciousServiceContainer>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Function_createTinyliciousServiceClient": {"backCompat": false}
 */
declare type current_as_old_for_Function_createTinyliciousServiceClient = requireAssignableTo<TypeOnly<typeof current.createTinyliciousServiceClient>, TypeOnly<typeof old.createTinyliciousServiceClient>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_TinyliciousServiceOptions": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_TinyliciousServiceOptions = requireAssignableTo<TypeOnly<old.TinyliciousServiceOptions>, TypeOnly<current.TinyliciousServiceOptions>>
