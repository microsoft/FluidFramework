...
export class DocumentDeltaConnection
    ...
    public get initialMessages(): ISequencedDocumentMessage[] {
        ...
        assert(this.earlyOpHandlerAttached, 0x75 /* Potentially missed initial messages */);
        // We will lose ops and perf will tank as we need to go to storage to become current!
        assert(this.listeners("op").length !== 0, 0x76 /* No op handler is setup! */);
    ...
    public get initialSignals(): ISignalMessage[] {
        assert(this.listeners("signal").length !== 0, 0x77 /* No signal handler is setup! */);
