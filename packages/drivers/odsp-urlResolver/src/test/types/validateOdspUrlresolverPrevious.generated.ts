 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Variable_isOdspUrl": {"backCompat": false}
 */
declare type current_as_old_for_Variable_isOdspUrl = requireAssignableTo<TypeOnly<typeof current.isOdspUrl>, TypeOnly<typeof old.isOdspUrl>>
