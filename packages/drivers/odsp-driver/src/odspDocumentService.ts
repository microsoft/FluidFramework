...
export class OdspDocumentService implements IDocumentService {
    ...
    public async connectToDeltaStream(client: IClient): Promise<IDocumentDeltaConnection> {
        assert(this.currentConnection === undefined, 0x4ac /* Should not be called when connection is already present! */);
        ...
        return getWithRetryForTokenRefresh<IDocumentDeltaConnection>(async (options) => {
            ...
            try {
                ...
                connection.once("disconnect", (error: any) => {
                    ...
                    assert(connection.disposed, 0x4ad /* Connection should be disposed by now */);
