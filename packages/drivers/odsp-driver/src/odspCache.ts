...
import { ICacheEntry, IEntry, IFileEntry, IOdspResolvedUrl, IPersistedCache, ISocketStorageDiscovery, getKeyForCacheEntry } from "@fluidframework/odsp-driver-definitions/internal";
