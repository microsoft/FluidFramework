...
describe("Create New Utils Tests", () => {
	...
	const test = (snapshot: ISnapshot): void => {
		...
		assert(appTreeBlobId !== undefined, "app tree attributes blob id should exist");
		...
		assert(docAttributesBlobId !== undefined, "protocol tree attributes blob id should exist");
