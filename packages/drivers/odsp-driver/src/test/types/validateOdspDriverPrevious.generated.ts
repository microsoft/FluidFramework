...
import type * as old from "@fluidframework/odsp-driver-previous/legacy";

import type * as current from "@fluidframework/odsp-driver/legacy";
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Function_createOdspDocumentServiceFactory": {"backCompat": false}
 */
declare type current_as_old_for_Function_createOdspDocumentServiceFactory = requireAssignableTo<TypeOnly<typeof current.createOdspDocumentServiceFactory>, TypeOnly<typeof old.createOdspDocumentServiceFactory>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IOdspDocumentServiceFactoryOptions": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IOdspDocumentServiceFactoryOptions = requireAssignableTo<TypeOnly<old.IOdspDocumentServiceFactoryOptions>, TypeOnly<current.IOdspDocumentServiceFactoryOptions>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IOdspDocumentServiceFactoryOptions": {"backCompat": false}
 */
declare type current_as_old_for_Interface_IOdspDocumentServiceFactoryOptions = requireAssignableTo<TypeOnly<current.IOdspDocumentServiceFactoryOptions>, TypeOnly<old.IOdspDocumentServiceFactoryOptions>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IOdspPointInTimeDocumentServiceImplementationProps": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IOdspPointInTimeDocumentServiceImplementationProps = requireAssignableTo<TypeOnly<old.IOdspPointInTimeDocumentServiceImplementationProps>, TypeOnly<current.IOdspPointInTimeDocumentServiceImplementationProps>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IOdspPointInTimeDocumentServiceImplementationProps": {"backCompat": false}
 */
declare type current_as_old_for_Interface_IOdspPointInTimeDocumentServiceImplementationProps = requireAssignableTo<TypeOnly<current.IOdspPointInTimeDocumentServiceImplementationProps>, TypeOnly<old.IOdspPointInTimeDocumentServiceImplementationProps>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IPointInTimeDocumentServiceFactory": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IPointInTimeDocumentServiceFactory = requireAssignableTo<TypeOnly<old.IPointInTimeDocumentServiceFactory>, TypeOnly<current.IPointInTimeDocumentServiceFactory>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IPointInTimeDocumentServiceFactory": {"backCompat": false}
 */
declare type current_as_old_for_Interface_IPointInTimeDocumentServiceFactory = requireAssignableTo<TypeOnly<current.IPointInTimeDocumentServiceFactory>, TypeOnly<old.IPointInTimeDocumentServiceFactory>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "TypeAlias_OdspPointInTimeDocumentServiceImplementation": {"forwardCompat": false}
 */
declare type old_as_current_for_TypeAlias_OdspPointInTimeDocumentServiceImplementation = requireAssignableTo<TypeOnly<old.OdspPointInTimeDocumentServiceImplementation>, TypeOnly<current.OdspPointInTimeDocumentServiceImplementation>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "TypeAlias_OdspPointInTimeDocumentServiceImplementation": {"backCompat": false}
 */
declare type current_as_old_for_TypeAlias_OdspPointInTimeDocumentServiceImplementation = requireAssignableTo<TypeOnly<current.OdspPointInTimeDocumentServiceImplementation>, TypeOnly<old.OdspPointInTimeDocumentServiceImplementation>>
