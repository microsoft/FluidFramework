 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Class_ReadBuffer": {"forwardCompat": false}
 */
declare type old_as_current_for_Class_ReadBuffer = requireAssignableTo<TypeOnly<old.ReadBuffer>, TypeOnly<current.ReadBuffer>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Class_ReadBuffer": {"backCompat": false}
 */
declare type current_as_old_for_Class_ReadBuffer = requireAssignableTo<TypeOnly<current.ReadBuffer>, TypeOnly<old.ReadBuffer>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "ClassStatics_ReadBuffer": {"backCompat": false}
 */
declare type current_as_old_for_ClassStatics_ReadBuffer = requireAssignableTo<TypeOnly<typeof current.ReadBuffer>, TypeOnly<typeof old.ReadBuffer>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Function_getApiRoot": {"backCompat": false}
 */
declare type current_as_old_for_Function_getApiRoot = requireAssignableTo<TypeOnly<typeof current.getApiRoot>, TypeOnly<typeof old.getApiRoot>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Function_isOdcOrigin": {"backCompat": false}
 */
declare type current_as_old_for_Function_isOdcOrigin = requireAssignableTo<TypeOnly<typeof current.isOdcOrigin>, TypeOnly<typeof old.isOdcOrigin>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Variable_currentReadVersion": {"backCompat": false}
 */
declare type current_as_old_for_Variable_currentReadVersion = requireAssignableTo<TypeOnly<typeof current.currentReadVersion>, TypeOnly<typeof old.currentReadVersion>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Variable_snapshotMinReadVersion": {"backCompat": false}
 */
declare type current_as_old_for_Variable_snapshotMinReadVersion = requireAssignableTo<TypeOnly<typeof current.snapshotMinReadVersion>, TypeOnly<typeof old.snapshotMinReadVersion>>
