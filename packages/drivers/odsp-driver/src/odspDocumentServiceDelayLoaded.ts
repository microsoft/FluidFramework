...
/**
 * This DocumentService is used by OdspDocumentService.ts to delay load the delta storage and delta connection
 * as they are not on critical path of loading a container. This class is not supposed to be used independently.
 */
export class OdspDocumentServiceDelayLoaded implements IDocumentService {
     ...
     * @param storageManagerGetter - Storage service getter.
    ...
    public async connectToStorage(): Promise<IDocumentStorageService> {
        throw new UsageError("Storage should not be delay loaded");
    }
    ...
    public async connectToDeltaStorage(): Promise<IDocumentDeltaStorageService> {
        const snapshotOps = this.storageManagerGetter()?.ops ?? [];
    ...
    protected get opsCache() {
        ...
        const seqNumber = this.storageManagerGetter()?.snapshotSequenceNumber;
