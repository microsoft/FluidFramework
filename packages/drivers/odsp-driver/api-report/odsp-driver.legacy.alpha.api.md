...
// @alpha
export function createOdspCreateContainerRequest(siteUrl: string, driveId: string, filePath: string, fileName: string, createShareLinkType?: ISharingLinkKind, _containerPackageInfo?: IContainerPackageInfo | undefined): IRequest;
