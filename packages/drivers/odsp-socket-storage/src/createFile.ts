...
export async function createNewFluidFile(
    ...
    const responseP: Promise<IOdspResolvedUrl> = cache.sessionCache.get(key);
    ...
    cache.sessionCache.put(key, odspResolvedUrlDeferred.promise);
