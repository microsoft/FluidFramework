...
function isCodeProposalTestPackage(
	pkg: unknown,
): pkg is ICodeProposalTestPackage {
	...
	(getTestObjectProvider, apis) => {
		...
		function createLoader() {
			...
			const fluidExport: SupportedExportInterfaces = {
				IFluidDataStoreFactory: new TestFluidObjectFactory([
