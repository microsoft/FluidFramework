...
import { CompressionAlgorithms, ContainerMessageType, IContainerRuntimeOptions, UnknownContainerRuntimeMessage } from "@fluidframework/container-runtime/internal";
