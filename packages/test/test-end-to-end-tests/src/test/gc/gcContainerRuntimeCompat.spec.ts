...
describeCompat(
	...
	(getTestObjectProvider, compatApis) => {
		 ...
		 */
		// not skipping this: https://dev.azure.com/fluidframework/internal/_build/results?buildId=298969&view=ms.vss-test-web.build-test-results-tab&runId=6153805&resultId=100953&paneView=history
