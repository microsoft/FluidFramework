...
import { describeFullInternalCompat, getContainerRuntimeApi } from "@fluidframework/test-version-utils";
 ...
 */
// Issue #10053
describeFullInternalCompat.skip("GC summary compatibility tests", (getTestObjectProvider) => {
