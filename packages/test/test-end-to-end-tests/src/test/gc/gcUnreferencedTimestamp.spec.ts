...
describeCompat(
	...
	(getTestObjectProvider, apis) => {
		...
		beforeEach("setup", async function () {
			...
			containerRuntime = dataStoreA._context
		...
		describe("unreferenced timestamp in summary", () => {
			...
			it("adds / removes unreferenced timestamp for attachment blobs correctly", async () => {
				...
				assert(
					blob1Timestamp1 === undefined,
					`blob1 should not have unreferenced timestamp`,
				);
				...
				assert(
					blob1Timestamp2 !== undefined,
					`blob1 should have unreferenced timestamp`,
				);
