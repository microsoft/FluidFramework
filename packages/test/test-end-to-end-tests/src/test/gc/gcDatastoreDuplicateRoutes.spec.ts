...
import type { IGarbageCollectionState } from "@fluidframework/container-runtime/internal/test/gc";
import {
	type ISummaryBlob,
	SummaryType,
...
describeCompat(
	...
	(getTestObjectProvider, apis) => {
		...
		it("DDS changes do not create new GC blobs", async () => {
			...
			assert(
				gcObject.handleType === SummaryType.Tree,
				"Expected a gc tree handle!",
			);
		});
