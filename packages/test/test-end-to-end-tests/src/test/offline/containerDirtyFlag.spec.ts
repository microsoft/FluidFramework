...
describeCompat(
	...
	(getTestObjectProvider, apis) => {
		...
		describe("Attached container", () => {
			...
			it("handles container with pending ops to be sent out", async () => {
			...
			it("handles container with pending ops not to be sent out", async () => {
				const pendingOps = await generatePendingState(
					testContainerConfig,
					provider,
					false,
			...
			it("handles container with no pending ops", async () => {
			...
			it("handles container that had no requests to process", async () => {
