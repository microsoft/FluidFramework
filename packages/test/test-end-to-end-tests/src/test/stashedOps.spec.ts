...
describeNoCompat("stashed ops", (getTestObjectProvider) => {
    ...
    it("resends marker ops", async function() {
        ...
        assert.strictEqual(simpleMarker1.properties?.markerSimpleType, "markerKeyValue", "markerSimpleType is incorrrect");
        ...
        assert.strictEqual(simpleMarker2.properties?.markerSimpleType, "markerKeyValue", "markerSimpleType is incorrrect");
