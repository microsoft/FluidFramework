...
After a Fluid Framework version bump or after a new compatibility checkpoint is designated, build client packages and then run the following from this package's directory:
