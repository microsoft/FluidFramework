...
describe("Get the major version number above or below the baseVersion", () => {
    ...
    assert.strictEqual(getRequestedRange("2.0.0-internal.2.1.0", -1), "2.0.0-internal.1.0.0");
    assert.strictEqual(getRequestedRange("2.0.0-internal.3.0.0", -1), "2.0.0-internal.2.0.0");
