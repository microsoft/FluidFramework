 ...
 *   compat-workspaces/generated-versions.mjs
...
async function main(): Promise<void> {
	...
	// Write generated-versions.mjs — flat list of all installed versions, newest first.
	...
	const manifestContent = [
		...
		`export const versions = ${JSON.stringify(sortedVersions, undefined, "\t")};`,
		"",
	].join("\n");
	writeFileSync(generatedVersionsMjsPath, manifestContent, "utf8");
	console.log(`\nWrote ${path.relative(pkgRoot, generatedVersionsMjsPath)}`);
