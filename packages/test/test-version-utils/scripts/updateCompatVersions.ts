 ...
 *   6. Writes `.npmrc` and `pnpm-workspace.yaml` files for the workspace.
 *   7. Runs `pnpm install --no-frozen-lockfile` in the workspace to regenerate the lockfile.
 *
...
async function main(): Promise<void> {
	...
	ensureWorkspaceScaffold(fullDir, registry);
