...
describeNoCompat("GC InactiveObjectX tests", (getTestObjectProvider) => {
	...
	): Promise<IResponse> => runtime.IFluidHandleContext.resolveHandle(request);
	const runtimeFactory = new ContainerRuntimeFactoryWithDefaultDataStore(
		rootDataObjectWithChildDataObjectFactory,
		[
			[
				rootDataObjectWithChildDataObjectFactory.type,
				Promise.resolve(rootDataObjectWithChildDataObjectFactory),
			],
