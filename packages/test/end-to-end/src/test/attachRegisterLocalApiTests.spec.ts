...
import { IExperimentalComponentRuntime, IContainerRuntime } from "@microsoft/fluid-runtime-definitions";
...
[true, false].forEach((isLocal) => {
    describe(`Attach/Register/Local Api Tests For ${isLocal ? "Local" : "Live"} Container`, () => {
        ...
        const createPeerComponent = async (
            ...
            const peerComponentRuntimeChannel = await containerRuntime.createComponentWithRealizationFn(["default"]);
            const peerComponent =
        ...
        it("Attaching component should not attach unregistered DDS", async () => {
            ...
            const expComponent2Runtime = component2.runtime as IExperimentalComponentRuntime;
            assert.strictEqual(expComponent2Runtime.isLocal(), true,
            ...
            assert.strictEqual(expComponent2Runtime.isLocal(), isLocal,
        ...
        async () => {
            ...
            const expComponent3Runtime = component3.runtime as IExperimentalComponentRuntime;
            assert.strictEqual(expComponent3Runtime.isLocal(), true,
                createTestStatementForLocalLive("Component2", true));
