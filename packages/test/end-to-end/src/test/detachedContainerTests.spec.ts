...
describe("Detached Container", () => {
    ...
    it("Components in detached container", async () => {
        ...
        assert.strictEqual(subComponent.runtime.isRegistered, true, "Component should be registered!!");
    ...
    it("Components in attached container", async () => {
        ...
        assert.strictEqual(testComponent.runtime.isRegistered, true, "Component should be registered!!");
    ...
    it("Load attached container and check for components", async () => {
        ...
        assert.strictEqual(subComponent2.runtime.isRegistered, true, "Component should be registered!!");
    ...
    it("Fire component attach ops during container attach", async () => {
        ...
        // Fire attach op
        peerComponentRuntimeChannel.register();
        await containerP;
        await defPromise.promise;
    });
