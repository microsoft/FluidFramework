...
| Follow the example application, supported boundaries, and run commands | [Text application README](text/README.md)                                                                                         |
...
`text/` contains application code that uses the exported loader and runtime APIs; `text/test/` contains its tests.
