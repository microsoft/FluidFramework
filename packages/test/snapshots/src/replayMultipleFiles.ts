 ...
 * 2. A list of snapshots in the current version. When running in "Compare" mode, snapshots generated by the replay
 *    tool are compared against these.
 * 3. original_snapshots - This optional folder contains a list snapshots in a previous version. When running in
 *    "Validate" mode, a container is loaded from each of these snapshot and ensured that it loads successfully.
 */
