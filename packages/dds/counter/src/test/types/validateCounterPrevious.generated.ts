 ...
 * "Class_SharedCounter": {"forwardCompat": false}
 */
declare type old_as_current_for_Class_SharedCounter = requireAssignableTo<TypeOnly<old.SharedCounter>, TypeOnly<current.SharedCounter>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Class_SharedCounter": {"backCompat": false}
 */
declare type current_as_old_for_Class_SharedCounter = requireAssignableTo<TypeOnly<current.SharedCounter>, TypeOnly<old.SharedCounter>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "ClassStatics_SharedCounter": {"backCompat": false}
 */
declare type current_as_old_for_ClassStatics_SharedCounter = requireAssignableTo<TypeOnly<typeof current.SharedCounter>, TypeOnly<typeof old.SharedCounter>>
