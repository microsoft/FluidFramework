 ...
 * "Class_SharedCell": {"forwardCompat": false}
 */
declare type old_as_current_for_Class_SharedCell = requireAssignableTo<TypeOnly<old.SharedCell>, TypeOnly<current.SharedCell>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Class_SharedCell": {"backCompat": false}
 */
declare type current_as_old_for_Class_SharedCell = requireAssignableTo<TypeOnly<current.SharedCell>, TypeOnly<old.SharedCell>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "ClassStatics_SharedCell": {"backCompat": false}
 */
declare type current_as_old_for_ClassStatics_SharedCell = requireAssignableTo<TypeOnly<typeof current.SharedCell>, TypeOnly<typeof old.SharedCell>>
