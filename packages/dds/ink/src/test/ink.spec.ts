...
describe("Ink", () => {
    ...
    describe("Ink in local state", () => {
        ...
        it("can load an Ink from snapshot", async () => {
            ...
            const services = MockSharedObjectServices.createFromSummary(ink.getAttachSummary().summary);
    ...
    describe("Ink op processing in local state", () => {
        it("should correctly process operations sent in local state", async () => {
            ...
            const services2 = MockSharedObjectServices.createFromSummary(ink.getAttachSummary().summary);
