 ...
 * "Class_ConsensusRegisterCollection": {"forwardCompat": false}
 */
declare type old_as_current_for_Class_ConsensusRegisterCollection = requireAssignableTo<TypeOnly<old.ConsensusRegisterCollection<never>>, TypeOnly<current.ConsensusRegisterCollection<never>>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Class_ConsensusRegisterCollection": {"backCompat": false}
 */
declare type current_as_old_for_Class_ConsensusRegisterCollection = requireAssignableTo<TypeOnly<current.ConsensusRegisterCollection<never>>, TypeOnly<old.ConsensusRegisterCollection<never>>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "ClassStatics_ConsensusRegisterCollection": {"backCompat": false}
 */
declare type current_as_old_for_ClassStatics_ConsensusRegisterCollection = requireAssignableTo<TypeOnly<typeof current.ConsensusRegisterCollection>, TypeOnly<typeof old.ConsensusRegisterCollection>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IConsensusRegisterCollectionFactory": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IConsensusRegisterCollectionFactory = requireAssignableTo<TypeOnly<old.IConsensusRegisterCollectionFactory>, TypeOnly<current.IConsensusRegisterCollectionFactory>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IConsensusRegisterCollectionFactory": {"backCompat": false}
 */
declare type current_as_old_for_Interface_IConsensusRegisterCollectionFactory = requireAssignableTo<TypeOnly<current.IConsensusRegisterCollectionFactory>, TypeOnly<old.IConsensusRegisterCollectionFactory>>
