 ...
 * "Class_SharedMatrix": {"forwardCompat": false}
 */
declare type old_as_current_for_Class_SharedMatrix = requireAssignableTo<TypeOnly<old.SharedMatrix>, TypeOnly<current.SharedMatrix>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Class_SharedMatrix": {"backCompat": false}
 */
declare type current_as_old_for_Class_SharedMatrix = requireAssignableTo<TypeOnly<current.SharedMatrix>, TypeOnly<old.SharedMatrix>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "ClassStatics_SharedMatrix": {"backCompat": false}
 */
declare type current_as_old_for_ClassStatics_SharedMatrix = requireAssignableTo<TypeOnly<typeof current.SharedMatrix>, TypeOnly<typeof old.SharedMatrix>>
