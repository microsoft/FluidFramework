...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/sequence`.

Import the `legacy` APIs from `@fluidframework/sequence/legacy`.

## API Documentation

Read the **@fluidframework/sequence** API documentation at <https://fluidframework.com/docs/apis/sequence>.
