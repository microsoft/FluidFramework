...
import { IFluidHandle, IFluidLoadable, FluidObject } from "@fluidframework/core-interfaces";
import {
    BaseSegment,
    createGroupOp,
    IJSONSegment,
...
export class SparseMatrix extends SharedSegmentSequence<MatrixSegment> {
    ...
    public getItem(row: number, col: number):
        ...
        Jsonable<string | number | boolean | IFluidHandle<FluidObject & IFluidLoadable>> {
