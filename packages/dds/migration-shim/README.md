...
```bash
npm i @fluidframework/migration-shim
```
...
To access the `public` ([SemVer](https://semver.org/)) APIs, import via `@fluidframework/migration-shim` like normal.

To access the `legacy` APIs, import via `@fluidframework/migration-shim/legacy`.

## API Documentation

API documentation for **@fluidframework/migration-shim** is available at <https://fluidframework.com/docs/apis/migration-shim>.
