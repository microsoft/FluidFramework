...
export class MapFactory implements IChannelFactory {
     ...
     */
    public static readonly Type = "https://graph.microsoft.com/types/new-map";
    ...
    public async load(
        ...
        const map = new NewSharedMap(id, runtime, attributes);
    ...
    public create(runtime: IFluidDataStoreRuntime, id: string): ISharedMap {
        const map = new NewSharedMap(id, runtime, MapFactory.Attributes);
        map.initializeLocal();
...
/**
 * The NewSharedMap distributed data structure can be used to store key-value pairs. It provides the same API for setting
 * and retrieving values that JavaScript developers are accustomed to with the
 * {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map | Map} built-in object.
 * However, the keys of a NewSharedMap must be strings.
 */
export class NewSharedMap extends SharedObject<ISharedMapEvents> implements ISharedMap {
     ...
     *
     * @example
     * To create a `NewSharedMap`, call the static create method:
     *
     * ```typescript
     * const myMap = NewSharedMap.create(this.runtime, id);
     * ```
     */
    public static create(runtime: IFluidDataStoreRuntime, id?: string): NewSharedMap {
        return runtime.createChannel(id, MapFactory.Type) as NewSharedMap;
    }

    /**
     * Get a factory for NewSharedMap to register with the data store.
     ...
     */
    public readonly [Symbol.toStringTag]: string = "NewSharedMap";
    ...
    /**
     * Do not call the constructor. Instead, you should use the {@link NewSharedMap.create | create method}.
     *
