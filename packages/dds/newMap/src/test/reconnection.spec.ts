...
describe("Reconnection", () => {
    describe("NewSharedMap", () => {
        ...
        beforeEach(async () => {
            ...
            map1 = new NewSharedMap("shared-map-1", dataStoreRuntime1, MapFactory.Attributes);
            map1.connect(services1);

            // Create the second NewSharedMap.
            ...
            map2 = new NewSharedMap("shared-map-2", dataStoreRuntime2, MapFactory.Attributes);
        ...
        it("can resend unacked ops on reconnection", async () => {
            ...
            // Set a value on the first NewSharedMap.
            map1.set(key, value);
            ...
            // Delete the value from the second NewSharedMap.
            map2.delete(key);
