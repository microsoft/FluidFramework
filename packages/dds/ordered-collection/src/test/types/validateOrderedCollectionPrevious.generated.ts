 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Class_ConsensusQueue": {"forwardCompat": false}
 */
declare type old_as_current_for_Class_ConsensusQueue = requireAssignableTo<TypeOnly<old.ConsensusQueue>, TypeOnly<current.ConsensusQueue>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Class_ConsensusQueue": {"backCompat": false}
 */
declare type current_as_old_for_Class_ConsensusQueue = requireAssignableTo<TypeOnly<current.ConsensusQueue>, TypeOnly<old.ConsensusQueue>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "ClassStatics_ConsensusQueue": {"backCompat": false}
 */
declare type current_as_old_for_ClassStatics_ConsensusQueue = requireAssignableTo<TypeOnly<typeof current.ConsensusQueue>, TypeOnly<typeof old.ConsensusQueue>>
