...
To access the `public` ([SemVer](https://semver.org/)) APIs, import via `@fluidframework/ordered-collection` like normal.

To access the `legacy` APIs, import via `@fluidframework/ordered-collection/legacy`.
