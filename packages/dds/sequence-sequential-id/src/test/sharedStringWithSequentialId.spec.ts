...
describe("SharedStringWithSequential Id", () => {
    ...
    beforeEach(() => {
        ...
        const factory = new SharedStringWithSequentialIdFactory();
        const sharedStringSequentialIdFactory = createStringWithSequentialIdFactory(factory);
    ...
    it("should have a marker id after marker insertion after existing marker", async ()=> {
        ...
        // Casting to avoid null check since we are already validating id is not undefined inside validate marker
        const id0 = segmentAt0.getId() as string;
        const id1 = segmentAt1.getId() as string;
    ...
    it("should have a marker id after marker insertion between two markers", async ()=> {
        ...
        const id0 = segmentAt0.getId() as string;
        const id1 = segmentAt1.getId() as string;
        const id2 = segmentAt2.getId() as string;
        assert(id0 < id1, "Id at 0 should be smaller than id at 1");
