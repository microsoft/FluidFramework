...
A DDS that does not generate ops but is part of summary.
...
- Special DDS that participates in summaries but doesn't generate ops
- Has public, legacy, and internal entry points
- Useful for storing metadata or configuration
