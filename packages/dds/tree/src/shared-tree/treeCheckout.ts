 ...
 * Note that `SharedTree` retains the right to unilaterally dispose of revertibles. This happens when the view that
 * the revertible was generated on is disposed.
 *
 * @public
 */
...
/**
 * A callback invoked after the disposal of a {@link Revertible}.
 * This is typically used to clean up any resources associated with the `Revertible` in host application.
 *
 * @param disposed - the `Revertible` that was disposed.
 *
 * @public
 */
	...
	public constructor(
		...
		branch.on("commitApplied", (data) => {
			...
			const getRevertible = hasSchemaChange(change)
				? undefined
				: (onRevertibleDisposed?: RevertibleDisposedCallback) => {
						assert(
							withinEventContext,
