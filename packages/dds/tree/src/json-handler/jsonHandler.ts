...
export const createResponseHandler: (streamedType: StreamedType, abortController: AbortController) => ResponseHandler =
    getCreateResponseHandler();
...
export const JsonHandler: {
    ...
    streamedStringProperty<Parent extends Record<Key, string | undefined>, Key extends keyof Parent>(args: {
        description?: string;
    ...
    string(args?: { description?: string; complete?: (value: string, partial: PartialArg) => void }): StreamedType;
    ...
    number(args?: { description?: string; complete?: (value: number, partial: PartialArg) => void }): StreamedType;

    boolean(args?: { description?: string; complete?: (value: boolean, partial: PartialArg) => void }): StreamedType;

    // eslint-disable-next-line @rushstack/no-new-null
    null(args?: { description?: string; complete?: (value: null, partial: PartialArg) => void }): StreamedType;
