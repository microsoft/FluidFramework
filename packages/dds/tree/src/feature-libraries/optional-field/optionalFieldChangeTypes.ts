...
export interface Replace {
	 ...
	 *
	 * Note that this ID may refer to the node detached by this OptionalChangeset.
	 ...
	 * The detach portion of an optional field pin should always be represented using `nodeDetach`, rather than `valueReplace.dst`.
	 */
