...
export function splitMoveIn<T>(mark: MoveIn, parts: MoveDstPartition<T>[]): Attach<T>[] {
...
export function splitMoveOut<T>(mark: MoveOut, parts: MoveSrcPartition<T>[]): SizedObjectMark<T>[] {
