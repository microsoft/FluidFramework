...
export function dequeueRelatedReattaches<T>(
    ...
    assert(newMark !== undefined && isReattach(newMark), 0x504 /* No new reattach mark to line up */);
    assert(baseMark !== undefined && isReattach(baseMark), 0x505 /* No base reattach mark to line up */);
