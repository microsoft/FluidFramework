...
import { type ObjectOptions, type Static, type TSchema, Array as _typebox_Array, Composite as _typebox_Composite, Enum as _typebox_Enum, Number as _typebox_Number, Object as _typebox_Object, Optional as _typebox_Optional, Tuple as _typebox_Tuple } from "@sinclair/typebox";
const Type = { Array: _typebox_Array, Composite: _typebox_Composite, Enum: _typebox_Enum, Number: _typebox_Number, Object: _typebox_Object, Optional: _typebox_Optional, Tuple: _typebox_Tuple };
