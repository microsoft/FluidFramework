...
export interface NodeIdentifierManager {
	 ...
	 */
	stabilizeNodeIdentifier(
		identifier: LocalNodeIdentifier,
	): StableNodeIdentifier;
...
class DefaultNodeIdentifierManager implements NodeIdentifierManager {
	public constructor(
		private readonly idCompressor: IIdCompressor | undefined,
	) {}
	...
	public localizeNodeIdentifier(
		identifier: StableNodeIdentifier,
	): LocalNodeIdentifier {
		assert(
			this.idCompressor !== undefined,
	...
	public stabilizeNodeIdentifier(
		...
		return brand(
			...
			assertIsStableId(
				this.idCompressor.decompress(extractFromOpaque(identifier)),
			),
		);
	}
