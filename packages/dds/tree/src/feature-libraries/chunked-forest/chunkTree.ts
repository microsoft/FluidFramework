 ...
 * @param length - how many nodes to process (at the top level). When 0, the cursor is not moved, and may be ad end of field (and this in Fields mode)
...
export function chunkRange(
	...
	assert(
		(cursor.mode === CursorLocationType.Nodes) === (length > 0 || skipLastNavigation),
