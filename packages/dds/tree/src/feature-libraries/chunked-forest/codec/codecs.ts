...
const ChunkReferenceId = brandedNumberType<ChunkReferenceId>({
	multipleOf: 1,
	minimum: 0,
});
 ...
 */
export interface IncrementalEncoderDecoder
	extends IncrementalEncoder,
		IncrementalDecoder {}
...
export function makeFieldBatchCodec(
	...
	const writeVersion = clientVersionToFieldBatchVersion(
...
export function getCodecTreeForFieldBatchFormat(
	...
	return {
		name: "FieldBatch",
		version: clientVersionToFieldBatchVersion(clientVersion),
	};
}
