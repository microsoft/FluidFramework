...
export interface NodeKeys {
	...
	/**
	 * Attempts to recompress a {@link StableNodeKey} back into its {@link LocalNodeKey} form.
	 * @param key - The key to convert.
	 * @returns The {@link LocalNodeKey} associated with `key` or undefined if the UUID was not generated by any session known to this compressor.
	 */
