    ...
    implements Index<TChangeset>, SummaryElement
{
    ...
    public async load(
        ...
        if (await services.contains(blobKey)) {
            ...
            assert(await services.contains(stringKey), 0x428 /* EditManager data is required in summary */);
        ...
        assert(
            ...
            0x429 /* There should not already be stored EditManager data when loading from summary */,
        );
