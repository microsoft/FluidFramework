...
export class ForestRepairDataStore implements RepairDataStore {
    ...
    public getNodes(
        ...
        assert(sparseField !== undefined, 0x479 /* No repair data found */);
        ...
        assert(sparseIndex !== -1, 0x47a /* No repair data found */);
        assert(
        ...
        return sparseField.slice(sparseIndex, sparseIndex + count).map((node) => {
            ...
            assert(repair !== undefined, 0x47c /* No repair data found */);
    ...
    public getValue(revision: RevisionTag, path: UpPath): Value {
        ...
        assert(valueMap?.has(revision) === true, 0x47d /* No repair data found */);
