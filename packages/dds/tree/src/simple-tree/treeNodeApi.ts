...
export interface TreeNodeApi {
	 ...
	 * @remarks
	 * If the node's identifier is a valid UUID that was automatically generated by the SharedTree, then this will return a unique process-local integer corresponding to that identifier.
	 ...
	 *
	 * The returned integer must not be serialized or preserved outside of the current process, i.e. its lifetime is that of the current in-memory instance of the FF runtime.
			...
			if (field.schema.kind === FieldKinds.identifier) {
				if (shortId !== undefined) {
					throw new UsageError(
						"shortId() may not be called on a node with more than one identifier",
					);
				}
