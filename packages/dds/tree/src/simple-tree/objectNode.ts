 ...
 * In this case, only own properties are considered to reduce the risk of incorrectly interpreting data at the cost of occasionally requiring users to convert data into a compatible format.
 *
