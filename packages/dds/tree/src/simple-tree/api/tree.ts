...
export interface TreeBranchEvents {
	 ...
	 *
	 * @deprecated use the {@link TreeBranchEvents.changed | "changed"} event instead which behaves the same way but also gets fired for more scenarios, see its doc comment
	 * for usage details
	 */
