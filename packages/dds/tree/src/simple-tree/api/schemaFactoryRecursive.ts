...
import type { FieldSchemaUnsafe, UnenforcedImplicitAllowedTypes } from "./typesUnsafe.js";

export function createFieldSchemaUnsafe<
	Kind extends FieldKind,
	Types extends UnenforcedImplicitAllowedTypes,
>(
	kind: Kind,
	allowedTypes: Types,
	...
	return createFieldSchema(kind, allowedTypes as AllowedTypes, props) as FieldSchemaUnsafe<
		Kind,
		Types
	>;
}
