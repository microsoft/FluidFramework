...
export interface Transactor {
	 ...
	 *
	 * @remarks
	 * Asynchronous transactions are not supported on the root checkout,
	 * since it is always kept up-to-date with the latest remote edits and the results of this rebasing (which might invalidate the transaction) is not visible to the application author.
	 * Instead:
	 *
