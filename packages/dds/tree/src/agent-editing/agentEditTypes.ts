 ...
 */
const agentEditSchemaCache = new WeakMap<TreeNodeSchema, OAIJsonNodeSchema>();

export function generateAgentEditSchema(
 ...
 * @alpha
 */
export type OAIJsonSchemaId = string;

/**
 * Reference string pointing to a definition in the schema.
 * @alpha
 */
export type OAIJsonRefPath = `#/$defs/${OAIJsonSchemaId}`;
 ...
 * @alpha
 */
export type OAIJsonSchemaType = "object" | "array" | OAIJsonLeafSchemaType;
 ...
 * @alpha
 */
export type OAIJsonLeafSchemaType = "string" | "number" | "boolean" | "null";
 ...
 * @alpha
 */
export interface OAIJsonNodeSchemaBase<TJsonSchemaType extends OAIJsonSchemaType> {
	/**
 ...
 * @alpha
 */
export interface OAIJsonObjectNodeSchema extends OAIJsonNodeSchemaBase<"object"> {
	/**
	 * Object fields.
	 * @remarks Required fields should have a corresponding entry in {@link OAIJsonObjectNodeSchema.required}.
	 * @see {@link https://json-schema.org/draft/2020-12/json-schema-core#name-properties}.
	 */
	readonly properties: Record<string, OAIJsonFieldSchema>;

	/**
	 * List of keys for all fields, as required by OpenAI.
	 * Each key specified must have an entry in {@link OAIJsonObjectNodeSchema.properties}.
	 */
 ...
 * @alpha
 */
export interface OAIJsonLeafNodeSchema extends OAIJsonNodeSchemaBase<OAIJsonLeafSchemaType> {
	/**
	 * Primitive type.
	 * @see {@link https://json-schema.org/draft/2020-12/json-schema-core#name-instance-data-model}.
	 */
	readonly type: OAIJsonLeafSchemaType;
}
 ...
 * @alpha
 */
export interface OAIJsonSchemaRef {
	/**
 ...
 * @alpha
 */
export type OAIJsonNodeSchema =
	| OAIJsonLeafNodeSchema
	| OAIJsonArrayNodeSchema
	| OAIJsonObjectNodeSchema;
 ...
 * @alpha
 */
export type OAIJsonFieldSchema = {
	/**
	...
	| {
			 ...
			 */
			readonly anyOf: OAIJsonSchemaRef[];
	  }
	| OAIJsonSchemaRef
);

/**
 * OpenAI allowed subset of JSON Schema.
 *
 * @sealed
 * @alpha
 */
export type OAIJsonSchema = OAIJsonNodeSchema & {
	/**
	 ...
	 */
	readonly $defs: Record<OAIJsonSchemaId, OAIJsonNodeSchema>;
};
