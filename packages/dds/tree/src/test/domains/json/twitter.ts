...
function generateTwitterStatus(type: "standard" | "retweet", random: IRandom,
    textFieldMarkovChain: SpaceEfficientWordMarkovChain, userDescFieldMarkovChain: SpaceEfficientWordMarkovChain,
    alphabet: string) {
...
function generateTwitterUser(random: IRandom, userDescFieldMarkovChain: SpaceEfficientWordMarkovChain,
...
export function getTwitterJsonTextFieldWordMarkovChain(): Record<string, [string, number][]> {
    return {
        ...
        "、...": [
            [
                "http://t.co/toQgVlXPyH",
                1,
            ],
            [
                "http://t.co/RNdqIHmTby",
                1,
            ],
        ],
        "http://t.co/toQgVlXPyH": [
...
export function getTwitterJsonUserDescFieldWordMarkovChain(): Record<string, [string, number][]> {
    return {
        ...
        "MARKOV_SENTENCE_BEGIN_KEY_01$#@%^#": [
            ...
            [
                "2310*basketball#41*UVERworld*Pooh☪Bell",
                1,
            ],
            [
                "宮",
