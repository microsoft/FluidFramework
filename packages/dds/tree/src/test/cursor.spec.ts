...
// import { ITreeCursorNew, TreeNavigationResult } from "../forest";
...
//     suiteName: string,
//     factory: (data?: Jsonable) => ITreeCursorNew,
...
//             function expectNotFound(cursor: ITreeCursorNew, key: FieldKey, index = 0) {
...
// function traverseNode(cursor: ITreeCursorNew) {
...
//     suiteName: string,
//     cursors: { cursorName: string; cursor: ITreeCursorNew; }[]) {
