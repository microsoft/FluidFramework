...
describe("schemaFactory", () => {
	...
	it("scopedFactory", () => {
		...
		type Scope = typeof scopedFactory extends SchemaFactoryBeta<infer S>
			? S
			: never;
	...
	it("scopedFactoryAlpha", () => {
		...
		type Scope = typeof scopedFactory extends SchemaFactoryAlpha<infer S>
			? S
			: never;
