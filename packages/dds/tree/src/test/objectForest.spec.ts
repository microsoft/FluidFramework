...
import { fieldSchema, rootFieldKey, SchemaData, StoredSchemaRepository } from "../schema-stored";
...
testForest(
	"object-forest",
	() => new ObjectForest(new StoredSchemaRepository(defaultSchemaPolicy, schemaData)),
);
