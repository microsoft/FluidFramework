...
describe("SessionIdNormalizer", () => {
    it("fails when adding finals with no corresponding locals", () => {
        ...
        assert.throws(
            ...
            new Error("Final IDs must be added to an existing local range."),
        );
    });
    ...
    it("fails when adding finals out of order", () => {
        ...
        assert.throws(
            ...
            new Error("Malformed normalization range."),
        );
    });
    ...
    it("fails when gaps in finals do not align with a local", () => {
        ...
        assert.throws(
            ...
            new Error("Gaps in final space must align to a local."),
        );
    });
    ...
    it("fails when attempting to normalize a local ID that was never registered", () => {
        ...
        assert.throws(
            ...
            new Error("Local ID was never recorded with this normalizer."),
        );
