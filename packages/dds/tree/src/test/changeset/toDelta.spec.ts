        ...
        const changeset: T.MarkList = [{
            ...
            fields: {
                foo: [
                    ...
                    {
                        type: "Modify",
                        value: { type: "Set", id: opId, value: 1 },
                    },
                ],
            },
        }];
        ...
        it("values", () => {
            const changeset: T.MarkList = [
                [{
                    ...
                    id: opId,
                    content: content[0],
                    value: { type: "Set", id: opId, value: 4242 },
                    fields: {
                        foo: [{
                            type: "Modify",
                            value: { type: "Set", id: opId, value: 4343 },
                        }],
                    },
                }],
            ];
                    ...
                    fields: {
                        foo: [
                            ...
                            [{
                                ...
                                id: opId,
                                content: { type, value: 45 },
                                value: { type: "Set", id: opId, value: 4545 },
                            }],
                        ],
                    },
                }],
