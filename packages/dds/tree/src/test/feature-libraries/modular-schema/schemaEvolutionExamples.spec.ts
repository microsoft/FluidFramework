...
describe("Schema Evolution Examples", () => {
	...
	it("basic usage", () => {
...

		{
			...
			assert.deepEqual(compat, { canView: false, canUpgrade: false, isEquivalent: false, enabledUpgrades: new Map() });
...

		{
			...
			assert.deepEqual(compatNew, { canView: true, canUpgrade: true, isEquivalent: true, enabledUpgrades: new Map() });
			...
			assert.deepEqual(compat2, { canView: false, canUpgrade: true, isEquivalent: false, enabledUpgrades: new Map() });
			...
			assert.deepEqual(compat3, { canView: true, canUpgrade: true, isEquivalent: true, enabledUpgrades: new Map() });
		}
	});
