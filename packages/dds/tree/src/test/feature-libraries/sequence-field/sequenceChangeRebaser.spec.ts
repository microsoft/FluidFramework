...
describeForBothConfigs("SequenceField - Rebaser Axioms", (config) => {
...
describeForBothConfigs("SequenceField - Sandwich Rebasing", (config) => {
	const withConfig = (fn: () => void) => withOrderingMethod(config.cellOrdering, fn);
...
describeForBothConfigs("SequenceField - Examples", (config) => {
	const withConfig = (fn: () => void) => withOrderingMethod(config.cellOrdering, fn);
