...
}) & { readonly [Property in keyof TEnum]: TreeNodeSchemaClass<TScope extends undefined ? `${TEnum[Property]}` : `${TScope}.${TEnum[Property]}`, NodeKind.Object, object & TreeNode & ObjectFromSchemaRecord<EmptyObject> & {
...
export function enumFromStrings<TScope extends string, const Members extends string>(factory: SchemaFactory<TScope>, members: Members[]): (<TValue extends Members>(value: TValue) => object & TreeNode & ObjectFromSchemaRecord<EmptyObject> & {
    readonly value: TValue;
}) & Record<Members, TreeNodeSchemaClass<TScope extends undefined ? `${Members}` : `${TScope}.${Members}`, NodeKind.Object, object & TreeNode & ObjectFromSchemaRecord<EmptyObject> & {
...
// @public @sealed
export class SchemaFactory<TScope extends string | undefined = string, TName extends number | string = string> {
    ...
    array<const Name extends TName, const T extends ImplicitAllowedTypes>(name: Name, allowedTypes: T): TreeNodeSchemaClass<TScope extends undefined ? `${Name}` : `${TScope}.${Name}`, NodeKind.Array, TreeArrayNode<T> & WithType<TScope extends undefined ? `${Name}` : `${TScope}.${Name}`>, Iterable<InsertableTreeNodeFromImplicitAllowedTypes<T>>, true>;
    ...
    map<Name extends TName, const T extends ImplicitAllowedTypes>(name: Name, allowedTypes: T): TreeNodeSchemaClass<TScope extends undefined ? `${Name}` : `${TScope}.${Name}`, NodeKind.Map, TreeMapNode<T> & WithType<TScope extends undefined ? `${Name}` : `${TScope}.${Name}`>, ReadonlyMap<string, InsertableTreeNodeFromImplicitAllowedTypes<T>>, true>;
    namedArray_internal<Name extends TName | string, const T extends ImplicitAllowedTypes, const ImplicitlyConstructable extends boolean>(name: Name, allowedTypes: T, customizable: boolean, implicitlyConstructable: ImplicitlyConstructable): TreeNodeSchemaClass<TScope extends undefined ? `${Name}` : `${TScope}.${Name}`, NodeKind.Array, TreeArrayNode<T> & WithType<`${TScope}.${string}`>, Iterable<InsertableTreeNodeFromImplicitAllowedTypes<T>>, ImplicitlyConstructable>;
    namedMap_internal<Name extends TName | string, const T extends ImplicitAllowedTypes, const ImplicitlyConstructable extends boolean>(name: Name, allowedTypes: T, customizable: boolean, implicitlyConstructable: ImplicitlyConstructable): TreeNodeSchemaClass<TScope extends undefined ? `${Name}` : `${TScope}.${Name}`, NodeKind.Map, TreeMapNode<T> & WithType<TScope extends undefined ? `${Name}` : `${TScope}.${Name}`>, ReadonlyMap<string, InsertableTreeNodeFromImplicitAllowedTypes<T>>, ImplicitlyConstructable>;
    readonly null: TreeNodeSchema<"com.fluidframework.leaf.null", NodeKind.Leaf, null, null>;
    readonly number: TreeNodeSchema<"com.fluidframework.leaf.number", NodeKind.Leaf, number, number>;
    object<const Name extends TName, const T extends RestrictiveReadonlyRecord<string, ImplicitFieldSchema>>(name: Name, t: T): TreeNodeSchemaClass<TScope extends undefined ? `${Name}` : `${TScope}.${Name}`, NodeKind.Object, object & TreeNode & ObjectFromSchemaRecord<T> & WithType<TScope extends undefined ? `${Name}` : `${TScope}.${Name}`>, object & InsertableObjectFromSchemaRecord<T>, true>;
...
// @internal
export function singletonSchema<TScope extends string, TName extends string | number>(factory: SchemaFactory<TScope, TName>, name: TName): TreeNodeSchemaClass<TScope extends undefined ? `${TName}` : `${TScope}.${TName}`, NodeKind.Object, object & TreeNode & ObjectFromSchemaRecord<EmptyObject> & {
