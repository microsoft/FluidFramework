...
export namespace FormattedTextAsTreeDefault {
    ...
    const // (undocumented)
    CharacterFormat_base: TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.CharacterFormat", import("../simple-tree/index.js").NodeKind.Object, TreeObjectNode<    {
    readonly bold: LeafSchema<"boolean", boolean>;
    readonly italic: LeafSchema<"boolean", boolean>;
    readonly underline: LeafSchema<"boolean", boolean>;
    readonly size: LeafSchema<"number", number>;
    readonly font: LeafSchema<"string", string>;
    ...
    const LineTag: (<TValue extends "ol" | "li" | "h1" | "h2" | "h3" | "h4" | "h5" | "checked" | "unchecked" | "blockquote" | "codeBlock">(value: TValue) => TValue extends unknown ? TreeNode & {
        readonly value: TValue;
    } : never) & {
        h1: TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.lineTag.h1" | "com.h1", import("../simple-tree/index.js").NodeKind.Object, TreeNode & {
        readonly value: "h1";
        }, Record<string, never>, true, Record<string, never>, undefined>;
        h3: TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.lineTag.h3" | "com.h3", import("../simple-tree/index.js").NodeKind.Object, TreeNode & {
        readonly value: "h3";
        }, Record<string, never>, true, Record<string, never>, undefined>;
        h2: TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.lineTag.h2" | "com.h2", import("../simple-tree/index.js").NodeKind.Object, TreeNode & {
        readonly value: "h2";
        }, Record<string, never>, true, Record<string, never>, undefined>;
        codeBlock: TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.lineTag.codeBlock" | "com.codeBlock", import("../simple-tree/index.js").NodeKind.Object, TreeNode & {
        readonly value: "codeBlock";
        }, Record<string, never>, true, Record<string, never>, undefined>;
        h4: TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.lineTag.h4" | "com.h4", import("../simple-tree/index.js").NodeKind.Object, TreeNode & {
        readonly value: "h4";
        }, Record<string, never>, true, Record<string, never>, undefined>;
        unchecked: TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.lineTag.unchecked" | "com.unchecked", import("../simple-tree/index.js").NodeKind.Object, TreeNode & {
        readonly value: "unchecked";
        }, Record<string, never>, true, Record<string, never>, undefined>;
        h5: TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.lineTag.h5" | "com.h5", import("../simple-tree/index.js").NodeKind.Object, TreeNode & {
        readonly value: "h5";
        }, Record<string, never>, true, Record<string, never>, undefined>;
        li: TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.lineTag.li" | "com.li", import("../simple-tree/index.js").NodeKind.Object, TreeNode & {
        readonly value: "li";
        }, Record<string, never>, true, Record<string, never>, undefined>;
        ol: TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.lineTag.ol" | "com.ol", import("../simple-tree/index.js").NodeKind.Object, TreeNode & {
        readonly value: "ol";
        }, Record<string, never>, true, Record<string, never>, undefined>;
        checked: TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.lineTag.checked" | "com.checked", import("../simple-tree/index.js").NodeKind.Object, TreeNode & {
        readonly value: "checked";
        }, Record<string, never>, true, Record<string, never>, undefined>;
        blockquote: TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.lineTag.blockquote" | "com.blockquote", import("../simple-tree/index.js").NodeKind.Object, TreeNode & {
        readonly value: "blockquote";
        }, Record<string, never>, true, Record<string, never>, undefined>;
    } & {
        readonly schema: [TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.lineTag.ol" | "com.ol", import("../simple-tree/index.js").NodeKind.Object, TreeNode & {
        readonly value: "ol";
        }, Record<string, never>, true, Record<string, never>, undefined>, TreeNodeSchemaCore<"com.fluidframework.text.formatted.default.lineTag.li" | "com.li", import("../simple-tree/index.js").NodeKind.Object, true, Record<string, never>, Record<string, never>, unknown> & (new (data?: Record<string, never> | InternalTreeNode | undefined) => TreeNode & {
            readonly value: "li";
        }), TreeNodeSchemaCore<"com.fluidframework.text.formatted.default.lineTag.h1" | "com.h1", import("../simple-tree/index.js").NodeKind.Object, true, Record<string, never>, Record<string, never>, unknown> & (new (data?: Record<string, never> | InternalTreeNode | undefined) => TreeNode & {
            readonly value: "h1";
        }), TreeNodeSchemaCore<"com.fluidframework.text.formatted.default.lineTag.h2" | "com.h2", import("../simple-tree/index.js").NodeKind.Object, true, Record<string, never>, Record<string, never>, unknown> & (new (data?: Record<string, never> | InternalTreeNode | undefined) => TreeNode & {
            readonly value: "h2";
        }), TreeNodeSchemaCore<"com.fluidframework.text.formatted.default.lineTag.h3" | "com.h3", import("../simple-tree/index.js").NodeKind.Object, true, Record<string, never>, Record<string, never>, unknown> & (new (data?: Record<string, never> | InternalTreeNode | undefined) => TreeNode & {
            readonly value: "h3";
        }), TreeNodeSchemaCore<"com.fluidframework.text.formatted.default.lineTag.h4" | "com.h4", import("../simple-tree/index.js").NodeKind.Object, true, Record<string, never>, Record<string, never>, unknown> & (new (data?: Record<string, never> | InternalTreeNode | undefined) => TreeNode & {
            readonly value: "h4";
        }), TreeNodeSchemaCore<"com.fluidframework.text.formatted.default.lineTag.h5" | "com.h5", import("../simple-tree/index.js").NodeKind.Object, true, Record<string, never>, Record<string, never>, unknown> & (new (data?: Record<string, never> | InternalTreeNode | undefined) => TreeNode & {
            readonly value: "h5";
        }), TreeNodeSchemaCore<"com.fluidframework.text.formatted.default.lineTag.checked" | "com.checked", import("../simple-tree/index.js").NodeKind.Object, true, Record<string, never>, Record<string, never>, unknown> & (new (data?: Record<string, never> | InternalTreeNode | undefined) => TreeNode & {
            readonly value: "checked";
        }), TreeNodeSchemaCore<"com.fluidframework.text.formatted.default.lineTag.unchecked" | "com.unchecked", import("../simple-tree/index.js").NodeKind.Object, true, Record<string, never>, Record<string, never>, unknown> & (new (data?: Record<string, never> | InternalTreeNode | undefined) => TreeNode & {
            readonly value: "unchecked";
        }), TreeNodeSchemaCore<"com.fluidframework.text.formatted.default.lineTag.blockquote" | "com.blockquote", import("../simple-tree/index.js").NodeKind.Object, true, Record<string, never>, Record<string, never>, unknown> & (new (data?: Record<string, never> | InternalTreeNode | undefined) => TreeNode & {
            readonly value: "blockquote";
        }), TreeNodeSchemaCore<"com.fluidframework.text.formatted.default.lineTag.codeBlock" | "com.codeBlock", import("../simple-tree/index.js").NodeKind.Object, true, Record<string, never>, Record<string, never>, unknown> & (new (data?: Record<string, never> | InternalTreeNode | undefined) => TreeNode & {
            readonly value: "codeBlock";
        })];
    };
    // @sealed
    ...
    const // (undocumented)
    StringLineAtom_base: TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.StringLineAtom", import("../simple-tree/index.js").NodeKind.Object, TreeObjectNode<    {
    readonly tag: [TreeNodeSchemaClass<"com.fluidframework.text.formatted.default.lineTag.ol" | "com.ol", import("../simple-tree/index.js").NodeKind.Object, TreeNode & {
    readonly value: "ol";
    }, Record<string, never>, true, Record<string, never>, undefined>, TreeNodeSchemaCore<"com.fluidframework.text.formatted.default.lineTag.li" | "com.li", import("../simple-tree/index.js").NodeKind.Object, true, Record<string, never>, Record<string, never>, unknown> & (new (data?: Record<string, never> | InternalTreeNode | undefined) => TreeNode & {
    readonly value: "li";
    }), TreeNodeSchemaCore<"com.fluidframework.text.formatted.default.lineTag.h1" | "com.h1", import("../simple-tree/index.js").NodeKind.Object, true, Record<string, never>, Record<string, never>, unknown> & (new (data?: Record<string, never> | InternalTreeNode | undefined) => TreeNode & {
    ...
    readonly indent: LeafSchema<"number", number>;
    }, "com.fluidframework.text.formatted.default.StringLineAtom">, object & {
    readonly tag: Record<string, never> | (Record<string, never> & TreeNode & {
    readonly value: "ol";
    }) | (Record<string, never> & TreeNode & {
    readonly value: "li";
    }) | (Record<string, never> & TreeNode & {
    readonly value: "h1";
    }) | (Record<string, never> & TreeNode & {
    ...
    const // @sealed
    StringAtomContent: readonly [FormattedTextAsTree.StringTextAtomStatics & TreeNodeSchema<"com.fluidframework.text.formatted.StringTextAtom", NodeKind, FormattedTextAsTree.TextAtom & TreeNode & WithType<"com.fluidframework.text.formatted.StringTextAtom", NodeKind, unknown>, never, false>, typeof StringLineAtom];
    // @sealed
    ...
    const // (undocumented)
    Tree_base: FormattedTextAsTree.FormattedTextSchema<"com.fluidframework.text.formatted.default", typeof CharacterFormat, readonly [typeof StringLineAtom]>;
    // @sealed
