...
// @alpha
export function withMetadata<const TNewCustomMetadata, const TName extends string = string, const TKind extends NodeKind = NodeKind, const TNode extends TreeNode = TreeNode, const TInsertable = never, const ImplicitlyConstructable extends boolean = boolean, const Info = unknown, const TConstructorExtra = never>(nodeSchema: TreeNodeSchemaClass<TName, TKind, TNode, TInsertable, ImplicitlyConstructable, Info, TConstructorExtra>, metadata: NodeSchemaMetadata<TNewCustomMetadata>): TreeNodeSchemaClass<TName, TKind, TNode, TInsertable, ImplicitlyConstructable, Info, TConstructorExtra, TNewCustomMetadata>;
