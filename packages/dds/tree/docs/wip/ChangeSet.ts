 ...
 * - Constraints
 *   - Implicit constraints from built-in operations
 ...
 */
interface Attach extends SequencedSegment {
	/**
 ...
 */
 interface Detach extends SequencedSegment {
	/**
 ...
 */
interface MoveOut extends Detach {
	type?: 'MoveOut';
	/**
 ...
 * - other modifications (Insert, MoveIn, MoveOut) are represented by adding a segment in the relevant ProtoTrait.
 */
type ProtoTrait = (ProtoNode | Insert | MoveIn | MoveOut | Delete)[];
