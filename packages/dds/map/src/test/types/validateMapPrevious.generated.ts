...
import type * as old from "@fluidframework/map-previous/legacy";

import type * as current from "@fluidframework/map/legacy";
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_FluidMapLegacy": {"backCompat": false}
 */
declare type current_as_old_for_Interface_FluidMapLegacy = requireAssignableTo<TypeOnly<current.FluidMapLegacy<never,never>>, TypeOnly<old.FluidMapLegacy<never,never>>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_ISharedMapBeta": {"backCompat": false}
 */
declare type current_as_old_for_Interface_ISharedMapBeta = requireAssignableTo<TypeOnly<current.ISharedMapBeta>, TypeOnly<old.ISharedMapBeta>>
