...
import { HandlesEncoded, IFluidSerializer, ValueType } from "@fluidframework/shared-object-base";
...
export class MapKernel {
	...
	public constructor(
		...
		private readonly submitMessage: (op: HandlesEncoded, localOpMetadata: unknown) => void,
