...
describe("client.applyMsg", () => {
    ...
    it("getContainingSegment with op", () => {
        ...
        let seg = clientA.getContainingSegment(2, { referenceSequenceNumber: insertMessage2.referenceSequenceNumber, clientId: clientA.getOrAddShortClientId(insertMessage2.clientId)});
        ...
        seg = clientA.getContainingSegment(2, { referenceSequenceNumber: insertMessage3.referenceSequenceNumber, clientId: clientA.getOrAddShortClientId(insertMessage3.clientId)});
