...
To access the `public` ([SemVer](https://semver.org/)) APIs, import via `@fluidframework/shared-object-base` like normal.

To access the `legacy` APIs, import via `@fluidframework/shared-object-base/legacy`.
