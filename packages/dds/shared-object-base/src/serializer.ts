...
import { parseHandlesInternal } from "./utils.js";
...
export interface IFluidSerializer {
	 ...
	 * See {@link IFluidSerializer.stringify} as a function that will serialize content with handles to a string.
	 */
...
export class FluidSerializer implements IFluidSerializer {
	...
	public encode(input: unknown, bind: IFluidHandleInternal): unknown {
		...
		return !!input && typeof input === "object"
			? recursivelyReplace(input, this.encodeValue.bind(this), bind)
			: input;
	}
	...
	public decode(input: unknown): unknown {
		...
		// eslint-disable-next-line @typescript-eslint/strict-boolean-expressions
		return !!input && typeof input === "object"
			? recursivelyReplace(input, this.decodeValue.bind(this))
			: input;
	}
	...
	protected decodeValue(value: unknown): unknown {
		return parseHandlesInternal(value, this.root, this.context);
	}
 ...
 */
export function recursivelyReplace<TContext = unknown>(
	input: object,
