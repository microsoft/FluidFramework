...
export abstract class SharedObject<TEvent extends ISharedObjectEvents = ISharedObjectEvents>
    ...
    protected get serializer(): IFluidSerializer {
        ...
        assert(!this._isSummarizing,
            "sc:0061" /* SummarySerializer should be used for serializing data during summary. */);
    ...
    public summarize(fullTree: boolean = false, trackState: boolean = false): IChannelSummarizeResult {
        ...
        assert(!this._isSummarizing, "sc:0062" /* Possible re-entrancy! Summary should not already be in progress. */);
        ...
        try {
            ...
            assert(this._isSummarizing, "sc:0063" /* Possible re-entrancy! Summary should have been in progress. */);
        } finally {
    ...
    public getGCData(fullGC: boolean = false): IGarbageCollectionData {
        ...
        // to serialize handles in this object's data. The routes of these serialized handles are outbound routes
        // to other Fluid objects.
        assert(!this._isSummarizing, "sc:0064" /* Possible re-entrancy! Summary should not already be in progress. */);
        this._isSummarizing = true;
        ...
        try {
            ...
            assert(this._isSummarizing, "sc:0065" /* Possible re-entrancy! Summary should have been in progress. */);
        } finally {
            this._isSummarizing = false;
        }
    ...
    private attachDeltaHandler() {
        ...
        assert(this.services !== undefined, "sc:0066" /* Services should be there to attach delta handler */);
        this._isBoundToContext = true;
