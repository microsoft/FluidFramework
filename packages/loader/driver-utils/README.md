...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/driver-utils`.

Import the `legacy` APIs from `@fluidframework/driver-utils/legacy`.

## API Documentation

Read the **@fluidframework/driver-utils** API documentation at <https://fluidframework.com/docs/apis/driver-utils>.
