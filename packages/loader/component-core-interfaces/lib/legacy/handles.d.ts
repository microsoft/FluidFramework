...
export declare const IComponentHandleContext: keyof IProvideComponentHandleContext;
...
export declare const IComponentHandle: keyof IProvideComponentHandle;
 ...
 */
export interface IComponentHandle<T = IComponent & IComponentLoadable> extends IComponentHandleContext, IProvideComponentHandle {
    /**
