    ...
    IEventProvider<IDeltaManagerInternalEvents>
{
    ...
    private _clientSequenceNumberObserved = 0;
    ...
    public get clientSequenceNumberObserved(): number {
        return this._clientSequenceNumberObserved;
    }

    public get clientSequenceNumber(): number {
    ...
    private async connectCore(args: IConnectionArgs): Promise<IDocumentDeltaConnection> {
        ...
        if (this._clientSequenceNumberObserved !== this._clientSequenceNumber) {
            requestedMode = "write";
        }
    ...
    public submit(type: MessageType, contents: any, batch = false, metadata?: any): number {
        ...
        if (this.lastSubmittedClientId !== this.connection?.clientId) {
            ...
            this._clientSequenceNumberObserved = 0;
        }
    ...
    private processInboundMessage(message: ISequencedDocumentMessage): void {
        ...
        if (this.lastSubmittedClientId !== undefined && this.lastSubmittedClientId === message.clientId) {
            ...
            assert(this._clientSequenceNumberObserved < clientSequenceNumber, "client seq# not growing");
            assert(clientSequenceNumber <= this.clientSequenceNumber,
                "Incoming local client seq# > generated by this client");

            this._clientSequenceNumberObserved = clientSequenceNumber;
        }
