...
export class ContainerContext implements IContainerContext {
    public static async createOrLoad(
        ...
        quorum: IQuorum,
        loader: ILoader,
        submitFn: (type: MessageType, contents: unknown, batch: boolean, appData: any) => number,
    ...
    constructor(
        ...
        public readonly submitFn: (type: MessageType, contents: unknown, batch: boolean, appData: any) => number,
