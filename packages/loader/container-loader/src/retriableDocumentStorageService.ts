...
import { CreateContainerCloseError, GenericError } from "@fluidframework/container-utils";
import {
...
export class RetriableDocumentStorageService implements IDocumentStorageService, IDisposable {
    ...
    private checkStorageDisposed() {
        if (this._disposed) {
            return {
                retry: false,
                error: new GenericError("Storage service disposed!!", "Storage service disposed!!"),
            };
        }
