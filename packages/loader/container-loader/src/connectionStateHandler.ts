 ...
 */
export class ConnectionStateHandlerPassThrough implements IConnectionStateHandler, IConnectionStateHandlerInputs {
...
export class ConnectionStateCatchup extends ConnectionStateHandlerPassThrough {
    ...
    public connectionStateChanged(value: ConnectionState, oldState: ConnectionState, reason?: string | undefined) {
        switch (value) {
            ...
            case ConnectionState.CatchingUp:
                ...
                this.catchUpMonitor = this.deltaManager !== undefined
    ...
    private readonly transitionToConnectedState = () => {
        ...
        const inConnectingState = state === ConnectionState.Connecting;
        logIfFalse(
            inConnectingState,
            this.inputs.logger,
            { eventName: "cannotTransitionToConnectedState", connectionState: ConnectionState[state] });
