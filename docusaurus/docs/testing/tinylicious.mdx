...
You can use TinyliciousClient to create and load Fluid containers with Tinylicious. Check out the [DiceRoller tutorial](../getting-started/tutorial) for an example setting up the Tinylicious client and server.
