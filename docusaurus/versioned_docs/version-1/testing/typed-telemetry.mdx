...
![Logs on App Insights Portal](https://fluidframework.blob.core.windows.net/static/assets/telemetry_1.png)
...
![Query result](https://fluidframework.blob.core.windows.net/static/assets/telemetry_2.png)
...
![Total sessions over time period](https://fluidframework.blob.core.windows.net/static/assets/telemetry_3.png)
...
![Average number of sessions over time period](https://fluidframework.blob.core.windows.net/static/assets/telemetry_4.png)
...
![Average number of containers per session over time period](https://fluidframework.blob.core.windows.net/static/assets/telemetry_5.png)
...
![Length of Individual Sessions in Minutes](https://fluidframework.blob.core.windows.net/static/assets/telemetry_6.png)
...
1. Adjusting the date span of the query
    ...
    ![Adjusting date](https://fluidframework.blob.core.windows.net/static/assets/telemetry_time_period.png)
