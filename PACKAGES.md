...
| Packages | Layer Dependencies |
| --- | --- |
| - [@fluid-example/app-integration-external-controller](/examples/service-clients/azure-client/external-controller) (private)</br>&nbsp;</br>&nbsp;</br>&nbsp;</br>&nbsp; | - [Runtime](#Runtime)</br>- [Framework](#Framework)</br>- [UberPackage](#UberPackage)</br>- [Tinylicious-Driver](#Tinylicious-Driver)</br>- [ServiceClients](#ServiceClients) |
