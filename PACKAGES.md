...
| Packages | Layer Dependencies |
| --- | --- |
| - [@fluid-example/app-integration-external-controller](/examples/service-clients/azure-client/external-controller) (private)</br>&nbsp;</br>&nbsp;</br>&nbsp;</br>&nbsp; | - [Telemetry-Utils](#Telemetry-Utils)</br>- [Runtime](#Runtime)</br>- [UberPackage](#UberPackage)</br>- [Routerlicious-Driver](#Routerlicious-Driver)</br>- [ServiceClients](#ServiceClients) |
