...
import rushstackSecurityPlugin from "@rushstack/eslint-plugin-security";
...
/**
 * "Minimal" eslint configuration for ESLint v9.
 *
...
export default [
    ...
    prettierConfig,
    {
        plugins: {
            ...
            "@rushstack/security": rushstackSecurityPlugin,
            "jsdoc": jsdocPlugin,
