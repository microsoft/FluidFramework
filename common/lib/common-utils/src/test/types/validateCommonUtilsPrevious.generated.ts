 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Class_BatchManager": {"forwardCompat": false}
 */
// @ts-expect-error compatibility expected to be broken
declare type old_as_current_for_Class_BatchManager = requireAssignableTo<TypeOnly<old.BatchManager<never>>, TypeOnly<current.BatchManager<never>>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Class_BatchManager": {"backCompat": false}
 */
// @ts-expect-error compatibility expected to be broken
declare type current_as_old_for_Class_BatchManager = requireAssignableTo<TypeOnly<current.BatchManager<never>>, TypeOnly<old.BatchManager<never>>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "ClassStatics_BatchManager": {"backCompat": false}
 */
// @ts-expect-error compatibility expected to be broken
declare type current_as_old_for_ClassStatics_BatchManager = requireAssignableTo<TypeOnly<typeof current.BatchManager>, TypeOnly<typeof old.BatchManager>>
