 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IHelpMessage": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IHelpMessage = requireAssignableTo<TypeOnly<old.IHelpMessage>, TypeOnly<current.IHelpMessage>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IHelpMessage": {"backCompat": false}
 */
declare type current_as_old_for_Interface_IHelpMessage = requireAssignableTo<TypeOnly<current.IHelpMessage>, TypeOnly<old.IHelpMessage>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IQueueMessage": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_IQueueMessage = requireAssignableTo<TypeOnly<old.IQueueMessage>, TypeOnly<current.IQueueMessage>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_IQueueMessage": {"backCompat": false}
 */
declare type current_as_old_for_Interface_IQueueMessage = requireAssignableTo<TypeOnly<current.IQueueMessage>, TypeOnly<old.IQueueMessage>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_ISummaryAuthor": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_ISummaryAuthor = requireAssignableTo<TypeOnly<old.ISummaryAuthor>, TypeOnly<current.ISummaryAuthor>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_ISummaryAuthor": {"backCompat": false}
 */
declare type current_as_old_for_Interface_ISummaryAuthor = requireAssignableTo<TypeOnly<current.ISummaryAuthor>, TypeOnly<old.ISummaryAuthor>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_ISummaryCommitter": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_ISummaryCommitter = requireAssignableTo<TypeOnly<old.ISummaryCommitter>, TypeOnly<current.ISummaryCommitter>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_ISummaryCommitter": {"backCompat": false}
 */
declare type current_as_old_for_Interface_ISummaryCommitter = requireAssignableTo<TypeOnly<current.ISummaryCommitter>, TypeOnly<old.ISummaryCommitter>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_ISummaryConfiguration": {"forwardCompat": false}
 */
declare type old_as_current_for_Interface_ISummaryConfiguration = requireAssignableTo<TypeOnly<old.ISummaryConfiguration>, TypeOnly<current.ISummaryConfiguration>>
 ...
 * To acknowledge the breaking change, add the following to package.json under
 * typeValidation.broken:
 * "Interface_ISummaryConfiguration": {"backCompat": false}
 */
declare type current_as_old_for_Interface_ISummaryConfiguration = requireAssignableTo<TypeOnly<current.ISummaryConfiguration>, TypeOnly<old.ISummaryConfiguration>>
