...
export interface ITokenClaims {
    /**
     * Identifies collab session instance. There can be at most 1 collab session per document.
     * Session can close when there are no active clients connected to relay service (service specific).
     * New session will start on demand when new client initiates connection.
     * In telemetry, and in Fluid repo we call it relaySessionId
