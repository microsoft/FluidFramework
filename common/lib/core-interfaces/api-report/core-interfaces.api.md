...
//
// @internal
export type FluidObjectProviderKeys<T, TProp extends keyof T = keyof T> = string extends TProp ? never : number extends TProp ? never : TProp extends keyof Exclude<T[TProp], undefined> ? TProp extends keyof Exclude<Exclude<T[TProp], undefined>[TProp], undefined> ? TProp : never : never;
