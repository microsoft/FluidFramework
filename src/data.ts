import { AvailabilityType, IPersonType, IViewSelectors } from "./provider.types";

export const defaultPeople: IPersonType[] = [
    {
        name: "Bruno",
        availability: [AvailabilityType.Yes, AvailabilityType.Maybe, AvailabilityType.Maybe]
    },
    {
        name: "Tamine",
        availability: [AvailabilityType.Yes, AvailabilityType.Yes, AvailabilityType.No]
    },
    {
        name: "Jodom",
        availability: [AvailabilityType.Maybe, AvailabilityType.No, AvailabilityType.Yes]
    },
    {
        name: "Michelle",
        availability: [AvailabilityType.Yes, AvailabilityType.No, AvailabilityType.Maybe]
    }
];
...
export const defaultDatesNumbers: number[] = defaultDates.map((date) => date.valueOf());
