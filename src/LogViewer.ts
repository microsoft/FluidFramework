...
export class CachingLogViewer implements LogViewer {
	 ...
	 */
	private readonly localSnapshotCache = new Denque<{ snapshot: Snapshot; result: EditingResult }>();
	 ...
	 */
	private handleSequencedEditResult(edit: Edit, result: EditingResult): void {
