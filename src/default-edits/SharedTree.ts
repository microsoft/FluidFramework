...
import { tryConvertToStablePlace_0_0_2, tryConvertToStableRange_0_0_2 } from './Conversion002';
		...
		switch (change.type) {
			case ChangeType.Insert:
				return {
					...
					destination:
						tryConvertToStablePlace_0_0_2(change.destination, this) ??
			...
			case ChangeType.Detach: {
				const detach: DetachInternal = {
					source:
						tryConvertToStableRange_0_0_2(change.source, this) ??
						fail('Node ID was not generated by this SharedTree'),
			...
			case ChangeType.Constraint: {
				const constraint: ConstraintInternal = {
					...
					toConstrain:
						tryConvertToStableRange_0_0_2(change.toConstrain, this) ??
						fail('Node ID was not generated by this SharedTree'),
