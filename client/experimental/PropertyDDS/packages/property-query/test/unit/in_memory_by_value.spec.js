...
describe('In Memory Filtering By Value', () => {
  ...
  describe('with evaluation on a non-primitive type', () => {
    ...
    it('should throw an error because filtering on non-primitive', async () => {
      ...
      return expect(InMemoryByValue.filterByValue(query.from[0], changeSet))
        .to.be.rejectedWith(
          OperationError,
                ...
                myPointsMap: {
                  insert: {
                    'mysample:point2d-1.0.0': {
                      ...
                      'pointK': {   // Ensures that it doesn't crash for undefined members
                        Float64: {}
                      }
                    }
                  }
    ...
    describe('match clause', () => {
      ...
      describe('with a non-string value', () => {
        ...
        it('should throw an exception', () => {
          ...
          return expect(InMemoryByValue.filterByValue(query.from[0], changeSetWithNumbers))
            .to.be.rejectedWith(
              OperationError,
      ...
      it('should return the proper result', async () => {
        let query = {
          ...
          from: [{
            ...
            where: {
              'in': {
                x: [[intsX[0][0], intsX[0][1]], [intsX[2][0], intsX[2][1]]]
              }
            }
          }]
        };
