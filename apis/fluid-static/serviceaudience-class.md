...
```
<b>Extends:</b> [TypedEventEmitter](/docs/apis/common-utils\typedeventemitter-class)<!-- -->&lt;[IServiceAudienceEvents](/docs/apis/fluid-static\iserviceaudienceevents-interface)

<b>Implements:</b> [IServiceAudience](/docs/apis/fluid-static\iserviceaudience-interface)
