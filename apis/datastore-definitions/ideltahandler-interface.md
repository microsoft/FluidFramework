...
<table class="table table-striped table-hover">
  ...
  <tbody>
    <tr>
      ...
      <td>
        (message: <a href='/docs/apis/protocol-definitions\isequenceddocumentmessage-interface'>ISequencedDocumentMessage</a>, local: boolean, localOpMetadata: unknown) => void
      </td>
      <td>
        Processes the op.
      </td>
