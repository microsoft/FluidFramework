...
```
<b>Extends:</b> [SharedObject](/docs/apis/shared-object-base\sharedobject-class)<!-- -->&lt;[IPactMapEvents](/docs/apis/pact-map\ipactmapevents-interface)

<b>Implements:</b> [IPactMap](/docs/apis/pact-map\ipactmap-interface)
...
<b>Return type:</b> [PactMap](/docs/apis/pact-map\pactmap-class)
