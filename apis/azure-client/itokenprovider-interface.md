{
  ...
  "members": {
    "MethodSignature": {
      "documentPostCreateCallback": "/docs/apis/azure-client\\itokenprovider-interface#documentpostcreatecallback-methodsignature",
      "fetchOrdererToken": "/docs/apis/azure-client\\itokenprovider-interface#fetchorderertoken-methodsignature",
      "fetchStorageToken": "/docs/apis/azure-client\\itokenprovider-interface#fetchstoragetoken-methodsignature"
    }
  },
...
[Packages](/docs/apis/) &gt; [@fluidframework/azure-client](/docs/apis/azure-client) &gt; [ITokenProvider](/docs/apis/azure-client\itokenprovider-interface)
...
<table class="table table-striped table-hover">
  ...
  <tbody>
    <tr>
      <td>
        <a href='/docs/apis/azure-client\itokenprovider-interface#documentpostcreatecallback-methodsignature'>documentPostCreateCallback</a>
      </td>
      <td>
        <code>optional</code>
      </td>
    ...
    <tr>
      <td>
        <a href='/docs/apis/azure-client\itokenprovider-interface#fetchorderertoken-methodsignature'>fetchOrdererToken</a>
      </td>
      <td>
      </td>
      <td>
    ...
    <tr>
      <td>
        <a href='/docs/apis/azure-client\itokenprovider-interface#fetchstoragetoken-methodsignature'>fetchStorageToken</a>
      </td>
      <td>
      </td>
      <td>
...
\* Any exceptions thrown in the callback would fail the creation workflow (see <i>RouterliciousDocumentServiceFactory.createContainer</i> for more details).
...
<table class="table table-striped table-hover">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>Optional flag indicating whether token fetch must bypass local cache. This likely indicates that some previous request failed authorization due to an expired token, and so a fresh token is required.</p><p>Default: <code>false</code>.</p><p>NOTE: This parameter will be made required in the future.</p>
      </td>
    </tr>
  </tbody>
</table>
