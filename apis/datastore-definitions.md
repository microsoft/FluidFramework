...
<table class="table table-striped table-hover">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>Definitions of a channel factory.</p><p>The runtime must be able to produce "channels" of the correct in-memory object type for the collaborative session. Here "channels" are typically distributed data structures (DDSs).</p><p>The runtime will consult with a registry of such factories during <a href='https://fluidframework.com/docs/build/containers/'>Container</a> load and when receiving "attach" operations (ops), which indicate a new instance of a channel being introduced to the collaboration session, to produce the appropriate in-memory object.</p>
      </td>
    </tr>
    <tr>
      <td>
