...
<b>Implements:</b> [IFluidLoadable](/docs/apis/core-interfaces\ifluidloadable-interface)<!-- -->, [IFluidRouter](/docs/apis/core-interfaces\ifluidrouter-interface)<!-- -->, [IProvideFluidHandle](/docs/apis/core-interfaces\iprovidefluidhandle-interface)
...
<table class="table table-striped table-hover">
  ...
  <tbody>
    ...
    <tr>
      <td>
        <a href='/docs/apis/aqueduct\puredataobject-class#getfluidobjectfromdirectory-method'>getFluidObjectFromDirectory</a>
      </td>
      <td>
        Promise<T | undefined>
      </td>
    ...
    <tr>
      <td>
        <a href='/docs/apis/aqueduct\puredataobject-class#getservice-method'>getService</a>
      </td>
      <td>
        Promise<T>
      </td>
    ...
    <tr>
      ...
      <td>
        <p>Return this object if someone requests it directly We will return this object in two scenarios:</p><p>1. the request url is a "/"</p><p>2. the request url is empty</p>
      </td>
    </tr>
  </tbody>
</table>
...
<b>Return type:</b> Promise&lt;[PureDataObject](/docs/apis/aqueduct\puredataobject-class)<!-- -->&lt;[DataObjectTypes](/docs/apis/aqueduct\dataobjecttypes-interface)<!-- -->&gt;&gt;
...
#### Returns {#getfluidobjectfromdirectory-returns}
