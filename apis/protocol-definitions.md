{
  ...
  "members": {
    ...
    "Interface": {
      ...
      "IHelpMessage": "/docs/apis/protocol-definitions\\ihelpmessage-interface",
      ...
      "IQueueMessage": "/docs/apis/protocol-definitions\\iqueuemessage-interface",
...
<table class="table table-striped table-hover">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>Proposal to set the given key/value pair.</p><p>Consensus on the proposal is achieved if the MSN is >= the sequence number at which the proposal is made and no client within the collaboration window rejects the proposal.</p>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <a href='/docs/apis/protocol-definitions\iqueuemessage-interface'>IQueueMessage</a>
      </td>
      <td>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <p><a href='https://jwt.io/introduction/'>JSON Web Token (JWT)</a> Claims</p><p>See <a href='https://datatracker.ietf.org/doc/html/rfc7519#section-4'>https://datatracker.ietf.org/doc/html/rfc7519#section-4</a></p>
      </td>
    </tr>
    <tr>
      <td>
...
<table class="table table-striped table-hover">
  ...
  <tbody>
    ...
    <tr>
      <td>
        <a href='/docs/apis/protocol-definitions#messagetype-remotehelp-enummember'>RemoteHelp</a>
      </td>
      <td>
...
##### RemoteHelp {#messagetype-remotehelp-enummember}

Message to indicate the need of a remote agent for a document.

###### Signature {#remotehelp-signature}
