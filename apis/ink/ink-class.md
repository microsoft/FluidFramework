...
```
<b>Extends:</b> [SharedObject](/docs/apis/shared-object-base\sharedobject-class)<!-- -->&lt;[IInkEvents](/docs/apis/ink\iinkevents-interface)

<b>Implements:</b> [IInk](/docs/apis/ink\iink-interface)
...
<b>Return type:</b> [Ink](/docs/apis/ink\ink-class)
...
<b>Return type:</b> [InkFactory](/docs/apis/ink\inkfactory-class)
