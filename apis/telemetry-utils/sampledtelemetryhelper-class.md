...
<table class="table table-striped table-hover">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Map<string, <a href='/docs/apis/common-definitions\itelemetryproperties-interface'>ITelemetryProperties</a>>
      </td>
      <td>
