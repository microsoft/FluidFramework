...
<table class="table table-striped table-hover">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <p>Default request handler for a Fluid object that returns the object itself if:</p><p>1. the request url is empty</p><p>2. the request url is "/"</p><p>3. the request url starts with "/" and is followed by a query param, such as /?key=value</p><p>Returns a 404 error for any other url.</p>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <a href='/docs/apis/aqueduct#waitforattach-function'>waitForAttach</a>
      </td>
      <td>
        Promise<void>
      </td>
