...
\* Any exceptions thrown in the callback would fail the creation workflow (see [RouterliciousDocumentServiceFactory.createContainer()](/docs/apis/routerlicious-driver\routerliciousdocumentservicefactory-class#createcontainer-method) for more details).
