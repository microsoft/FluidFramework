 ...
 * components.
 */
export const OptionPickerContainerRuntimeFactory = new ContainerRuntimeFactoryWithDefaultComponent(
    OptionPicker.ComponentName,
    new Map([
        [OptionPicker.ComponentName, Promise.resolve(OptionPickerInstantiationFactory)],
    ]),
);
