...
export class ClickerWithHooks extends SyncedComponent
    ...
    private readonly functionalFluidToView: FluidToViewMap<ICounterState,ICounterState> = new Map([
        [
            "value", {
                type: "number",
                viewKey: "value",
    ...
    private readonly functionalViewToFluid: ViewToFluidMap<ICounterState,ICounterState> = new Map([
        [
            "value", {
                type: "number",
                fluidKey: "value",
    ...
    private readonly reducerFluidToView: FluidToViewMap<ICounterReducerViewState,ICounterReducerFluidState> = new Map([
        [
            "counter", {
    ...
    private readonly reducerViewToFluid: ViewToFluidMap<ICounterReducerViewState,ICounterReducerFluidState> = new Map([
        [
            "value", {
                type: "number",
                fluidKey: "counter",
