...
export class TabsDataModel extends EventEmitter implements ITabsDataModel {
    ...
    constructor(
        ...
        private readonly createAndAttachComponent: <T extends IComponent & IFluidLoadable>
            (pkg: string, props?: any) => Promise<T>,
        private readonly getComponentFromDirectory: <T extends IComponent & IFluidLoadable>(
            id: string,
