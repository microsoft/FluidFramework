...
// TODO these may or may not want to exist in the runtime-definitions. Or some other core.
...
export function getLeader(clients: Map<string, api.IClient>): api.IClientJoin {
