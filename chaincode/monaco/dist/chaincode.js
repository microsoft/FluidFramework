...
const component_1 = require("@prague/component");
const map_1 = require("@prague/map");
const sequence = require("@prague/sequence");
...
// tslint:enable
class MonacoRunner extends events_1.EventEmitter {
    constructor() {
        super(...arguments);
        this.collabDocDeferred = new utils_1.Deferred();
    }
    ...
    initialize(runtime) {
        return __awaiter(this, void 0, void 0, function* () {
            const collabDoc = yield document_1.Document.Load(runtime);
...
exports.MonacoRunner = MonacoRunner;
class Chaincode extends events_1.EventEmitter {
    /**
    ...
    constructor(runner) {
        ...
        map_1.registerDefaultValueType(new map_1.DistributedSetValueType());
        map_1.registerDefaultValueType(new map_1.CounterValueType());
        map_1.registerDefaultValueType(new sequence.SharedStringIntervalCollectionValueType());
        map_1.registerDefaultValueType(new sequence.SharedIntervalCollectionValueType());
        // Create channel extensions
        const mapExtension = new map_1.MapExtension();
        ...
        this.modules.set(map_1.MapExtension.Type, mapExtension);
...
class MonacoComponent {
    ...
    run(runtime) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const component = yield component_1.ComponentHost.LoadFromSnapshot(runtime, chaincode);
...
exports.MonacoComponent = MonacoComponent;
