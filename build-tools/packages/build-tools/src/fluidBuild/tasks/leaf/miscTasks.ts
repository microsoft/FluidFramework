...
/**
 * A fluid-build task that adds incremental build support for the type tests generated by `flub generate:typetests`.
 */
export class TypeValidationTask extends LeafWithFileStatDoneFileTask {
	 ...
	 *
	 * Once AB#7318 is done and this task depends on more input files, we may want to remove this and switch back to file
	 * stat-based caching to regain the perf hit that hashing represents.
	 */
