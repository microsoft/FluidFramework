 ...
 * @privateRemarks
 *
 * Once AB#7318 is done and type tests are no longer double-built, this task can be converted to a TscDependentTask,
 * and much of the code in this class can be removed.
 */
