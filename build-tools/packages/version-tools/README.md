...
running command...
$ fluv (--version)
@fluid-tools/version-tools/0.4.7000 win32-x64 node-v14.18.1
$ fluv --help [COMMAND]
USAGE
  $ fluv COMMAND
...
...
_See code: [dist/commands/version.ts](https://github.com/microsoft/FluidFramework/blob/v0.4.7000/dist/commands/version.ts)_
