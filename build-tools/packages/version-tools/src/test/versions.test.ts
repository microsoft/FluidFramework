...
import { generateAlphaBetaVersion, getIsLatest, getSimpleVersion } from "../versions";
...
describe("getAlphaBetaVersion", () => {
	it("alpha prerelease versions", () => {
		...
		const result = generateAlphaBetaVersion(input, "93923", false, false, "alpha");
		expect(result).to.equal(expected);
	});
	...
	it("beta prerelease versions", () => {
		...
		const result = generateAlphaBetaVersion(input, "93923", false, false, "beta");
		expect(result).to.equal(expected);
	});
	...
	it("none prerelease versions", () => {
		const input = "2.0.0-dev.1.3.0";
		const expected = "2.0.0-dev.1.3.0.93923";
		const result = generateAlphaBetaVersion(input, "93923", false, false, "none");
		expect(result).to.equal(expected);
	});
	...
	it("public prerelease versions", () => {
		const input = "2.0.0-dev.1.3.0";
		const expected = "2.0.0-dev.1.3.0.93923";
		const result = generateAlphaBetaVersion(input, "93923", false, false, "public");
		expect(result).to.equal(expected);
	});
	...
	it("untrimmed prerelease versions", () => {
		const input = "2.0.0-dev.1.3.0";
		const expected = "2.0.0-dev.1.3.0.93923";
		const result = generateAlphaBetaVersion(input, "93923", false, false, "untrimmed");
		expect(result).to.equal(expected);
	});
	...
	it("alpha release versions", () => {
		...
		const result = generateAlphaBetaVersion(input, "93923", true, false, "alpha");
		expect(result).to.equal(expected);
	});
	...
	it("beta release versions", () => {
		const input = "2.0.0-dev.1.3.0";
		const expected = "2.0.0-dev.1.3.0";
		const result = generateAlphaBetaVersion(input, "93923", true, false, "beta");
		expect(result).to.equal(expected);
	});
	...
	it("none release versions", () => {
		const input = "2.0.0-dev.1.3.0";
		const expected = "2.0.0-dev.1.3.0";
		const result = generateAlphaBetaVersion(input, "93923", true, false, "none");
		expect(result).to.equal(expected);
	});
	...
	it("public release versions", () => {
		const input = "2.0.0-dev.1.3.0";
		const expected = "2.0.0-dev.1.3.0";
		const result = generateAlphaBetaVersion(input, "93923", true, false, "public");
		expect(result).to.equal(expected);
	});
	...
	it("untrimmed release versions", () => {
		const input = "2.0.0-dev.1.3.0";
		const expected = "2.0.0-dev.1.3.0";
		const result = generateAlphaBetaVersion(input, "93923", true, false, "untrimmed");
		expect(result).to.equal(expected);
	});
});
