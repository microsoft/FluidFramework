...
* [`flub generate fluid-import-data`](#flub-generate-fluid-import-data)
...
## `flub generate fluid-import-data`

Generates data files for use with the modify:fluid-imports command.

```
USAGE
  $ flub generate fluid-import-data --glob <value> [--json] [-v | --quiet] [--out <value>]

FLAGS
  --glob=<value>...  (required) [default: **/*.api.md] A glob to select api-extractor report markdown files. This flag
                     can be used multiple times; the array of glob strings will be passed to globby in the order
                     provided. This allows you to exclude (negate) portions earlier glob paths.
  --out=<value>      A path to a file in which to output the generated data.
...
DESCRIPTION
  ...
  This command extracts API metadata from api.md files which are generated by api-extractor.
```

_See code: [src/commands/generate/fluid-import-data.ts](https://github.com/microsoft/FluidFramework/blob/main/build-tools/packages/build-cli/src/commands/generate/fluid-import-data.ts)_
