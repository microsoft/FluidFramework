...
```
USAGE
  $ flub generate sourceEntrypoints [-v | --quiet] [--mainEntrypoint <value>]
...
DESCRIPTION
  Generates TypeScript source files that roll up APIs into different entrypoint files. The entrypoints are determined
