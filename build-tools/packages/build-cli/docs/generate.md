...
* [`flub generate asserts`](#flub-generate-asserts)
...
## `flub generate asserts`

Tags asserts by replacing their message with a unique numerical value.

```
USAGE
  $ flub generate asserts [-v | --quiet] [--disableConfig] [--concurrency <value>] [--all | --dir <value> | --packages
...
_See code: [src/commands/generate/asserts.ts](https://github.com/microsoft/FluidFramework/blob/main/build-tools/packages/build-cli/src/commands/generate/asserts.ts)_
