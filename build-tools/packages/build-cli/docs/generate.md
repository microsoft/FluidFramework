...
* [`flub generate generation`](#flub-generate-generation)
...
## `flub generate generation`

Updates the generation and release date for layer compatibility.

```
USAGE
  $ flub generate generation [-v | --quiet] [--generationDir <value>] [--generationFileName <value>]
...
FLAGS
  --concurrency=<value>                [default: 25] The number of tasks to execute concurrently.
  --generationDir=<value>              [default: ./src] Where to read / write the generation file.
  --generationFileName=<value>         [default: layerGeneration.ts] File name for reading / writing generation.
...
_See code: [src/commands/generate/generation.ts](https://github.com/microsoft/FluidFramework/blob/main/build-tools/packages/build-cli/src/commands/generate/generation.ts)_
