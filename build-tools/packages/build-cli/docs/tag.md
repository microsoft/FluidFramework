...
* [`flub tag asserts`](#flub-tag-asserts)
...
```
USAGE
  $ flub tag asserts [-v | --quiet] [--disableConfig] [--concurrency <value>] [--all | --dir <value> | --packages
...
_See code: [src/commands/tag/asserts.ts](https://github.com/microsoft/FluidFramework/blob/main/build-tools/packages/build-cli/src/commands/tag/asserts.ts)_
