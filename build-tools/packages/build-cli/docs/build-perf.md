...
EXAMPLES
  Check thresholds for public (PR) builds.
    ...
    $ flub build-perf-tools check-thresholds --mode public --inputDir ./data --avgDurationThreshold 90 --changePeriodThreshold 15
```
...
EXAMPLES
  Collect public (PR) build data.
    ...
    $ flub build-perf-tools collect-data --mode public --project public --prBuildDefId 11 --outputDir ./output --adoApiToken \
      $ADO_TOKEN
```
