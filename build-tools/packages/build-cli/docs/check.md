...
FLAGS
  ...
  --webpack-dir=<value>    [default: .] Directory whose compareBundlesOutput holds the bundle stats to compare. Matches
                           the --webpack-dir passed to 'flub generate bundleAnalysisRepo' (defaults to the current
                           directory).
