...
export const handlers: Handler[] = [
		...
		resolver: (file: string): { resolved: boolean; message?: string } => {
			updatePackageJsonFile(path.dirname(file), (json) => {
				...
				if (hasScriptsField) {
					...
					const hasPrettierScriptResolver =
						Object.prototype.hasOwnProperty.call(json.scripts, "prettier");

					const hasPrettierFixScriptResolver =
						Object.prototype.hasOwnProperty.call(json.scripts, "prettier:fix");
	...
	},
	{
		...
		handler: async (file: string): Promise<string | undefined> => {
			...
			if (hasScriptsField) {
				const hasBuildScript = Object.prototype.hasOwnProperty.call(
					json.scripts,
					"build",
				);
				const hasCleanScript = Object.prototype.hasOwnProperty.call(
					json.scripts,
					"clean",
				);
