...
export const selectionFlags = {
	all: Flags.boolean({
		description:
			"Run on all packages and release groups. Cannot be used with --dir, --releaseGroup, or --releaseGroupRoot.",
		exclusive: ["dir", "packages", "releaseGroup", "releaseGroupRoot"],
		helpGroup: "PACKAGE SELECTION",
	}),
	dir: Flags.directory({
		description:
			"Run on the package in this directory. Cannot be used with --all, --releaseGroup, or --releaseGroupRoot.",
