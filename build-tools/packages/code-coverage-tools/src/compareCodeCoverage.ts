...
import type { CoverageReport } from "./getCoverageMetrics";
...
export const compareCodeCoverage = (
	...
	prCoverageReport.forEach((packageInPrReport: CoverageReport) => {
		const packageName = packageInPrReport.packageName;
		...
		let lineCoverageInPr = 0.0;
		let lineCoverageInBaseline = 0.0;
		let branchCoverageInPr = 0.0;
		let branchCoverageInBaseline = 0.0;
