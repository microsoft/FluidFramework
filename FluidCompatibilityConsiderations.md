...
Client 3.0 supports values from the 2.x and 3.x release lines, so every active
deployment that must collaborate needs to use Fluid Framework 2.0.0 or later
before upgrading.
