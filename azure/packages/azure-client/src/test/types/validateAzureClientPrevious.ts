 ...
 */
declare function get_old_ClassDeclaration_AzureAudience(): TypeOnly<old.AzureAudience>;
declare function use_current_ClassDeclaration_AzureAudience(use: TypeOnly<current.AzureAudience>);
use_current_ClassDeclaration_AzureAudience(get_old_ClassDeclaration_AzureAudience());
 ...
 */
declare function get_current_ClassDeclaration_AzureAudience(): TypeOnly<current.AzureAudience>;
declare function use_old_ClassDeclaration_AzureAudience(use: TypeOnly<old.AzureAudience>);
use_old_ClassDeclaration_AzureAudience(get_current_ClassDeclaration_AzureAudience());
 ...
 */
declare function get_old_ClassDeclaration_AzureClient(): TypeOnly<old.AzureClient>;
declare function use_current_ClassDeclaration_AzureClient(use: TypeOnly<current.AzureClient>);
 ...
 */
declare function get_current_ClassDeclaration_AzureClient(): TypeOnly<current.AzureClient>;
declare function use_old_ClassDeclaration_AzureClient(use: TypeOnly<old.AzureClient>);
 ...
 */
declare function get_old_InterfaceDeclaration_AzureClientProps(): TypeOnly<old.AzureClientProps>;
 ...
 */
declare function get_current_InterfaceDeclaration_AzureClientProps(): TypeOnly<current.AzureClientProps>;
declare function use_old_InterfaceDeclaration_AzureClientProps(use: TypeOnly<old.AzureClientProps>);
 ...
 */
declare function get_old_InterfaceDeclaration_AzureConnectionConfig(): TypeOnly<old.AzureConnectionConfig>;
 ...
 */
declare function get_current_InterfaceDeclaration_AzureConnectionConfig(): TypeOnly<current.AzureConnectionConfig>;
 ...
 */
declare function get_old_TypeAliasDeclaration_AzureConnectionConfigType(): TypeOnly<old.AzureConnectionConfigType>;
 ...
 */
declare function get_current_TypeAliasDeclaration_AzureConnectionConfigType(): TypeOnly<current.AzureConnectionConfigType>;
 ...
 */
declare function get_old_InterfaceDeclaration_AzureContainerServices(): TypeOnly<old.AzureContainerServices>;
 ...
 */
declare function get_current_InterfaceDeclaration_AzureContainerServices(): TypeOnly<current.AzureContainerServices>;
 ...
 */
declare function get_old_InterfaceDeclaration_AzureContainerVersion(): TypeOnly<old.AzureContainerVersion>;
 ...
 */
declare function get_current_InterfaceDeclaration_AzureContainerVersion(): TypeOnly<current.AzureContainerVersion>;
 ...
 */
declare function get_old_ClassDeclaration_AzureFunctionTokenProvider(): TypeOnly<old.AzureFunctionTokenProvider>;
 ...
 */
declare function get_current_ClassDeclaration_AzureFunctionTokenProvider(): TypeOnly<current.AzureFunctionTokenProvider>;
 ...
 */
declare function get_old_InterfaceDeclaration_AzureGetVersionsOptions(): TypeOnly<old.AzureGetVersionsOptions>;
 ...
 */
declare function get_current_InterfaceDeclaration_AzureGetVersionsOptions(): TypeOnly<current.AzureGetVersionsOptions>;
 ...
 */
declare function get_old_InterfaceDeclaration_AzureLocalConnectionConfig(): TypeOnly<old.AzureLocalConnectionConfig>;
 ...
 */
declare function get_current_InterfaceDeclaration_AzureLocalConnectionConfig(): TypeOnly<current.AzureLocalConnectionConfig>;
 ...
 */
declare function get_old_InterfaceDeclaration_AzureMember(): TypeOnly<old.AzureMember>;
declare function use_current_InterfaceDeclaration_AzureMember(use: TypeOnly<current.AzureMember>);
 ...
 */
declare function get_current_InterfaceDeclaration_AzureMember(): TypeOnly<current.AzureMember>;
declare function use_old_InterfaceDeclaration_AzureMember(use: TypeOnly<old.AzureMember>);
 ...
 */
declare function get_old_InterfaceDeclaration_AzureRemoteConnectionConfig(): TypeOnly<old.AzureRemoteConnectionConfig>;
 ...
 */
declare function get_current_InterfaceDeclaration_AzureRemoteConnectionConfig(): TypeOnly<current.AzureRemoteConnectionConfig>;
 ...
 */
declare function get_old_TypeAliasDeclaration_IAzureAudience(): TypeOnly<old.IAzureAudience>;
 ...
 */
declare function get_current_TypeAliasDeclaration_IAzureAudience(): TypeOnly<current.IAzureAudience>;
declare function use_old_TypeAliasDeclaration_IAzureAudience(use: TypeOnly<old.IAzureAudience>);
 ...
 */
declare function get_old_InterfaceDeclaration_ITelemetryBaseEvent(): TypeOnly<old.ITelemetryBaseEvent>;
 ...
 */
declare function get_current_InterfaceDeclaration_ITelemetryBaseEvent(): TypeOnly<current.ITelemetryBaseEvent>;
 ...
 */
declare function get_old_InterfaceDeclaration_ITelemetryBaseLogger(): TypeOnly<old.ITelemetryBaseLogger>;
 ...
 */
declare function get_current_InterfaceDeclaration_ITelemetryBaseLogger(): TypeOnly<current.ITelemetryBaseLogger>;
 ...
 */
declare function get_old_InterfaceDeclaration_ITokenClaims(): TypeOnly<old.ITokenClaims>;
declare function use_current_InterfaceDeclaration_ITokenClaims(use: TypeOnly<current.ITokenClaims>);
 ...
 */
declare function get_current_InterfaceDeclaration_ITokenClaims(): TypeOnly<current.ITokenClaims>;
declare function use_old_InterfaceDeclaration_ITokenClaims(use: TypeOnly<old.ITokenClaims>);
 ...
 */
declare function get_old_InterfaceDeclaration_ITokenProvider(): TypeOnly<old.ITokenProvider>;
 ...
 */
declare function get_current_InterfaceDeclaration_ITokenProvider(): TypeOnly<current.ITokenProvider>;
declare function use_old_InterfaceDeclaration_ITokenProvider(use: TypeOnly<old.ITokenProvider>);
 ...
 */
declare function get_old_InterfaceDeclaration_ITokenResponse(): TypeOnly<old.ITokenResponse>;
 ...
 */
declare function get_current_InterfaceDeclaration_ITokenResponse(): TypeOnly<current.ITokenResponse>;
declare function use_old_InterfaceDeclaration_ITokenResponse(use: TypeOnly<old.ITokenResponse>);
 ...
 */
declare function get_old_InterfaceDeclaration_IUser(): TypeOnly<old.IUser>;
declare function use_current_InterfaceDeclaration_IUser(use: TypeOnly<current.IUser>);
 ...
 */
declare function get_current_InterfaceDeclaration_IUser(): TypeOnly<current.IUser>;
declare function use_old_InterfaceDeclaration_IUser(use: TypeOnly<old.IUser>);
 ...
 */
declare function get_old_EnumDeclaration_ScopeType(): TypeOnly<old.ScopeType>;
declare function use_current_EnumDeclaration_ScopeType(use: TypeOnly<current.ScopeType>);
 ...
 */
declare function get_current_EnumDeclaration_ScopeType(): TypeOnly<current.ScopeType>;
declare function use_old_EnumDeclaration_ScopeType(use: TypeOnly<old.ScopeType>);
