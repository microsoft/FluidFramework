...
Import the `public` ([Semantic Versioning (SemVer)](https://semver.org/)) APIs from `@fluidframework/azure-service-utils`.

Import the `legacy` APIs from `@fluidframework/azure-service-utils/legacy`.

## API Documentation

Read the **@fluidframework/azure-service-utils** API documentation at <https://fluidframework.com/docs/apis/azure-service-utils>.
