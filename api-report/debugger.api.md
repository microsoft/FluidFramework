...
export namespace FluidDebugger {
    ...
    // (undocumented)
    export function createFromServiceFactory(documentServiceFactory: IDocumentServiceFactory): Promise<IDocumentServiceFactory<never> | ReplayDocumentServiceFactory>;
}
