## API Report File for "@fluidframework/new-map"
...
export class MapFactory implements IChannelFactory {
    ...
    // (undocumented)
    static readonly Type = "https://graph.microsoft.com/types/new-map";
    // (undocumented)
    get type(): string;
}

// @public
export class NewSharedMap extends SharedObject<ISharedMapEvents> implements ISharedMap {
    [Symbol.iterator](): IterableIterator<[string, any]>;
    readonly [Symbol.toStringTag]: string;
    ...
    clear(): void;
    static create(runtime: IFluidDataStoreRuntime, id?: string): NewSharedMap;
