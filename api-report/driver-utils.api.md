...
export class AuthorizationError
    ...
    implements IAuthorizationError {
    constructor(
        errorMessage: string,
...
// @public (undocumented)
export class BlobAggregationStorage
    ...
    protected constructor(
        ...
        blobCutOffSize?: number | undefined
    );
    // (undocumented)
...
// @public
export function configurableUrlResolver(
...
export const createWriteError: (
    errorMessage: string
) => NonRetryableError<DriverErrorType>;

// @public (undocumented)
export class DeltaStreamConnectionForbiddenError
    extends LoggingError
    implements IDriverErrorBase {
...
// @public
export function readAndParse<T>(
    storage: Pick<IDocumentStorageService, "readBlob">,
    id: string
): Promise<T>;

// @public
export function readAndParseFromBlobs<T>(
    blobs: {
        [index: string]: string;
    },
    id: string
