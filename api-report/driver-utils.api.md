...
// @public (undocumented)
export function createGenericNetworkError(errorMessage: string, canRetry: boolean, retryAfterSeconds?: number, props?: ITaggableTelemetryProperties): ThrottlingError | GenericNetworkError;
