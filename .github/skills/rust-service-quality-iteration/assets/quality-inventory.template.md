...
Configured scope: <!-- TODO(required): summarize or link the charter scope -->
...
<!-- TODO(required): identify the risk evidence used to select reviewed boundaries and explain why they outrank deferred candidates without naming private expected findings -->
