...
Client 3.0 accepts supported 2.x and 3.x SemVer values. Before upgrading an
application to Client 3.0, ensure every active deployment that must collaborate
uses Fluid Framework 2.0.0 or later.
