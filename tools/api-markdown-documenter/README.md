...
This library is intended to be consumed programmatically.
...
This library also now offers an preview command line script that leverages [`lintApiModel`](#lintapimodel).
It can be invoked via `api-markdown-documenter lint-api-model ...`.
...
Note that this script is offered as a preview.
It's details may change without notice like any other of the preview APIs in this library.
