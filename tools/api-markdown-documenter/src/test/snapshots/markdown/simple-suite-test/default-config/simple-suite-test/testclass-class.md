...
| protectedProperty | [TestEnum](./simple-suite-test#testenum-enum) | Some notes about the parameter.<br>See [protectedProperty](./simple-suite-test/testabstractclass-class#protectedproperty-property). |
