 ...
 * @remarks
 * Used as API input.
 * Optional properties will be filled in with default values if not provided.
 *
 * @public
 */
...
/**
 * Complete {@link DocumentationSuiteOptions} configuration, with any unspecified properties filled in with system defaults.
 *
 * @public
 */
 ...
 */
const defaultDocumentationSuiteOptions: DocumentationSuiteConfiguration = {
