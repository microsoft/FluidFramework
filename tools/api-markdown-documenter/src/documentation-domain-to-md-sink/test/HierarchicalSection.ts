...
import { HeadingNode, HierarchicalSectionNode, ParagraphNode, PlainTextNode } from "../../documentation-domain";
...
describe("HierarchicalSectionNode markdown tests", () => {
    it("Creates a hierarchical section with sensible default depth when none is provided", () => {
        ...
        const renderedForm = renderer.renderNode(new HierarchicalSectionNode([], HeadingNode.createFromPlainText('Heading')));
