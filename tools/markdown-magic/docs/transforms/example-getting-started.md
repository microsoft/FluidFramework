...
| `serviceClient`   | boolean | `false`          | Include the unified ServiceClient setup steps.          | When enabled, the generated instructions cover ephemeral, session, and Tinylicious modes.                                                |
