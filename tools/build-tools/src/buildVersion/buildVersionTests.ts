...
export function test() {
    ...
    assert.equal(getFullVersion("0.15.0", "12345", "refs/heads/master", true), "0.15.12345");
    ...
    assert.equal(getFullVersion("0.15.0-alpha.1", "12345.0", "refs/heads/master", true), "0.15.12345-alpha.1");
    ...
    assert.equal(getFullVersion("0.16.0", "12345.0", "refs/heads/master", false), "0.16.0--ci.12345.0.official");
    ...
    assert.equal(getFullVersion("0.16.0-alpha.1", "12345.0", "refs/heads/master", false), "0.16.0-alpha.1.0.ci.12345.0.official");
    ...
    assert.equal(getSimpleVersion("0.15.0", "12345.0", "refs/heads/master", true), "0.15.12345");
    ...
    assert.equal(getSimpleVersion("0.15.0-alpha.1", "12345.0", "refs/heads/master", true), "0.15.12345-alpha.1");
    ...
    assert.equal(getSimpleVersion("0.16.0", "12345.0", "refs/heads/master", false), "0.16.0-12345.0");
    ...
    assert.equal(getSimpleVersion("0.16.0-alpha.1", "12345.0", "refs/heads/master", false), "0.16.0-alpha.1.12345.0");
