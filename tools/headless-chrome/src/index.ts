...
commander
    ...
    .option(
        "-d, --document [document]",
        "Document to open",
        "http://localhost:3000/loader/fluid/testtesttest8?component=@fluid-example/shared-text2@0.2.13")
    .option(
        "-e, --document2 [document2]",
        "Document to open",
        "http://localhost:3000/loader/fluid/testtesttest7?component=@fluid-example/shared-text2@0.2.13")
