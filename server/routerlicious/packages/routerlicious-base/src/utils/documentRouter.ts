...
export interface IPlugin {
     ...
     */
    create(config: nconf.Provider, customization?: Record<string, any>): Promise<IPartitionLambdaFactory>;
}

export async function createDocumentRouter(config: nconf.Provider, customization?: Record<string, any>): Promise<IPartitionLambdaFactory<IPartitionConfig>> {
