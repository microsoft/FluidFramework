...
export interface ISocketIoServerConfig {
	...
	/**
	 * Whether to enable Socket.i{@link https://socket.io/docs/v4/server-options/#permessagedeflate | perMessageDeflate}e) option.
	 * Default is `true`.
	 */
...
class SocketIoServer implements core.IWebSocketServer {
	...
	constructor(
		...
		this.io.on("connection", (socket: Socket) => {
			 ...
			 * {@link https://socket.io/docs/v4/server-socket-instance/#sockethandshake | socket.handshake.query}e) contains parsed query params.
