...
export interface IProducer {
     ...
     * Event handlers
     */
    on(event: "connected" | "disconnected" | "produced" | "throttled" | "error", listener: (...args: any[]) => void): this;
    once(event: "connected" | "disconnected" | "produced" | "throttled" | "error", listener: (...args: any[]) => void): this;
}
