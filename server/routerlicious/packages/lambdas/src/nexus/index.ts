...
export function configureWebSocketServices(
	...
	webSocketServer.on("connection", (socket: core.IWebSocket) => {
		...
		socket.on(
			 ...
			 * {@link https://github.com/microsoft/FluidFramework/blob/ccb26baf65be1cbe3f708ec0fe6887759c25be6d/packages/loader/container-loader/src/container.ts#L2292-L2294 | Container.submitSignal}4)
			 * and sent via
			 * {@link https://github.com/microsoft/FluidFramework/blob/ccb26baf65be1cbe3f708ec0fe6887759c25be6d/packages/drivers/driver-base/src/documentDeltaConnection.ts#L313C1-L321C4 | DocumentDeltaConnection.emitMessages}4)),
