...
## What is this for?
Tinylicious includes most of the basic features needed to **test** components and containers. While we use the [Webpack Component Loader](../../packages/tools/webpack-fluid-loader)'s in browser service for much of our component and container development, Tinylicious offers some advantages because it's a standalone process. For instance, testing a Fluid Container from 2+ simultaneously connected clients can be easier using Tinylicious.
