...
import { sharedTreeTraverse } from "../shared-tree-object-diff/index.js";
...
describe("sharedTreeTraverse", () => {
	...
	it("Simple Object Traversal", () => {
		...
		assert.strictEqual(sharedTreeTraverse(treeNode as unknown as Record<string, unknown>, path), true);
	});
	...
	it("Object With Nested Array Traversal", () => {
		...
		assert.strictEqual(sharedTreeTraverse(treeNode as unknown as Record<string, unknown>, path), false);
	});
	...
	it("Map With Nested Object Traversal", () => {
		class TreeNode extends schemaFactory.map("TreeNode", [schemaFactory.object("NestedObj", {
			nestedTest: schemaFactory.boolean
		})]) {}
	...
	it("Map With Nested Array Traversal", () => {
		class TreeNode extends schemaFactory.map("TreeNode", [schemaFactory.array(schemaFactory.boolean)]) {}
	...
	it("Map With Nested Map Traversal", () => {
		class TreeNode extends schemaFactory.map("TreeNode", [schemaFactory.map("NestedMap", [schemaFactory.boolean])]) {}
	...
	it("Array With Nested Object Traversal", () => {
		class TreeNode extends schemaFactory.array("Array", schemaFactory.object("NestedObj", {
			nestedTest: schemaFactory.boolean
		})) {}
	...
	it("Array With Nested Array Traversal", () => {
		class TreeNode extends schemaFactory.array("Array", schemaFactory.array(schemaFactory.boolean)) {}
	...
	it("Array With Nested Map Traversal", () => {
		class TreeNode extends schemaFactory.array("Array", schemaFactory.map("NestedMap", [schemaFactory.boolean])) {}
