...
```bash
npm i @fluid-experimental/fluid-llm-example
```

## API Documentation

API documentation for **@fluid-experimental/fluid-llm-example** is available at <https://fluidframework.com/docs/apis/fluid-llm-example>.
