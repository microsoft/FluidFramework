...
/**
 * Derives a deterministic type name for kind of collection containing certain types.
 * @param collectionName - The name of the type of collection, e.g. `List` or `Map`.
 * @param allowedTypes - The set of types that are allowed in the collection.
 */
