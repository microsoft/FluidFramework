...
// import { EncodedChunkShape, EncodedTreeShape } from "../format";
...
// 	readonly tree: TreeShape | "incompatible";
...
//  * */
// const decodingShapeSet: Set<EncodedTreeShape> = new Set();
...
// const treeShapesSlot = decoderCacheSlot<Map<EncodedTreeShape, UniformTreeShapeInfo>>();
// const decodersSlot = decoderCacheSlot<Map<EncodedTreeShape, ChunkDecoder>>();

// function decodeTreeShape(
// 	cache: DecoderCache<EncodedChunkShape>,
// 	treeShape: EncodedChunkShape,
// ): UniformTreeShapeInfo {
// 	const getInnerShape = (shapeIndex: number): EncodedChunkShape => {
...
// 		// Recursive shapes can't be uniform shapes.
// 		if (decodingShapeSet.has(treeShape)) {
// 			return { tree: "incompatible" };
// 		}
...
// 				const subShape = decodeTreeShape(cache, innerShape);
// 				if (subShape.tree === "incompatible") {
// 					return subShape;
// 				}
// 				fields.push([
