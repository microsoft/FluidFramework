...
import { ImplicitFieldSchema, TreeFieldFromImplicitField } from "../../class-tree";
...
const tcs: TestCase[] = [
	{
		schema: makeSchema((_) => _.object("empty", {})),
		initialTree: () => ({}),
	},
	{
		schema: makeSchema((_) =>
	...
	},
	{
		schema: makeSchema((_) =>
			_.object("outer", {
				nested: _.object("inner", {}),
			}),
		),
		initialTree: () => ({ nested: {} }),
	},
	{
		schema: makeSchema((_) => _.list(_.string)),
		initialTree: () => [],
	},
	{
		schema: makeSchema((_) => _.list(_.string)),
