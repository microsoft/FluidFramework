			...
			for (const { rebasedEditCount: peerCount, trunkEditCount: trunkCount } of scenarios) {
				...
				it(`Rebase a peer branch with ${peerCount} commits over ${trunkCount} trunk commits`, () => {
					...
					const expected = {
						...
						// we realize that the trunk already contains those edits, they therefore undergo no rebasing.
						// As part of rebasing P+ we realize that it is effectively based on the tip of the trunk,
