...
// // TODO: derive types like these from those schema, which subset Tree

// // TODO: provide relaxed types like these based on ContextuallyTyped setters

// export type Float64 = Brand<number, "editable-tree.Float64"> & Tree;
// export type Int32 = Brand<number, "editable-tree.Int32"> & Tree;
// export type Bool = Brand<boolean, "editable-tree.Bool"> & Tree;

// export type ComplexPhone = Tree &
// 	Brand<
// 		{
// 			number: string;
// 			prefix: string;
...
// 	>;
// export type Friends = Tree & Brand<Record<FieldKey, string>, "editable-tree.Map<String>">;

// export type Person = Tree &
// 	Brand<
// 		{
// 			name: string;
// 			age?: Int32;
...
// 	const context = getReadonlyTreeContext(forest, schema);
// 	return context;
// }
