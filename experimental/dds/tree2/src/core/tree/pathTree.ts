 ...
 * @alpha
 */
export interface FieldUpPath<TUpPath extends UpPath | undefined = UpPath> {
	/**
...
/**
 * A range of nodes in a rooted field.
 * Such ranges are generated attach operations and consumed by detach operations.
 */
export type AttachedRangeUpPath = Brand<RangeUpPath<undefined>, "AttachedRangeUpPath">;
 ...
 */
export type DetachedRangeUpPath = Brand<RangeUpPath<undefined>, "DetachedRangeUpPath">;
 ...
 */
export interface RangeUpPath<TUpPath extends UpPath | undefined = UpPath>
