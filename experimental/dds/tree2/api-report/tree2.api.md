...
// @alpha
type FixedSizeTypeArrayToTypedFlexTree<T extends readonly FlexTreeNodeSchema[]> = [
T extends readonly [infer Head, ...infer Tail] ? [
FlexTreeTypedNode<Assume<Head, FlexTreeNodeSchema>>,
...FixedSizeTypeArrayToTypedFlexTree<Assume<Tail, readonly FlexTreeNodeSchema[]>>
] : []
][_InlineTrick];
...
// @alpha
export type FlexTreeTyped<TSchema extends TreeFieldSchema | FlexTreeNodeSchema> = TSchema extends FlexTreeNodeSchema ? FlexTreeTypedNode<TSchema> : FlexTreeTypedField<Assume<TSchema, TreeFieldSchema>>;
...
// @alpha
export type FlexTreeTypedNodeUnion<TTypes extends AllowedTypes> = TTypes extends InternalTypedSchemaTypes.FlexList<FlexTreeNodeSchema> ? FlexTreeTypedNodeUnionHelper<TTypes> : FlexTreeNode;

// @alpha
type FlexTreeTypedNodeUnionHelper<TTypes extends InternalTypedSchemaTypes.FlexList<FlexTreeNodeSchema>> = InternalTypedSchemaTypes.ArrayToUnion<TypeArrayToTypedFlexTreeArray<Assume<InternalTypedSchemaTypes.FlexListToNonLazyArray<TTypes>, readonly FlexTreeNodeSchema[]>>>;
...
// @alpha
type InsertableObjectFromSchemaRecord<T extends RestrictiveReadonlyRecord<string, ImplicitFieldSchema_2>> = {
...
// @alpha (undocumented)
type InsertableTreeNodeFromImplicitAllowedTypes<TSchema extends ImplicitAllowedTypes_2 = TreeNodeSchema> = TSchema extends TreeNodeSchema ? Unhydrated<NodeFromSchema<TSchema>> | InsertableTypedNode_2<TSchema> : TSchema extends AllowedTypes_2 ? InsertableTypedNode_2<InternalTypedSchemaTypes.FlexListToUnion<TSchema>> : unknown;
...
// @alpha
type InsertableTypedNode_2<T extends TreeNodeSchema> = T extends TreeNodeSchema<any, any, any, any, infer TInsertable> ? TInsertable : never;

declare namespace InternalClassTreeTypes {
    export {
        ImplicitFieldSchema_2 as ImplicitFieldSchema,
...
export interface ITree extends IChannel {
    schematize<TRoot extends TreeNodeSchema>(config: TreeConfiguration<TRoot>): TreeView<NodeFromSchema<TRoot>>;
}
...
// @alpha
type NormalizeAllowedTypes<TSchema extends ImplicitAllowedTypes> = TSchema extends FlexTreeNodeSchema ? readonly [TSchema] : TSchema extends Any ? readonly [Any] : TSchema;
...
// @alpha
type ObjectFromSchemaRecord<T extends RestrictiveReadonlyRecord<string, ImplicitFieldSchema_2>> = {
...
export class SchemaFactory<TScope extends string, TName extends number | string = string> {
    ...
    list<const Name extends TName, const T extends ImplicitAllowedTypes_2>(name: Name, allowedTypes: T): TreeNodeSchemaClass<`${TScope}.${Name}`, NodeKind.List, T, TreeListNode<T>, Iterable<TreeNodeFromImplicitAllowedTypes<T>>>;
...
export interface TreeApi {
    ...
    on<K extends keyof EditableTreeEvents>(node: NodeBase, eventName: K, listener: EditableTreeEvents[K]): () => void;
...
export class TreeConfiguration<TSchema extends TreeNodeSchema = TreeNodeSchema> {
    constructor(schema: TSchema, initialTree: () => Unhydrated<NodeFromSchema<TSchema>>);
    // (undocumented)
    readonly initialTree: () => Unhydrated<NodeFromSchema<TSchema>>;
    // (undocumented)
    readonly schema: TSchema;
}
...
// @alpha (undocumented)
type TreeNodeFromImplicitAllowedTypes<TSchema extends ImplicitAllowedTypes_2 = TreeNodeSchema> = TSchema extends TreeNodeSchema ? NodeFromSchema<TSchema> : TSchema extends AllowedTypes_2 ? NodeFromSchema<InternalTypedSchemaTypes.FlexListToUnion<TSchema>> : unknown;
