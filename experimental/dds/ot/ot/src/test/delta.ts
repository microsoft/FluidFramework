...
export class SharedDelta extends SharedOT<Delta, Delta> {
    ...
    public static getFactory() { return new DeltaFactory(); }

    constructor(id: string, runtime: IFluidDataStoreRuntime, attributes: IChannelAttributes) {
        super(id, runtime, attributes, /* initialValue: */ new Delta());
    }

    public get delta(): Delta { return this.state; }
...
export class DeltaFactory implements IChannelFactory {
    ...
    public get type() { return DeltaFactory.Type; }
    public get attributes() { return DeltaFactory.Attributes; }
