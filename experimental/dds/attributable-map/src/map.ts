...
export class MapFactory implements IChannelFactory {
	...
	public async load(
		...
		const map = new AttributableSharedMap(id, runtime, attributes);
	...
	public create(runtime: IFluidDataStoreRuntime, id: string): ISharedMap {
		const map = new AttributableSharedMap(id, runtime, MapFactory.Attributes);
		map.initializeLocal();
 ...
 */
export class AttributableSharedMap extends SharedObject<ISharedMapEvents> implements ISharedMap {
	/**
	 ...
	 * ```
	 */
	public static create(runtime: IFluidDataStoreRuntime, id?: string): AttributableSharedMap {
		return runtime.createChannel(id, MapFactory.Type) as AttributableSharedMap;
	}
	 ...
	 */
	public readonly [Symbol.toStringTag]: string = "AttributableSharedMap";
