...
export const inheritNodeProp = {
	...
	properties: [{ id: "something", typeid: "String" }],
...
export const constantsCustomType = {
	constants: [{ id: "constGrandchild", typeid: "Uint32", context: "array" }],
	properties: [
		{ id: "propGrandchild", properties: [{ id: "dynamic_string", typeid: "String" }] },
	],
...
export const sampleComplexConstsSchema = {
	...
	properties: [{ id: "prop", typeid: "Int8", value: 123 }],
