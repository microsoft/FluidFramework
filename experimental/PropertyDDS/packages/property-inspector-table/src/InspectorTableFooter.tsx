...
import { icon24, iconBaseColor, iconHoverColor } from "./constants";
...
export const InspectorTableFooter: React.FunctionComponent<IInspectorTableFooterProps> = (
	props,
) => {
		...
		<div className={classes.footer}>
			...
			<div className={classes.svgFooterContainer}>
				<div
					...
					onClick={() => {
						handleExpandAll(parentProps);
					}}
				>
					<span>Expand All</span>
					<div id="expandAllButton" className={classes.svg}>
						<SvgIcon
							svgId={"expand-all"}
				...
				>
					...
					<div id="collapseAllButton" className={classes.svg}>
						<SvgIcon
							svgId={"collapse-all"}
							activeClassName={classes.footerButtonContainer}
							width={icon24}
