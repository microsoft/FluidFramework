...
export const ExpiryModal: React.FunctionComponent<IExpiryModalProps> = (props) => {
    ...
    const [modalState, setModalState] =
        useState<IModalState>({ mode: "default" });
    const [modalExpiryState, setModalExpiryState] =
        useState<IModalExpiryState>({ expiresIn: expiryPlaceHolder, expiryState: "live" });
    const [deletionState, setDeletionState] =
        useState<IModalDeletionState>({ deleting: false });
