...
const FloatingLabelTextField: React.FunctionComponent<
	IFloatingLabelTextFieldProps & WithStyles<typeof styles>
> = (props) => {
	const {
		classes,
		error,
...
const StyledFloatingLabelTextField = withStyles(styles, { name: "FloatingLabelTextField" })(
