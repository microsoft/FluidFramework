...
class ShareModal extends React.Component<
	IShareModalProps & WithStyles<typeof styles>,
	IShareModalState
> {
			...
			<div className={classes.infoContainer}>
				<div className={classes.info}>
					<SvgIcon
						...
						svgId={this.isPublic ? "visible-16" : "hidden-16"}
					/>
	...
	private readonly disablePublicSharing = () => {
		this.updateSharing(async () =>
			ErrorPopup(
				this.props.options.unshareHandler!.bind(this, ["*"], [], {
	...
	private readonly enablePublicSharing = () => {
		this.updateSharing(async () =>
			ErrorPopup(
				this.props.options.shareHandler.bind(this, ["*"], [], {
					actions: ["read", "write", "delete"],
				}),
			).then(() => {
