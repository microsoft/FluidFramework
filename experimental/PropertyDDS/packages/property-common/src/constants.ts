 ...
 * @alias property-common.SchemaValidator.MSG
 */
const VALIDATOR_MSG = {
    /**
     * @alias SV-001
...
const MSG = {
    ...
    // PF-003 Moved to Schema Validator (is now SV-001).
    ...
    // PF-013 Moved to Schema Validator (is now SV-002).
    // PF-014 Moved to Schema Validator (is now SV-003).
    // PF-015 Moved to Schema Validator (is now SV-004).
    // PF-016 Moved to Schema Validator (is now SV-005).
    // PF-017 Moved to Schema Validator (is now SV-006).
    // PF-018 Moved to Schema Validator (is now SV-007).
    // PF-019 Moved to Schema Validator (is now SV-008).
    // PF-020 Moved to Schema Validator (is now SV-009).
    // PF-021 AND PF-022 empty
    // PF-023 Moved to Schema Validator (is now SV-010).
    ...
    // PF-063 Moved to Schema Validator (is now SV-011).
    ...
    // UT-003 Moved to Schema Validator. (now use TH-001)
...
const MESSAGE_CONSTANTS = Object.assign(MSG, VALIDATOR_MSG);

export {
    CONNECTIVITY_RETRYABLE_ERRORS,
    NATIVE_BINARY_CONSTANTS,
    WORKSPACE_STATE,
