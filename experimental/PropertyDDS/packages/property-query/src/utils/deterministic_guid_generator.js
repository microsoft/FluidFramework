 ...
 */
const { hashCombine4xUint32, uint32x4ToGUID, guidToUint32x4 } =
...
class DeterministicGuidGenerator {
    ...
    constructor(seed1, seed2) {
        this.lastGuid = hashCombine4xUint32(
            guidToUint32x4(seed1),
            guidToUint32x4(seed2)
        );
    }
    ...
    getNextGuid(toCombineWithGuid, base64 = false) {
        this.lastGuid = hashCombine4xUint32(
            this.lastGuid,
            guidToUint32x4(toCombineWithGuid)
        );
