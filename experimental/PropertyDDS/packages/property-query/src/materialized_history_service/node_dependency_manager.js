	...
	if (!nodeStatus) {
		...
		if (in_parentRef) {
			...
			if (isCreateCommitSession) {
				if (
					parent.status >= NodeDependencyManager.NodeStatus.INTERNAL_CHILDREN_PROCESSED &&
		...
		if (isCreateCommitSession) {
			...
			if (
				in_newStatus >= NodeDependencyManager.NodeStatus.INTERNAL_CHILDREN_PROCESSED &&
...
NodeDependencyManager.prototype.getNode = function (in_nodeRef, in_session) {
	return in_session.nodeStatus[in_nodeRef] && in_session.nodeStatus[in_nodeRef].data;
};
...
NodeDependencyManager.prototype.getNodeParent = function (in_nodeRef, in_session) {
	return in_session.nodeStatus[in_nodeRef] && in_session.nodeStatus[in_nodeRef].parent;
};
...
NodeDependencyManager.prototype.getNodeStatus = function (in_nodeRef, in_session) {
	return in_session.nodeStatus[in_nodeRef] && in_session.nodeStatus[in_nodeRef].status;
};
