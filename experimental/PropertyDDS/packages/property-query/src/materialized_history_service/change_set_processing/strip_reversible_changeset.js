            ...
            if (TypeIdHelper.isPrimitiveType(type)) {
                ...
                if (type === "String" && !_.isString(nestedChangeset)) {
                    ...
                    if (nestedChangeset.modify) {
                        for (
                            let i = 0;
                            i < nestedChangeset.modify.length;
                            i++
                        ) {
                    ...
                    if (nestedChangeset.remove) {
                        for (
                            let i = 0;
                            i < nestedChangeset.remove.length;
                            i++
                        ) {
                    ...
                    if (
                        ...
                        in_context.replaceNestedChangeSet(
                            nestedChangeset.value
                        );
                    }
                } else if (
                    nestedChangeset &&
