...
describe("Index key encoder", () => {
    ...
    describe("for paths", () => {
        ...
        it("should properly decode values", () => {
            ...
            for (let i = 0; i < values.length; i++) {
                expect(encoder.decode(values[i][1])[0]).to.eql(
                    decodedValues[i]
                );
            }
        });
    ...
    describe("for single (Float32)", () => {
        before(() => {
            encoder = new IndexKeyEncoder([
                { name: "scienceStuff", typeId: "Single" },
            ]);
        });

        const values = [
            [-3.4028234663852886e38, "\x2000800000"],
            ...
            [3.4028234663852886e38, "\x20ff7fffff"],
        ];
    ...
    describe("for double (Float64)", () => {
        ...
        const values = [
            [-1.7976931348623157e308, "\x210010000000000000"],
            ...
            [1.7976931348623157e308, "\x21ffefffffffffffff"],
        ];
    ...
    describe("for tuples", () => {
        ...
        const values = [
            ...
            [
                [undefined, "Pier-Luc", undefined, false, undefined],
                "\x00\uffff\x01Pier-Luc\x00\x00\uffff\x26\x00\uffff",
            ],
            [
                ["a.b", undefined, 1234, true, undefined],
                "\x05\x01a\x00\x01b\x00\x00\x00\uffff\x1604d2\x27\x00\uffff",
            ],
            [
            ...
            [
                ["a.b", "Martin", 35, false, undefined],
                "\x05\x01a\x00\x01b\x00\x00\x01Martin\x00\x1523\x26\x00\uffff",
            ],
            [
                ["a.b", "Martin", 35, true, undefined],
                "\x05\x01a\x00\x01b\x00\x00\x01Martin\x00\x1523\x27\x00\uffff",
            ],
            [
            ...
            [
                ["a.b", "Martin", 35, true, 5.486124068793689e303],
