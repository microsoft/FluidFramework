...
describe("Query V1 execution", () => {
    ...
    const getCommitMVStub = sinon.stub(
        mockMaterializedHistoryService,
        "getCommitMV"
    );
    ...
    describe("with a from query member", () => {
        ...
        it("should return the result from materializedHistoryService as-is", () =>
            expect(
                aQV1Execution.execute(someBranchInfo, someCommitGuid, theQuery)
            ...
            it("should throw", () =>
                expect(
                    ...
                    .to.be.eventually.rejectedWith(
                        "from.typeId required when paging"
                    )
                    .and.to.have.property("statusCode", 400));
        });
        ...
        describe("paging with multiple orders but not all of them having by", () => {
            ...
            it("should throw", () =>
                expect(
                    ...
                    .to.be.eventually.rejectedWith(
                        "Only a single ordering criteria is allowed when ordering by key"
                    )
                    .and.to.have.property("statusCode", 400));
        });
        ...
        describe("paging with a native typeId passed", () => {
            ...
            it("should throw", () =>
                expect(
                    ...
                    .to.be.eventually.rejectedWith(
                        "from.typeId must not be a primitive type"
                    )
                    .and.to.have.property("statusCode", 400));
        });
