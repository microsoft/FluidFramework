...
export const proxyHandler = {
	 ...
	 */
	set(target: ProxyType<ContainerProperty | NodeProperty>, key: string, value: any) {
	 ...
	 */
	ownKeys: (target: ProxyType<ContainerProperty>) =>
		Reflect.ownKeys(target.getProperty().getEntriesReadOnly()),
};
