...
export const PropertyProxyErrors = {
	 ...
	 */
	NON_DYNAMIC_REMOVE:
		"PropertyProxy-006: It is not possible to delete properties from a non-dynamic parent.",

	/**
	 * @alias PropertyProxy-007
	 */
	ASSIGN_ITERABLE_TO_SINGLE:
		"PropertyProxy-007: " +
	 ...
	 */
	NON_REFERENCE_ASSIGN:
		"PropertyProxy-008: Only ReferenceProperties can be set via the [propertyName*] syntax.",
	...
	DIRECT_CHILDREN_ONLY:
		"PropertyProxy-010: getProperty() only provides access to direct child properties.",
};
