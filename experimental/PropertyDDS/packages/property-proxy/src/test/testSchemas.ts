			...
			properties: [
				...
				},
				{
					...
					value: [
						...
						"myEnumArray[0]",
						"refArrayToEnum[2]",
						"/myTestProperty.myEnumCases.refToEnum",
						"refArrayToEnum[4]",
						"/myTestProperty.myEnumCases.refToEnumArrayEntry",
						"refArrayToEnum[6]",
					],
				},
				{
					...
					value: {
						...
						c: "myEnumArray[0]",
						d: "refMapToEnum[c]",
						e: "/myTestProperty.myEnumCases.refToEnum",
						f: "refMapToEnum[e]",
						g: "/myTestProperty.myEnumCases.refToEnumArrayEntry",
						h: "refMapToEnum[g]",
					},
				},
			],
		},
		{
			...
			properties: [
				...
				},
				{
					...
					value: [
						"myUint64",
						"refArrayToUint64Int64[0]",
						"myUint64Array[0]",
						"refArrayToUint64Int64[2]",
						"myInt64Map[a]",
						"refArrayToUint64Int64[4]",
						"/myTestProperty.myUint64Int64Cases.refToUint64",
						"refArrayToUint64Int64[6]",
						"/myTestProperty.myUint64Int64Cases.refToUint64ArrayEntry",
						"refArrayToUint64Int64[8]",
						"/myTestProperty.myUint64Int64Cases.refToInt64MapEntry",
						"refArrayToUint64Int64[10]",
					],
				},
				{
					...
					value: {
						a: "myUint64",
						b: "refMapToUint64Int64[a]",
						c: "myUint64Array[0]",
						d: "refMapToUint64Int64[c]",
						e: "myInt64Map[a]",
						f: "refMapToUint64Int64[e]",
						g: "/myTestProperty.myUint64Int64Cases.refToUint64",
						h: "refMapToUint64Int64[g]",
						i: "/myTestProperty.myUint64Int64Cases.refToUint64ArrayEntry",
						j: "refMapToUint64Int64[i]",
						k: "/myTestProperty.myUint64Int64Cases.refToInt64MapEntry",
						l: "refMapToUint64Int64[k]",
					},
				},
			],
		},
