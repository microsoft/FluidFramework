...
describe('JS-Object-like property accessing ', function() {
  ...
  describe('Proxy properties directly', function() {
    it('should throw if something other than a HFDM property is supplied', function() {
      const someNonHFDMProperty = { a: 1, name: 'property' };
      expect(() => { PropertyProxy.proxify(someNonHFDMProperty); }).toThrow(Error, 'PropertyProxy-000');
    });
    ...
    describe('Array (with primitive type entries)', function() {
      ...
      describe('Setting', function() {
        ...
        it('should be possible to assign a new iterable', function() {
          ...
          }).toThrow(Error, 'PropertyProxy-003');
        });
      });
    });
      ...
      describe('Int32 Maps', function() {
        ...
        describe('Setting', function() {
          ...
          it('should be possible to assign a new iterable', function() {
            ...
            state.myTestProperty.myMap = new Map(entries);
            checkAssignment();
      ...
      describe('Maps with complex entries', function() {
        ...
        describe('Setting', function() {
          ...
          it('should be possible to assign a new iterable', function() {
            ...
            // Assign pure javascript iterables
            const entries = [['a', { x: 1, y: 2 }], ['b', { x: 3, y: 4 }]];
