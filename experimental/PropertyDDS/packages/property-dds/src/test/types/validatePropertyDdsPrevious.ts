...
* "ClassDeclaration_CompressedPropertyTreeFactory": {"forwardCompat": false}
*/
declare function get_old_ClassDeclaration_CompressedPropertyTreeFactory():
    TypeOnly<old.CompressedPropertyTreeFactory>;
declare function use_current_ClassDeclaration_CompressedPropertyTreeFactory(
    use: TypeOnly<current.CompressedPropertyTreeFactory>);
use_current_ClassDeclaration_CompressedPropertyTreeFactory(
    get_old_ClassDeclaration_CompressedPropertyTreeFactory());

/*
* Validate back compat by using current type in place of old type
* If breaking change required, add in package.json under typeValidation.broken:
* "ClassDeclaration_CompressedPropertyTreeFactory": {"backCompat": false}
*/
declare function get_current_ClassDeclaration_CompressedPropertyTreeFactory():
    TypeOnly<current.CompressedPropertyTreeFactory>;
declare function use_old_ClassDeclaration_CompressedPropertyTreeFactory(
    use: TypeOnly<old.CompressedPropertyTreeFactory>);
use_old_ClassDeclaration_CompressedPropertyTreeFactory(
    get_current_ClassDeclaration_CompressedPropertyTreeFactory());
...
* Validate forward compat by using old type in place of current type
* If breaking change required, add in package.json under typeValidation.broken:
* "ClassDeclaration_LZ4PropertyTree": {"forwardCompat": false}
*/
declare function get_old_ClassDeclaration_LZ4PropertyTree():
    TypeOnly<old.LZ4PropertyTree>;
declare function use_current_ClassDeclaration_LZ4PropertyTree(
    use: TypeOnly<current.LZ4PropertyTree>);
use_current_ClassDeclaration_LZ4PropertyTree(
    get_old_ClassDeclaration_LZ4PropertyTree());

/*
* Validate back compat by using current type in place of old type
* If breaking change required, add in package.json under typeValidation.broken:
* "ClassDeclaration_LZ4PropertyTree": {"backCompat": false}
*/
declare function get_current_ClassDeclaration_LZ4PropertyTree():
    TypeOnly<current.LZ4PropertyTree>;
declare function use_old_ClassDeclaration_LZ4PropertyTree(
    use: TypeOnly<old.LZ4PropertyTree>);
use_old_ClassDeclaration_LZ4PropertyTree(
    get_current_ClassDeclaration_LZ4PropertyTree());

/*
* Validate forward compat by using old type in place of current type
* If breaking change required, add in package.json under typeValidation.broken:
* "ClassDeclaration_LZ4PropertyTreeFactory": {"forwardCompat": false}
*/
declare function get_old_ClassDeclaration_LZ4PropertyTreeFactory():
    TypeOnly<old.LZ4PropertyTreeFactory>;
declare function use_current_ClassDeclaration_LZ4PropertyTreeFactory(
    use: TypeOnly<current.LZ4PropertyTreeFactory>);
use_current_ClassDeclaration_LZ4PropertyTreeFactory(
    get_old_ClassDeclaration_LZ4PropertyTreeFactory());

/*
* Validate back compat by using current type in place of old type
* If breaking change required, add in package.json under typeValidation.broken:
* "ClassDeclaration_LZ4PropertyTreeFactory": {"backCompat": false}
*/
declare function get_current_ClassDeclaration_LZ4PropertyTreeFactory():
    TypeOnly<current.LZ4PropertyTreeFactory>;
declare function use_old_ClassDeclaration_LZ4PropertyTreeFactory(
    use: TypeOnly<old.LZ4PropertyTreeFactory>);
use_old_ClassDeclaration_LZ4PropertyTreeFactory(
    get_current_ClassDeclaration_LZ4PropertyTreeFactory());
