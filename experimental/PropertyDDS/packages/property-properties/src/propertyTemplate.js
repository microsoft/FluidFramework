 ...
 */
PropertyTemplate.prototype._isVersioned = function () {
 ...
 * @return {string} The version string is returned.
 */
PropertyTemplate.prototype._canonicalForm = function (in_obj, in_target_, in_key_, in_preserve_) {
 ...
 */
PropertyTemplate.prototype.serializeCanonical = function () {
...
/**
  ...
  */
PropertyTemplate.isTemplate = function (in_param) {
...
*/
PropertyTemplate.extractDependencies = function (template) {
    var dependencies = {};
