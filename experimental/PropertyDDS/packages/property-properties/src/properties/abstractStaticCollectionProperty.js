 ...
 */
var AbstractStaticCollectionProperty = function (in_params) {
...
AbstractStaticCollectionProperty.prototype = Object.create(BaseProperty.prototype);
 ...
 */
AbstractStaticCollectionProperty.prototype.get = function (in_ids, in_options) {
 ...
 * @return {property-properties.BaseProperty | undefined} The property you seek or undefined if none is found.
 */
AbstractStaticCollectionProperty.prototype._get = function (in_id) {
 ...
 */
AbstractStaticCollectionProperty.prototype.getId = function () {
    if (this._id !== null) {
        return this._id;
    } else {
        return this.getGuid();
 ...
 */
AbstractStaticCollectionProperty.prototype.getGuid = function () {
 ...
 */
AbstractStaticCollectionProperty.prototype.getValue = function (in_ids, in_options) {
 ...
 */
AbstractStaticCollectionProperty.prototype.getEntriesReadOnly = function () {
 ...
 */
AbstractStaticCollectionProperty.prototype.getIds = function () {
    return this._getIds();
};
 ...
 * @return {Array.<string>} An array of all the property ids
 */
AbstractStaticCollectionProperty.prototype._getIds = function () {
 ...
 * }
 */
AbstractStaticCollectionProperty.prototype.getValues = function () {
 ...
 */
AbstractStaticCollectionProperty.prototype.has = function (in_id) {
 ...
 */
AbstractStaticCollectionProperty.prototype.resolvePath = function (in_path, in_options) {
 ...
 * @protected
 */
AbstractStaticCollectionProperty.prototype._getPathSegmentForChildNode = function (in_childNode) {
 ...
 * @protected
 */
AbstractStaticCollectionProperty.prototype._resolvePathSegment = function (in_segment, in_segmentType) {
 ...
 */
AbstractStaticCollectionProperty.prototype._setValues = function (in_values, in_typed, in_initial) {
 ...
 */
AbstractStaticCollectionProperty.prototype.setValues = function (in_values) {
 ...
 */
AbstractStaticCollectionProperty.prototype._append = function (in_property, in_allowChildMerges) {
...
* @protected
*/
AbstractStaticCollectionProperty.prototype._merge = function (in_property) {
 ...
 * @inheritdoc
 */
AbstractStaticCollectionProperty.prototype._getDirtyChildren = function (in_flags) {
 ...
 *                            otherwise undefined
 */
AbstractStaticCollectionProperty.prototype.traverseDown = function (in_callback) {
 ...
 * @private
 */
AbstractStaticCollectionProperty.prototype._traverse = function (in_callback, in_pathFromTraversalStart) {
 ...
 * @protected
 */
AbstractStaticCollectionProperty.prototype._traverseStaticProperties = function (in_callback,
 ...
 * @private
 */
AbstractStaticCollectionProperty.prototype._serialize = function (in_dirtyOnly,
 ...
 *     deserialization
 */
AbstractStaticCollectionProperty.prototype._deserialize = function (in_serializedObj, in_reportToView) {
 ...
 * @private
 */
AbstractStaticCollectionProperty.prototype._flatten = function () {
 ...
 * @private
 */
AbstractStaticCollectionProperty.prototype._getChildrenCount = function () {
 ...
 */
AbstractStaticCollectionProperty.prototype._setConstants = function (in_constants) {
...
Object.defineProperty(
    AbstractStaticCollectionProperty.prototype,
    '_properties',
    {
        get: function () {
...
module.exports = AbstractStaticCollectionProperty;
