        ...
        for (iClass = 0; iClass < classKeys.length; iClass++) {
            ...
            for (i = 0; i < modifiedKeys.length; i++) {
                ...
                if (this._containsPrimitiveTypes) {
                    ...
                    valueWasChanged = this._typeid === 'Int64' || this._typeid === 'Uint64' ? this._dynamicChildren[modifiedKeys[i]].getValueLow() !== changes[0] ||
                            this._dynamicChildren[modifiedKeys[i]].getValueHigh() !== changes[1] : this._dynamicChildren[modifiedKeys[i]] !== changes;
