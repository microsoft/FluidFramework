...
ContainerProperty.prototype = Object.create(IndexedCollectionBaseProperty.prototype);
 ...
 */
ContainerProperty.prototype._getIds = function () {
 ...
 */
ContainerProperty.prototype._get = function (in_id) {
 ...
 * @private
 */
ContainerProperty.prototype._addOptionalChild = function (in_id, in_typeid) {
 ...
 */
ContainerProperty.prototype.insert = function (in_id, in_property) {
 ...
 * @protected
 */
ContainerProperty.prototype._validateInsert = function (in_id, in_property) {
 ...
 * @inheritdoc
 */
ContainerProperty.prototype._getScope = function () {
    if (this._parent) {
 ...
 */
ContainerProperty.prototype.remove = function (in_property) {
    var id = in_property;
    var returnValue;
 ...
 * @protected
 */
ContainerProperty.prototype._validateRemove = function (in_id) {
 ...
 */
ContainerProperty.prototype._insert = function (in_key, in_property, in_reportToView) {
    this._checkIsNotReadOnly(true);
 ...
 *     When batching updates, this can be prevented via this flag.
 */
ContainerProperty.prototype._removeByKey = function (in_key, in_reportToView) {
    this._checkIsNotReadOnly(true);
 ...
 * @protected
 */
ContainerProperty.prototype._setCheckedOutRepositoryInfo = function (in_checkedOutRepositoryInfo) {
 ...
 * @protected
 */
ContainerProperty.prototype._getCheckedOutRepositoryInfo = function () {
 ...
 */
ContainerProperty.prototype.getStaticIds = function () {
 ...
 */
ContainerProperty.prototype.getDynamicIds = function () {
...
*/
ContainerProperty.prototype._getDynamicChildrenReadOnly = function () {
 ...
 * @private
 */
ContainerProperty.prototype.setValues = function (in_properties) {
