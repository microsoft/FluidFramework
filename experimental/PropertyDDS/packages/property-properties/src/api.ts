 ...
 */
export type ArrayChangeSetRangeType_TYPE = number;
/**
 * Used to set the synchronization mode of the Workspace.
 */
export type SYNC_MODE_TYPE = number;
export interface SYNC_MODE_ENUM {
 ...
 */
export type REBASE_CALLBACK_NOTIFICATION_MODES_TYPE = number;
export interface REBASE_CALLBACK_NOTIFICATION_MODES_ENUM {
 ...
 */
export type SERVER_AUTO_REBASE_MODES_TYPE = number;
export interface SERVER_AUTO_REBASE_MODES_ENUM {
 ...
 */
export type REFERENCE_RESOLUTION_TYPE = number;
export interface REFERENCE_RESOLUTION_ENUM {
 ...
 */
export type MODIFIED_STATE_FLAGS_TYPE = number;
export interface MODIFIED_STATE_FLAGS_ENUM {
 ...
 */
export type BINARY_PROPERTY_STATUS_TYPE = number;
export interface BINARY_PROPERTY_STATUS_ENUM {
	NEW: number;
	INITIALIZED: number;
	ATTACHING: number;
	ATTACHED: number;
 ...
 * Token Types
 */
export type TOKEN_TYPES_TYPE = number;
export interface TOKEN_TYPES_ENUM {
 ...
 */
export type STATE_TYPE = number;
export interface STATE_ENUM {
 ...
 */
export type RepositoryState_TYPE = number;
export interface RepositoryState_ENUM {
	INIT: number;
	LOADING: number;
	LOADED: number;
	UPDATING: number;
 ...
 * Iterator types
 */
export type types_TYPE = number;
export interface types_ENUM {
	INSERT: number;
	REMOVE: number;
	MODIFY: number;
	MOVE: number;
 ...
 * Token Types
 */
export type PATH_TOKENS_TYPE = number;
export interface PATH_TOKENS_ENUM {
...
export type PropertyTemplateType = {
...
export type ArrayProperty_ArrayProperty_in_params_TYPE = {
	length: number; // the length of the array, if applicable
};
export type BaseProperty_BaseProperty_in_params_TYPE = {
	id: string; // id of the property
...
export type BinaryProperty_BinaryProperty_in_params_TYPE = {
	typeid: string; // Type Id (nothing for BinaryProperty)
};
export type ContainerProperty_ContainerProperty_in_params_TYPE = {
...
export type EnumArrayProperty_EnumArrayProperty_in_params_TYPE = {
	length: number; // the length of the array, if applicable
	_enumDictionary: object; // the value<->enum dictonary needed to convert the values
};
export type NamedNodeProperty_NamedNodeProperty_in_params_TYPE = {
	id: string; // id of the property (null, if the GUID should be used for the ID)
	typeid: string; // The type identifier
};
export type NamedProperty_NamedProperty_in_params_TYPE = {
	id: string; // id of the property (null, if the GUID should be used for the ID)
	typeid: string; // The type identifier
};
export type RepositoryReferenceProperty_RepositoryReferenceProperty_in_params_TYPE = {
	id: string; // id of the property
	name: string; // Name of the property
	typeid: string; // The type identifier
};
export type ValueProperty_ValueProperty_in_params_TYPE = {
	dataObj: object; // optional argument containing an object
	//                  that should be used as the backing store of this value
	//                  property
	dataId: object; // optional argument must be provided when
...
export type ScopeProperty_ScopeProperty_in_params_TYPE = {
	scope: string; // The scope to keep track of
};
export type Repository_Repository_in_params_TYPE = {
...
export type BranchNode_BranchNode_in_params_TYPE = {
	guid: string; // The guid of the branch
	name: string; // The name of the branch. Will default to the guid.
};
export type PropertyFactory_create_in_options_TYPE = {
...
export type PropertyFactory_inheritsFrom_in_options_TYPE = {
	includeSelf?: boolean; // Also return true if in_templateTypeid === in_baseTypeid
	workspace?: Workspace; // A checked out workspace to check against. If supplied,
	//  the function will check against the schemas that have been registered within the workspace
};
export type PropertyFactory_getAllParentsForTemplate_in_options_TYPE = {
...
export type getBearerTokenFn = (...arg: any[]) => any; // TODO
export type PropertyFactory_initializeSchemaStore_in_options_TYPE = {
...
export type Workspace_initialize_in_options_TYPE = {
...
export type Workspace_branch_in_options_TYPE = {
	metadata?: {
		// The branch metadata
		name?: string;
	};
...
export type Workspace_commit_in_options_TYPE = {
...
export type Workspace_rebase_in_options_TYPE = {
...
export type Workspace_revertTo_in_options_TYPE = {
	/**
...
export type Workspace_setRebaseCallback_in_options_TYPE = {
	notificationMode?: number; // Mode controlling the invocation of the rebase callback
	//  (default = ALWAYS)
};
export type Workspace_checkout_in_options_TYPE = {
	paths: string[]; // List of paths to checkout.
	//  NOTE: the workspace will ONLY load the given paths and will only receive changes on these paths from the server.
};
export type Workspace_resolvePath_in_options_TYPE = {
	referenceResolutionMode: REFERENCE_RESOLUTION_TYPE; // How should this function behave during reference resolution?
};
export type Workspace_get_in_options_TYPE = {
	referenceResolutionMode: REFERENCE_RESOLUTION_TYPE; // How should this function behave during reference resolution?
};
export type ArrayProperty_get_in_options_TYPE = {
	referenceResolutionMode: REFERENCE_RESOLUTION_TYPE; // How should this function behave during reference resolution?
};
export type BaseProperty_serialize_in_options_TYPE = {
...
export type Datastore = any; // TODO
export type DataSource = any; // TODO
export type BinaryProperty_initialize_in_params_TYPE = {
	datastore: Datastore; // Datastore for storing data.
	dataSource: DataSource; // DataSource to read or write to.
};
export type ContainerProperty_get_in_options_TYPE = {
	referenceResolutionMode: REFERENCE_RESOLUTION_TYPE; // How should this function behave during reference resolution?
};
export type ContainerProperty_getValue_in_options_TYPE = {
	referenceResolutionMode: REFERENCE_RESOLUTION_TYPE; // How should this function behave during reference resolution?
};
export type ContainerProperty_resolvePath_in_options_TYPE = {
	referenceResolutionMode: REFERENCE_RESOLUTION_TYPE; // How should this function behave during reference resolution?
};
export type ReferenceProperty_get_in_options_TYPE = {
	referenceResolutionMode: REFERENCE_RESOLUTION_TYPE; // How should this function behave during reference resolution?
};
export type ReferenceProperty_resolvePath_in_options_TYPE = {
	referenceResolutionMode: REFERENCE_RESOLUTION_TYPE; // How should this function behave during reference resolution?
};
export type CoarsePermission = "read" | "write" | "delete";
...
export type Repository__branch_in_options_TYPE = {
...
export type Repository__rebase_in_options_TYPE = {
...
export type RepositoryStore_createRemoteRepository_in_params_TYPE = {
...
export type RepositoryStore_addCommitNode_in_params_TYPE = {
...
export type RepositoryStore_updateRepository_in_params_TYPE = {
...
export type EnumArrayProperty_get_in_options_TYPE = {
	referenceResolutionMode: REFERENCE_RESOLUTION_TYPE; // How should this function behave during reference resolution?
};
export type ValueArrayProperty_get_in_options_TYPE = {
	referenceResolutionMode: REFERENCE_RESOLUTION_TYPE; // How should this function behave during reference resolution?
};

export type NamedProperty_share_permission_TYPE = {
...
export type NamedProperty_share_options_TYPE = {
...
export type NamedProperty_unshare_permission_TYPE = {
	userIds: Array<string>; // The user ids which will get permissions assigned
	groupIds?: Array<string>; // The user group ids which will get permissions assigned
	serviceIds?: Array<string>; // The service ids which will get permissions assigned
	actions: PropertyPermission[]; // The actions to grant to the subject on the property
};
export type NamedProperty_unshare_options_TYPE = {
	synchronous?: boolean; // whether the share sould be sent to the PropertyTree immediatly or on next sync
};
export type BranchIdentifier = any; // TODO
export type CommitOrBranchIdentifier = any; // TODO
export type RootProperty = any; // TODO
export type ExpiryTimeType = "transient" | "temporary" | "persistent" | number;
...
export declare class PropertyError {}

export declare class PropertyFactoryError {}

export declare class RepositoryError {}

export declare class ServerError {}

export declare class ChangeSetError {}

export declare class UtilsError {}

export declare class PssClientError {}

export declare class JSONSchemaToPropertySetsTemplateConverter {
	/**
...
export declare class ContainerProperty extends BaseProperty {
	/**
...
export declare class IndexedCollectionBaseProperty extends ContainerProperty {
	/**
...
export declare class ValueArrayProperty extends ArrayProperty {
	/**
...
export declare class ArrayProperty extends ContainerProperty {
	/**
...
export declare class EnumArrayProperty extends ArrayProperty {
	/**
 ...
 */
export declare class ReferenceArrayProperty extends ArrayProperty {
	/**
...
export declare class StringProperty extends ValueArrayProperty {
	/**
...
export declare class Float32ArrayProperty extends ValueArrayProperty {}

export declare class Float64ArrayProperty extends ValueArrayProperty {}

export declare class Uint8ArrayProperty extends ValueArrayProperty {}

export declare class Int8ArrayProperty extends ValueArrayProperty {}

export declare class Uint16ArrayProperty extends ValueArrayProperty {}

export declare class Int16ArrayProperty extends ValueArrayProperty {}

export declare class Uint32ArrayProperty extends ValueArrayProperty {}

export declare class Int32ArrayProperty extends ValueArrayProperty {}

export declare class Integer64ArrayProperty extends ValueArrayProperty {}

export declare class Int64ArrayProperty extends Integer64ArrayProperty {
	/**
	 * Inserts the content of a given array into the array property
	 * It will not overwrite the existing values but push them to the right instead.
	 * E.g. [1, 2, 3] .insertRange(1, [9, 8]) => [1, 9, 8, 2, 3]
...
export declare class Uint64ArrayProperty extends Integer64ArrayProperty {
	/**
	 * Inserts the content of a given array into the array property
	 * It will not overwrite the existing values but push them to the right instead.
	 * E.g. [1, 2, 3] .insertRange(1, [9, 8]) => [1, 9, 8, 2, 3]
...
export declare class StringArrayProperty extends ValueArrayProperty {}

export declare class BoolArrayProperty extends ValueArrayProperty {}

export declare class BinaryProperty extends NamedProperty {
	/**
...
export var PropertyFactory: IPropertyFactory;
...
export declare class CommitNode {
	/**
...
export declare class MapProperty extends IndexedCollectionBaseProperty {
	/**
...
export declare class ReferenceMapProperty extends StringMapProperty {
	/**
...
export declare class ValueMapProperty extends MapProperty {
	/**
...
export declare class Float32MapProperty extends ValueMapProperty {}

export declare class Float64MapProperty extends ValueMapProperty {}

export declare class Uint32MapProperty extends ValueMapProperty {}

export declare class Uint16MapProperty extends ValueMapProperty {}

export declare class Uint8MapProperty extends ValueMapProperty {}

export declare class Int32MapProperty extends ValueMapProperty {}

export declare class Integer64MapProperty extends ValueMapProperty {
...
export declare class Int64MapProperty extends Integer64MapProperty {}

export declare class Uint64MapProperty extends Integer64MapProperty {}

export declare class Int16MapProperty extends ValueMapProperty {}

export declare class Int8MapProperty extends ValueMapProperty {}

export declare class StringMapProperty extends ValueMapProperty {}

export declare class BoolMapProperty extends ValueMapProperty {}

export declare class NamedNodeProperty extends NodeProperty {
	/**
...
export declare class NodeProperty extends IndexedCollectionBaseProperty {
	/**
...
export declare class SetProperty extends IndexedCollectionBaseProperty {
	/**
...
export declare class PropertyTemplate {
	/**
...
export declare class NamedProperty extends ContainerProperty {
	/**
...
export declare class ReferenceProperty extends ValueProperty {
	/**
	 * This class serves as a view to read, write and listen to changes in an
	 * object's value field. To do this we simply keep a pointer to the object and
...
export declare class RepositoryReferenceProperty extends ContainerProperty {
	/**
 ...
 */
export declare class BoolProperty extends ValueProperty<boolean> {}

export declare class EnumProperty extends Int32Property {
	/**
 ...
 */
export declare class Float32Property extends ValueProperty<number> {}

/**
 * A primitive property for a 64 bit floating point value.
 */
export declare class Float64Property extends ValueProperty<number> {}

/**
 * A primitive property for an signed 8 bit integer value.
 */
export declare class Int8Property extends ValueProperty<number> {}

/**
 * A primitive property for an signed 16 bit integer value.
 */
export declare class Int16Property extends ValueProperty<number> {}

/**
 * A primitive property for an signed 32 bit integer value.
 */
export declare class Int32Property extends ValueProperty<number> {}

export declare class Integer64Property extends ValueProperty<number> {
	/**
 ...
 */
export declare class Int64Property extends Integer64Property {
	setValue(): void;
}
 ...
 */
export declare class Uint64Property extends Integer64Property {
	setValue(): void;
}
 ...
 */
export declare class Uint8Property extends ValueProperty<number> {}

/**
 * A primitive property for an unsigned 16 bit integer value.
 */
export declare class Uint16Property extends ValueProperty<number> {}

/**
 * A primitive property for an unsigned 32 bit integer value.
 */
export declare class Uint32Property extends ValueProperty<number> {}

export declare class ValueProperty<T = any> extends BaseProperty {
	/**
	 * This class serves as a view to read, write and listen to changes in an
	 * object's value field. To do this we simply keep a pointer to the object and
	 * its associated data field that we are interested in. If no data field is
...
export declare class CheckedOutRepositoryInfo {
	/**
...
export declare class ScopeProperty {
	/**
...
export declare class _createTemplateValidator {
	/**
 ...
 */
export declare function enableValidations(enabled: boolean);
