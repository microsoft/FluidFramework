            ...
            properties: [
              ...
              },
              {
                id: 'map_poly', typeid: 'SimpleTest:EntryWithOverriddenDefaults-1.0.0', context: 'map', typedValue: {
                  key2: { typeid: 'SimpleTest:EntryWithOverriddenPolyDefaults-1.0.0',
                    value: { string: 'map_poly_string_2_inherited' } },
                  key3: { typeid: 'SimpleTest:EntryWithOverriddenPolyDefaults-1.0.0',
      ...
      describe('Overriding constants', function() {
            ...
            constants: [
              ...
              },
              {
                id: 'map_poly', typeid: 'SimpleTest:EntryWithOverriddenConstants-1.0.0', context: 'map', typedValue: {
                  key2: { typeid: 'SimpleTest:EntryWithOverriddenPolyConstants-1.0.0',
                    value: { string: 'map_poly_string_2_inherited' } },
                  key3: { typeid: 'SimpleTest:EntryWithOverriddenPolyConstants-1.0.0',
                    value: { string: 'map_poly_string_3_inherited' } }
                }
              },
              {
        ...
        it('should allow overriding constants with typed values', function() {
          ...
          var SquareWithTypedOverriddenConstants = {
            ...
            constants: [
              { id: 'entry1', typedValue: { typeid: 'SimpleTest:EntryWithTypedOverriddenConstants-1.0.0',
                value: { string: 'entry_string_1' } } },
              { id: 'entry2', typedValue: { typeid: 'SimpleTest:EntryWithTypedOverriddenPolyConstants-1.0.0',
              ...
              },
              {
                id: 'map', typeid: 'SimpleTest:EntryWithTypedOverriddenConstants-1.0.0', context: 'map', typedValue: {
                  key2: { typeid: 'SimpleTest:EntryWithTypedOverriddenPolyConstants-1.0.0',
                    value: { string: 'map_string_2_inherited', name: 'map_string_2' } },
                  key3: { typeid: 'SimpleTest:EntryWithTypedOverriddenPolyConstants-1.0.0',
