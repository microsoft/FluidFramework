...
describe('Reversible ChangeSets', function() {
  ...
  it('should work for custom map properties', function() {
    ...
    testRevAndInvCS(
      ...
      },
      {
        'map<NamedProperty>': {
          'map': {
            'insert': {'autodesk.tests:AnonymousMapTestPropertyID-1.0.0': {
              'F': {'String': {'stringProperty': ''}}
            }},
            'remove': {'autodesk.tests:AnonymousMapTestPropertyID-1.0.0': {
              'B': {'String': {'stringProperty': ''}}, 'C': {'String': {'stringProperty': ''}}
            }},
            'modify': {'autodesk.tests:AnonymousMapTestPropertyID-1.0.0': {
  ...
  it('@regression should not fail when creating a reversible change set', function() {
    var cs = {'modify': {'autodesk.compute:graph-1.0.0': {'5eb6ebe1-92c8-52fa-984b-b0b65c46d2a7':
    {'map<autodesk.compute:node-2.0.0>': {'computeNodes': {'modify': {'autodesk.compute:fanOut-1.0.0':
    {'a7e7d213-1202-9ee4-a3c1-8a33d6f36122': {'autodesk.compute:context-1.0.0': {'computeContext':
    {'Reference<autodesk.compute:resource-2.0.0>': {'resource': '/8ce10fdd-b2b6-7152-21dc-c0e199b579e3'}}},
      'map<autodesk.compute:node-2.0.0>': {'computeNodes': {'modify': {'autodesk.test:testCN-1.0.0':
      {'1e924300-92ef-eaad-391f-53b77fe01099': {'enum<Enum>': {'status': 1}, 'autodesk.compute:context-1.0.0':
      {'computeContext': {'Reference<autodesk.compute:resource-2.0.0>': {'resource':
      '/c1a811ea-608e-5fcc-1487-c74ab6939dee'}}}, 'Reference<autodesk.core:user-1.0.0>': {'inputs.input':
    ...
    var parent = {'insert': {'autodesk.compute:graph-1.0.0': {'5eb6ebe1-92c8-52fa-984b-b0b65c46d2a7':
    {'map<autodesk.compute:node-2.0.0>': {'computeNodes': {'insert': {'autodesk.compute:fanOut-1.0.0':
    {'a7e7d213-1202-9ee4-a3c1-8a33d6f36122': {'autodesk.compute:context-1.0.0': {'computeContext':
      {'Reference<autodesk.compute:resource-2.0.0>': {'resource': ''}}}, 'map<autodesk.compute:node-2.0.0>':
      {'computeNodes': {'insert': {'autodesk.test:testCN-1.0.0': {'1e924300-92ef-eaad-391f-53b77fe01099':
      {'enum<Enum>': {'status': 0}, 'autodesk.compute:context-1.0.0': {'computeContext':
      {'Reference<autodesk.compute:resource-2.0.0>': {'resource': ''}}}, 'Reference<autodesk.core:user-1.0.0>':
      {'inputs.input': ''}}}}}}}}}}}}}}};
