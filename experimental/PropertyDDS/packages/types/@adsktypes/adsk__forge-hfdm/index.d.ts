declare module "@fluid-experimental/property-properties" {
    namespace HFDM_NS {
         ...
         */
        type ConflictType_TYPE = number;
        interface ConflictType_ENUM {
          INVALID_CHANGESET_BASE: number; // We had two incompatible ChangeSets, they probably were with respect to different base commits
          COLLIDING_SET: number; // A value was changed in both ChangeSets
          ENTRY_MODIFIED_AFTER_REMOVE: number; // A deleted child node was modified
          ENTRY_MODIFICATION_AFTER_REMOVE_INSERT: number; // A child was modified after it had been removed and added.
            //
          ...
          INSERTED_ENTRY_WITH_SAME_KEY: number; // An entry with the same key was inserted into the collection
          REMOVE_AFTER_MODIFY: number; // A property was removed after a modify, this should mostly be safe, be we report it for completeness sake
          MISMATCH_TEMPLATES: number;
          INSERT_IN_REMOVED_RANGE: number;
        }
        /**
        ...
        type ChangeSet_applyChangeSet_in_options_TYPE = {
        ...
        type Utils_traverseChangeSetRecursively_in_params_TYPE = {
        ...
        type Utils_getChangesToTokenizedPaths_in_options_TYPE = {
        ...
        type Utils_extractPathsFromChangeSet_in_options_TYPE = {
          includeOperation: boolean | undefined; // Flag to include the operation
          includeTypeidInfo: boolean | undefined; // Flag to include the typeid info
        }
        ...
        class CheckoutView extends EventEmitter {
          /**
           ...
           */
          getActiveCommit(): BranchNode | string;
          /**
           ...
           * Sets the workspace.
           */
          protected _setWorkspace(): void;
          /**
           * Gets the workspace.
           */
          protected _getWorkspace(): Workspace | undefined;
          /**
           * Get all loaded templates from the checked out repository infos.
           */
          getTemplates(): object;
          /**
           ...
           */
          protected _setParentRepository(): void;
          /**
           * Returns the parent repository guid
           */
          getParentRepositoryGuid(): string | undefined;
          /**
           * Returns the repository information for the given GUID.
           *
           ...
           */
          getNotificationDelayScope(): number;
          /**
          ...
          getNumberOfCheckedOutRepositories(): number;
          /**
           ...
           */
          addReferencingRepositoryReferenceProperty(): void;
          /**
           * Removes a reference to a repository reference property that points to this repository
           */
          removeReferencingRepositoryReferenceProperty(): void;
          /**
           * Revert the PropertySet to a state, given a changeset
           */
          revertToState(): SerializedChangeSet;
          /**
           * Update the PropertySet to a new state, given the old and the new commit nodes.
           * TODO: We should already know the current commit node that we're representing, for consistency...
           * TODO: We should already know the repository we're representing...
           */
          _updateToCommit(): SerializedChangeSet;
          /**
           ...
           */
          getDirtyItems(): object;
          /**
           * Delays notifications until setNotificationDelayScope has been called with a 0 argument
           * pushNotificationDelayScope.
           */
          setNotificationDelayScope(): void;
          /**
           * Returns a serialized list of the changes in the CheckedOutRepositoryInfo
           */
          serializePendingChanges(): ChangeSet;
          /**
           ...
           */
          _gatherUnknownTemplates(): object;
          /**
           ...
           */
          protected _propertyDirtied(): void;
          /**
        ...
        class RepositoryStore {
          /**
           * Manages a group of repositories and builds indexes for repository Guids, branch Guids and commit Guids
           */
          constructor();
          /**
           ...
           * @param in_params The list of parameters
           * @param in_params.repository.guid GUID of the repository
           * @param in_params.repository.creatorId The Oxygen user ID of the Repository creator
           * @param in_params.rootCommit.guid Guid representing the root commit of the Repository
           *                                               This is generally set when loading a Repository for the first time
           */
          createRemoteRepository(in_params: RepositoryStore_createRemoteRepository_in_params_TYPE): Repository;
          /**
           * Update the Repository commit graph by adding a new commit node.
           * @param in_params List of options
           * @param in_params.branch.guid The guid of the branch that the commit belongs to
           *    Note: This will change soon as commits may belong to multiple branches
           */
          addCommitNode(in_params: RepositoryStore_addCommitNode_in_params_TYPE): void;
          /**
           * Return the Repository specified by the given guid
           */
           ...
           * @param in_repository The Repository to update
           * @param in_params The list of parameters
           */
          updateRepository(in_repository: Repository, in_params: RepositoryStore_updateRepository_in_params_TYPE): void;
          /**
           * Returns the local commit node that corresponds to the Guid identifier.
           */
          getCommit(): CommitNode | Error | undefined;
          /**
           * Returns the local branch node that corresponds to the guid identifier.
           */
          getBranch(): BranchNode | Error | undefined;
          /**
           * Returns the repository for a given commit Guid
           */
          getRepositoryForCommitGuid(): Repository | undefined;
          /**
           * Returns the repository for a given branch Guid
           */
          getRepositoryForBranchGuid(): Repository | undefined;
          /**
           * Returns true is the input repository is local; False otherwise.
           */
        ...
        class ReferenceArrayProperty extends ArrayProperty {
           ...
           * @param {Array<HFDM.Property.BaseProperty|undefined|String>} in_array  - contains the properties to be set or
        ...
        class Utils {
           ...
           */
          traverseChangeSetRecursively(in_changeSet: SerializedChangeSet, in_params: Utils_traverseChangeSetRecursively_in_params_TYPE, in_finalizer?: Function): void;
          /**
           ...
           * @param in_options -
           */
          getChangesToTokenizedPaths(in_paths: object, in_changeSet: SerializedChangeSet, in_callback: Function, in_options?: Utils_getChangesToTokenizedPaths_in_options_TYPE): void;
          /**
           ...
           */
          getFilteredChangeSetByPaths(): SerializedChangeSet;
          /**
           ...
           */
          extractPathsFromChangeSet(in_changeSet: SerializedChangeSet, in_options?: Utils_extractPathsFromChangeSet_in_options_TYPE): object;
          /**
           * Gather all properties that pass an arbitrary predicate function
           */
          gatherProperties(): Array<BaseProperty>;
        ...
        class Workspace extends EventEmitter {
          ...
          hasPendingChanges(): Boolean;
          /**
           * Returns the HFDM object for this workspace.
           */
          getHfdm(): HFDM;
          /**
        ...
        class ChangeSet {
           ...
           * @param in_options Optional additional parameters
           */
          applyChangeSet(in_changeSet: ChangeSet | SerializedChangeSet, in_options?: ChangeSet_applyChangeSet_in_options_TYPE): void;
          /**
           * Helper function which checks whether a given serialized changeSet is an empty changeSet.
           */
          isEmptyChangeSet(): boolean;
          /**
          ...
          static ConflictType: ConflictType_ENUM;

        }

        class HFDM extends EventEmitter {
          /**
          ...
          constructor();
          /**
           * Gets the server's environment which is used when building URNs
           *   Returns: Server's environment
           */
          getEnvironment() : string | undefined;
          /**
           * Connect to the PropertySetsServer
           * @param in_options connection options
           * @param in_params.requestOptions LYNX.Utils.RequestUtils.requestWithRetries parameters
           */
          connect(in_options: HFDM_connect_in_options_TYPE): Promise<any>;
          /**
           * Disconnect from the backend
           * This method disconnects from the backend. Note that it DOES NOT leave any branches, because
           * we are able to work offline for some time and properly reconnect later.
           */
           ...
           */
          getRepository(in_urn: string): Repository | undefined;
          /**
           * Returns the local branch node that corresponds to the Urn identifier.
           */
          getBranch(in_urn: string): BranchNode | undefined;
          /**
           * Returns the local commit node that corresponds to the Urn identifier.
           */
          getCommit(in_urn: string): CommitNode | undefined;
          /**
           * Creates a new Workspace object associated with this HFDM instance.
           * All new workspaces are assigned the 'Temporary' retention policy by default,
           * and will expire after 30 days. That can be changed by calling 'HFDM.setExpiry'.
           * HFDM keeps track of all workspaces that have been initialized/checked out.
           */
          createWorkspace(): Workspace;
          /**
           * Leaves the branch if working on an active branch then decrements its checkoutCounter
           */
          destroyWorkspace(workspace: Workspace): Promise<void>;
          /**
           * Share resources (URN's) with given user(s)
           * @param in_urns The URNs for the resources
           * @param in_userIds The oxygen user ids which will get policies assigned
           * @param in_groupIds The oxygen group ids which will get policies assigned
           * @param in_options Optional parameters
           */
          share(in_urns: Array<string>, in_userIds: Array<string>, in_groupIds: Array<string>, in_options?: HFDM_share_in_options_TYPE): Promise<any>;
          /**
           * UnShare resources (URN's) with given user(s)
           * @param in_urns The URNs for the resources
           * @param in_userIds The oxygen user ids which will get policies unassigned
           * @param in_groupIds The oxygen group ids which will get policies unassigned
           * @param in_options Optional parameters
           */
          unshare(in_urns: Array<string>, in_userIds: Array<string>, in_groupIds: Array<string>, in_options?: HFDM_unshare_in_options_TYPE): Promise<any>;
          /**
           * Get share info for a specific urn
           */
          getShareInfo(urn: string): Promise<any>;
          /**
           * Creates a new policy for a urn.
           */
          createPolicy(): Promise<any>;
          /**
           * Fetches the repository state and time at which it will expire or be destroyed (if at all).
           * The 'action' and 'when' fields are not returned for live repositories with the 'Persistent' data retention policy.
           */
          getExpiry(urn: string): Promise<{
            state: 'live' | 'expired',
            action?: 'expire' | 'destroy',
            when?: number
          }>;
          /**
           * Sets the retention policy (the expiry) of a repository. All the OSS Retention Policies are supported.
           * This method can also override an existing expiry policy.
           * @param in_urn A repository URN
           * @param in_value The expiry policy to set: 'transient' | 'temporary' | 'persistent' | <delay in seconds from now>
           */
          setExpiry(in_urn:	string, in_value: ExpiryTimeType): Promise<void>;
          /**
           * Deletes a repository and causes the repository to expire immediately.
           *
           * A deleted repository is expired and inaccessible, but not destroyed. The
           * difference between the methods (soft and hard) is the duration of the grace
           * period, which takes effect after the expired state. The assets will then be
           * destroyed after the grace period has ended. Until that happens, it remains
           * possible to undelete the asset.
           * @param in_urn A repository URN
           * @param in_options Optional deletion parameters
           */
          delete(in_urn: string, in_options: HFDM_delete_in_options_TYPE): Promise<any>;
          /**
           * This function restores access to an expired workspace, causing it to become Live again.
           * It also sets the ‘persistent’ policy.
           */
        ...
        class Repository {
          /**
           * The repository manages changes, persistency and collaboration.
           * It contains all commits and branches that have a common ancestor.
           * @param in_params List of parameters
           */
          constructor(in_params: Repository_Repository_in_params_TYPE);
          getMetadata(): any;
          /**
           * Returns the branch node that corresponds to the identifier.
           */
          getBranch(): BranchNode;
          /**
           * Returns the branch with the given name
           */
          getBranchByName(): BranchNode;
          /**
           * Get the list of BranchNodes from the graph
           * @param in_options List of options
           */
          getBranchNodes(in_options?: Repository_getBranchNodes_in_options_TYPE): object | Array<any>;
          /**
           ...
           */
          getCommit(): CommitNode | undefined;
          /**
           * Create a branch from in_parentCommit.
           * @param in_branchMetaData The branch metadata
           * @param in_parentCommit The commit Node we want to branch from.
           * @param in_options The options
           * @param in_branchMetaData The branch metadata
           * @param in_parentCommit The commit Node we want to branch from.
           * @param in_options The options
           */
          protected _branch(in_branchMetaData: Repository__branch_in_branchMetaData_TYPE, in_parentCommit: CommitNode, in_options?: Repository__branch_in_options_TYPE): BranchNode;
          /**
           * Sets a branch to point to the given commit
           */
          protected _resetBranch(): void;
          /**
           * Commit the current pending changes. The new commit node will be
           ...
           * detached head!
           */
          protected _commit(): CommitNode;
          /**
           * Get the root node of the repository commit graph
           */
          getRootNode(): CommitNode;
          /**
           * Set the reference to the HFDM object that created this repository.
           */
          protected _setHFDMObject(): void;
          /**
           * Performs a rebase of a branch onto another branch.
           * @param in_rebaseBranchOrView The branch or view that will be rebased. If only a branch is supplied it will be rebased on the supplied
           ...
           * @param in_ontoCommitOrBranch The commit onto which the branch should be rebased
           * @param in_options Options
           */
          protected _rebase(in_rebaseBranchOrView: BranchIdentifier | CheckoutView, in_ontoCommitOrBranch: CommitOrBranchIdentifier, in_options?: Repository__rebase_in_options_TYPE): boolean;
          /**
           ...
           */
          protected _checkout(): undefined;
          /**
           * Returns a normalized ChangeSet (one that contains no modify operations) that
           * describes the state at the given commit by applying all ChangeSets between the commit
           * and the previous node having a cached Normalized ChangeSet.
           */
          getNormalizedChangeSetForCommitReadOnly(): SerializedChangeSet;
          /**
        ...
        class BaseProperty {
           ...
           */
          protected _getCheckoutView(): CheckoutView;
          /**
        ...
        const PropertyUtils: {
          TypeIdHelper: TypeIdHelperType;
          PathHelper: IPathHelper;
        };
    }
    export = HFDM_NS;
}
