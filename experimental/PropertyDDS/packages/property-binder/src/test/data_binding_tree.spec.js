...
describe("DataBindingTree", function () {
	...
	it("should support array inserts", function () {
		...
		expect(function () {
			tree.insert("a.b.c[-1]", 6);
		}).toThrow();
		expect(function () {
			tree.insert("a.b.c[4]", 6);
		}).toThrow();
		expect(function () {
			tree.insert("a.b.c[4", 6);
		}).toThrow();
	...
	it("should support array removal", function () {
		...
		expect(function () {
			tree.remove("a.b.c[2");
		}).toThrow(); // Invalid path should throw
	...
	it("should support deeply nested arrays ", function () {
		...
		expect(
			tree
				.getNode("Widget5.children[1].children[3].children[1].children[1].children[0]")
				.getValue(),
		).toEqual(5);
	});
	...
	it("should support map/set inserts", function () {
		...
		// Should throw if invalid index provided
		expect(function () {
			tree.insert("a.b.c[missingBracket", 6);
		}).toThrow();
