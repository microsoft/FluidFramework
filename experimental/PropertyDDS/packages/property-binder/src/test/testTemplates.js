...
const EscapingTestTemplate = {
	...
	properties: [
		{
			id: "nested.test",
			properties: [{ id: 'child "with" quotes', typeid: "Test:ChildID-0.0.1" }],
		},
	],
};
