...
export class DataBinding {
    ...
    _registerCallbacksForReferenceProperties(
        ...
        if (PropertyFactory.instanceOf(in_rootProperty, 'Reference', 'single')) {
            ...
            for (let i = 0; i < registeredKeys.length; i++) {
                ...
                let subProperty = (in_rootProperty as any).get(unescapeTokenizedStringForMap(key), RESOLVE_NEVER);
                if (!subProperty) {
                    continue;
                }
    ...
    private _registerCallbacksForSingleReferenceProperty(
        ...
        // @ts-ignore
        let handlerNode = getInNestedObjects.apply(this, [in_referencePropertySubTable].concat(escapeTokenizedPathForMap(tokenizedRegistrySubPath)));
        ...
        if (_.isString(originalReferencedPath) && originalReferencedPath !== '') {
            ...
            if (originalReferencedPath[0] === '/') {
                ...
                let tokenizedReferencedPath = PathHelper.tokenizePathString(originalReferencedPath, referencedPathTokenTypes);
            ...
            let sourceReferencePropertyInfo = handlerNode.__registeredData.sourceReferencePropertyInfo;
    ...
    private _referenceTargetChanged(
        ...
        const handlerNode = getOrInsertDefaultInNestedObjects.apply(this,
            // @ts-ignore
            [in_referencePropertySubTable].concat(escapeTokenizedPathForMap(in_tokenizedRegistrySubPath)).concat({})) as any;
        ...
        if (handlerNode.__registeredData.sourceReferencePropertyInfo) {
            ...
            while (sourceReferencePropertyInfo !== undefined) {
                let referencedPath = sourceReferencePropertyInfo.propertyKey !== undefined ?
    ...
    _handleReferenceModifications(
        ...
        if (operationType === 'insert' || operationType === 'modify') {
            ...
            if (_.isString(in_rootPathOrProperty)) {
                rootProperty = (this._property as ReferenceProperty).resolvePath(in_rootPathOrProperty, RESOLVE_NO_LEAFS)!;
            } else {
            ...
            if (in_context.getSplitTypeID().context === 'single') {
                ...
                let processNestedChangeSetRemove = function(in_nestedChangeSet: string | any[]) {
                    ...
                    for (k = 0; k < in_nestedChangeSet.length; k++) {
                        ...
                        // @ts-ignore
                        referenceInformation = getInNestedObjects.apply(undefined, [in_referencePropertySubTable].concat(escapeTokenizedPathForMap(in_tokenizedPath.concat(currentKey))));
                    ...
                    switch (arrayIterator.opDescription.type) {
                        ...
                        case ArrayChangeSetIterator.types.REMOVE:
                            for (i = 0; i < arrayIterator.opDescription.operation![1]; ++i) {
                                ...
                                // @ts-ignore
                                referenceInformation = getInNestedObjects.apply(undefined, [in_referencePropertySubTable].concat(escapeTokenizedPathForMap(in_tokenizedPath.concat(index))));
                                // we only need to call _handleRemovals if we actually had a reference there (we might have deleted
            ...
            // @ts-ignore
            let referenceInformation = getInNestedObjects.apply(undefined, [in_referencePropertySubTable].concat(escapeTokenizedPathForMap(in_tokenizedPath)));
            if (referenceInformation) {
                this._handleRemovals(
                    in_tokenizedFullPath,
                    in_nestedRegisteredPath,
    ...
    private _handleModifications(
        ...
        let rootTypeid = in_referencedPropertyTypeidHolder ? in_referencedPropertyTypeidHolder.typeid :
        ...
        Utils.getChangesToTokenizedPaths(in_registeredSubPaths,
            ...
            function(this: DataBinding, in_context, in_currentSubPaths, in_currentTokenizedPath, in_contractedSegment) {
                ...
                if (operationType !== 'remove') {
                    ...
                    const that = this;
                    const visitor = function(in_subpathEntry, in_referenceEntry: any | undefined, in_tokenizedPath: any[]) {
                    ...
                    // @ts-ignore
                    const startingRefEntry = getInNestedObjects.apply(this, [in_referencePropertySubTable].concat(escapeTokenizedPathForMap(in_currentTokenizedPath)));
    ...
    _registerOnPath(
        ...
        const callback = in_options.isDeferred ? deferCallback.call(this, in_function as any) : in_function;
        ...
        const handle = createHandle(in_dataBindingConstructor, escapedPaths as any[], filteredOperations, callback);

        // Keep a central list of all the handles, so unregisterAllOnPathListeners can unregister them
        // all.
        const allPathHandles = getOrCreateMemberOnPrototype(in_dataBindingConstructor, '_allPathHandles', []) as any;
     ...
     */
    _registerOnProperty(
        in_dataBindingConstructor: typeof DataBinding, in_path: string, in_operations: Array<string>, in_function: Function, in_options: IRegisterOnPropertyOptions
    ) {
     ...
     * @public
     */
    static registerOnProperty(in_path: string, in_events: Array<string>, in_callback: Function, in_options: IRegisterOnPropertyOptions = {}) {
     ...
     * @public
     */
    static registerOnPath(in_path: Array<string> | string, in_events: Array<string>, in_callback: Function, in_options: IRegisterOnPathOptions = {}) {
     ...
     * @public
     */
    static registerOnValues(in_path: string, in_events: Array<string>, in_callback: Function, in_options: IRegisterOnPathOptions = {}) {
        if (_.isArray(in_path)) {
     ...
     * @hidden
     */
    private static _registerOnValues(this: typeof DataBinding, in_path: string, in_events: Array<string>, in_callback: Function, in_options: any = {}) {
        this.registerOnProperty(in_path, in_events, function(this: DataBinding, propertyOrKey: any, parent: any) {
     ...
     * @hidden
     */
    private static _handleBinding(in_register: Function, in_path: string, in_events: Array<string>, in_callback: Function, in_options = {}) {
 ...
 * @public
 */
export const onValuesChanged = function(_in_path: string, _in_events: Array<string>, _in_options: IRegisterOnPathOptions = {}): Function {
 ...
 * @public
 */
export const onPropertyChanged = function(_in_path: string, _in_events: Array<string>, _in_options: IRegisterOnPathOptions = {}): Function {
 ...
 * @public
 */
export const onPathChanged = function(_in_path: Array<string> | string, _in_events: Array<string>, _in_options: IRegisterOnPathOptions = {}): Function {
