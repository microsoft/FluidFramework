...
(function () {
    ...
    var BaseController = function (in_params) {
        this._logger = ModuleLogger.getLogger(
            in_params.name || "HFDM.ServerUtils.BaseServer"
        );
        this._log = in_params.log || this._logger.info.bind(this._logger);
        this._logError =
            in_params.logError || this._logger.error.bind(this._logger);
    ...
    BaseController.prototype.render = function (
        ...
        if (
            ...
            in_body = {
                errors: [
                    {
                        message:
                            "Bad Request. One or more parameters are malformed or missing.",
                    },
                ],
            };
        ...
        var isWritableType =
            typeof in_body === "string" || in_body instanceof Buffer;
        if (!isWritableType) {
