...
(function () {
    ...
    var Chronometer =
        require("@fluid-experimental/property-common").Chronometer;
    ...
    var S3Store = function (params) {
        ...
        this._params.options.acl =
            this._params.options.acl || "bucket-owner-full-control";
        ...
        this._params.options.signedUrlExpirySec =
            this._params.options.signedUrlExpirySec || 60;
    ...
    var _apiCall = async function (name, params) {
        ...
        this._timingLogger.debug(
            name,
            "Duration:",
            chrono.stop().elapsedMilliSec()
        );
    ...
    var _logQuery = function (name, params) {
        if (this._logger.isLevelEnabled(ModuleLogger.levels.DEBUG)) {
            ...
            this._logger.debug(
                name + " ==> " + JsonUtils.stringify(params, null, 2)
            );
    ...
    S3Store.prototype.exists = function (key) {
        ...
        return _apiCall
            ...
            .then((result) => !!result)
            .catch((error) =>
                error && error.statusCode === HttpStatus.NOT_FOUND
                    ? false
    ...
    S3Store.prototype.getObject = function (key) {
        ...
        return _apiCall
            ...
            .catch(function (error) {
                ...
                that._logger.debug(
                    "getObject failed: " + JSON.stringify(params),
                    error.message
                );
    ...
    S3Store.prototype.putObject = function (key, buffer, tags) {
        ...
        if (this._params.options.serverSideEncryption) {
            params.ServerSideEncryption =
                this._params.options.serverSideEncryption;
        }
