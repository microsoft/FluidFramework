...
function createLocalLoader(packageEntries, deltaConnectionServer, urlResolver, options) {
...
describe("Rebasing", () => {
	...
	function createRandomTests(operations, final, count = 100, startTest = 0, maxOperations = 30) {
