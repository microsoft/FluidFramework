    ...
    describe("Reading nodes", () => {
        describe("Stored inline", () => {
            ...
            describe("With success and no value", () => {
                ...
                it("should return the value", () =>
                    expect(ddbStorage.get(theKey)).to.eventually.eql(
                        undefined
                    ));
        ...
        describe("with store() called twice with small payloads", () => {
            ...
            describe("calling finishWriteBatch", () => {
                ...
                describe("with success in DynamoDB", () => {
                    ...
                    it("should resolve", () =>
                        expect(ddbStorage.finishWriteBatch(createdBatch)).to.be
            ...
            describe("calling finishWriteBatch", () => {
                describe("with an S3 failure", () => {
                    ...
                    before(() => {
                        deleteAllStub = sandbox
                            ...
                            .rejects(
                                new Error(
                                    "S3 API for delete did not cooperate today.  Sorry"
                                )
                            );
                    });
                ...
                describe("with an S3 success", () => {
                    ...
                    describe("with a DynamoDB success", () => {
                        ...
                        it("should resolve", () =>
                            expect(ddbStorage.finishWriteBatch(createdBatch)).to
                                .be.fulfilled);
            ...
            describe("calling finishWriteBatch concurrently with store", () => {
                ...
                it("should throw on the store", () => {
                    return Promise.all([
                        ...
                        expect(() =>
                            ddbStorage.store(aBatch, "some-id", { a: "value" })
                        ).to.throw(
    ...
    describe("deleting nodes", () => {
        ...
        describe("without an S3 reference", () => {
            ...
            describe("failing to read", () => {
                ...
                it("should bubble the error up", () =>
                    expect(ddbStorage.delete(theKey)).to.be.rejectedWith(
                        Error,
                        "Reading failed"
                    ));
            ...
            describe("for a non-existing item", () => {
                ...
                it("should succeed", () =>
                    expect(ddbStorage.delete("notExisting")).to.eventually.eql(
                        undefined
                    ));
