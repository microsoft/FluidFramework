...
describe("Index query tests", function () {
    ...
    describe("with simple indices", () => {
        ...
        const checkIndexQueryResult = async (commitGuid, query, paths) => {
            ...
            const expected = await Fixtures.fetchMaterializedView(
                branchGuid,
                commitGuid,
                headers,
                {
            ...
            let result = await Fixtures.fetchMaterializedView(
                branchGuid,
                commitGuid,
                headers,
                { query }
            ...
            result = await Fixtures.fetchMaterializedView(
                branchGuid,
                commitGuid,
                headers,
                { query }
