...
(function() {
  const _ = require('lodash'),
      DeterministicGuidGenerator = require('../server/utils/deterministic_guid_generator'),
      ...
      stripReversibleChangeSet = require('../server/utils/strip_reversible_changeset'),
      { compareChangeSetBoundaries } = require('./change_set_processing/chunk_change_set'),
      ModuleLogger = require('../server/utils/module_logger'),
