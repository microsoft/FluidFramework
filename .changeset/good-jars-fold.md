...
The `fluid-framework` package now also exports `OldestSupportedClientVersion`, which is required by existing SharedTree codec options exposed through the package.
