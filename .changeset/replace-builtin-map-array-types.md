...
- BubbleBench's shared model contracts now use Fluid-owned iterable types and a minimal read-only collection shape so both Tree arrays and native arrays remain compatible
