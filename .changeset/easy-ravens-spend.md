...
"__section": fix
---
Add and correct MSG error constants

Several error constants referenced in other PropertyDDS packages did not exist and would produce errors with "undefined".
In the past:
