...
1. Run `npm run start` from this directory (examples/data-objects/clicker-react/clicker-function) and open <http://localhost:8080> in a web browser to see the app running.
