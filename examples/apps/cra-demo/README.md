...
`Fluid` gives you access to methods to boostrap a new Fluid [container](https://fluidframework.com/docs/glossary/#container) and attach [DataObjects](https://fluidframework.com/docs/glossary/#dataobject) to it.
