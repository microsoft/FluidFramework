...
const SpacesEditButton: React.FC<ISpacesEditButtonProps> = (props: React.PropsWithChildren<ISpacesEditButtonProps>) => (
    <button
...
const SpacesEditPane: React.FC<ISpacesEditPaneProps> = (props: React.PropsWithChildren<ISpacesEditPaneProps>) => {
    return (
...
const SpacesItemView: React.FC<ISpacesItemViewProps> = (props: React.PropsWithChildren<ISpacesItemViewProps>) => {
...
export const SpacesStorageView: React.FC<ISpacesStorageViewProps> = (
    ...
    const [itemMap, setItemMap] = React.useState<Map<string, ISpacesStoredItem<AsSerializable<any>>>>(
