...
export { SpacesObject as SpacesExample, SpacesContainer };
...
async function start() {
    ...
    const container = await getTinyliciousContainer(documentId, SpacesContainer, createNew);

    // Get the Default Object from the Container
    const defaultObject = await getDefaultObjectFromContainer<SpacesObject>(container);
