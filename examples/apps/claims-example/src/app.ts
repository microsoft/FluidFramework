...
import {
	ClaimsExampleContainerRuntimeFactory,
	type IClaimsDataObject,
} from "./container/index.js";
import { ClaimsView } from "./view.js";
...
const codeLoader: ICodeDetailsLoader = {
	load: async (details: IFluidCodeDetails): Promise<IFluidModuleWithDetails> => {
		return {
			module: { fluidExport: new ClaimsExampleContainerRuntimeFactory() },
			details,
		};
	},
};
...
appRoot.render(createElement(ClaimsView, { claimsDataObject }));
