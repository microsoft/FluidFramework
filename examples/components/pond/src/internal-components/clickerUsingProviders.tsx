 ...
 */
export class ClickerUsingProviders
    extends PrimedComponent<IComponentUserInformation & IComponentRegistry>
    implements IComponentHTMLView
{
    ...
    private static readonly factory = new PrimedComponentFactory(
        ...
        {IComponentUserInformation, IComponentRegistry},
        {},
    );
}
...
//     counter: Counter;
//     userInfo: IComponentUserInformation;
// }
