...
1. Run `npm start` from this directory (examples/hosts/app-integration/container-views) and open <http://localhost:8080> in a web browser to see the app running.
