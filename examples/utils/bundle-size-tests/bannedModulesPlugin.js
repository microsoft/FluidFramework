...
exports.BannedModulesPlugin = void 0;
...
class BannedModulesPlugin {
    ...
    apply(compiler) {
        ...
        compiler.hooks.done.tap(pluginName, (stats) => {
            var _a;
            (_a = stats.toJson().modules) === null || _a === void 0 ? void 0 : _a.forEach((mod) => {
            ...
            if (foundBannedModules.size > 0) {
                ...
                foundBannedModules.forEach((issuerPaths, bannedModule) => {
                    ...
                    issuerPaths.forEach((issuerPathJson) => {
                        errorMessage += `\t\tIssuer: \n`;
                        const pathSegments = JSON.parse(issuerPathJson);
...
exports.BannedModulesPlugin = BannedModulesPlugin;
