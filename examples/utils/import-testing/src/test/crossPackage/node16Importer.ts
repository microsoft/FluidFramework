...
invalid import paths. Fixing tree's exports (giving each tier its own JS entrypoint)
will resolve these — at which point the @ts-expect-error lines should be removed.
*/
