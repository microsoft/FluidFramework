...
import {
	...
	// eslint-disable-next-line import/no-internal-modules, import-x/no-internal-modules -- #26986: `fluid-static` internal used in examples
} from "@fluidframework/fluid-static/internal";
// eslint-disable-next-line import/no-internal-modules, import-x/no-internal-modules -- #26987: `local-driver` internal used in examples
...
// eslint-disable-next-line import/no-internal-modules, import-x/no-internal-modules -- This is the pattern prescribed by React
...
async function createContainerAndRenderInElement(
	...
	if (createNewFlag) {
		appModel = await initializeAppForNewContainer(fluidContainer);
		await attach?.();
	} else {
