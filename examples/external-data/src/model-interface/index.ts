...
export interface IAppModelEvents extends IEmitter {}

/**
 * For this simple demo, our app model only needs a single member taskList.
 */
export interface IAppModel extends Listenable<IAppModelEvents> {
	/**
 ...
 */
export interface ITask extends Listenable<ITaskEvents> {
	/**
 ...
 */
export interface ITaskListEvents {
	/**
	 * Emitted when a draft task is added.
	 */
	draftTaskAdded: (task: ITask) => void;
	/**
	 * Emitted when a draft task is removed.
	 */
	draftTaskDeleted: (task: ITask) => void;
}
 ...
 */
export interface ITaskList extends Listenable<ITaskListEvents> {
	/**
 ...
 */
export interface IBaseDocumentEvents {
	/**
	 ...
	 */
	leaderChanged: (newLeader: string) => void;
}
 ...
 */
export interface IBaseDocument extends Listenable<IBaseDocumentEvents> {
	/**
