...
<!-- To modify this table, edit `packages/test/test-version-utils/src/checkpoints.ts` then run `pnpm -r --filter @fluid-private/test-version-utils run update-compat-versions` -->

<!-- prettier-ignore -->
| Checkpoint | Version Range | Start Date | Compatible Checkpoints | Compatible Semantic Versions |
| --- | --- | --- | --- | --- |
| CC#1 | `>=1.4.0 <2.0.0 \| 2.0.0-internal* \| 2.0.0-rc*` | 2024-04-09 | CC#1, CC#2, CC#3, CC#4 | `>=1.4.0 <3.0.0`` \| 2.0.0-internal* \| 2.0.0-rc*` |
...
| CC#4 | `>=2.80.0 <3.0.0` | 2026-01-06 | CC#1, CC#2, CC#3, CC#4, CC#5, CC#6, CC#7 | `>=1.4.0 <6.0.0`(estimated)` \| 2.0.0-internal* \| 2.0.0-rc*` |
| CC#5 | `>=3.0.0 <4.0.0`(estimated) | 2026-09-03 | CC#2, CC#3, CC#4, CC#5, CC#6, CC#7 | `>=2.0.0 <6.0.0`(estimated) |
