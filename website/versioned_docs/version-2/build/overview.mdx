...
For more information about these types and the differences between them, see [Data modeling](./data-modeling.mdx) and [Introducing distributed data structures](./dds.mdx).
