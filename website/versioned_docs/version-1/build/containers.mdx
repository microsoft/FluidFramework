...
A container is represented by the <ApiLink package="fluid-static" api="IFluidContainer">FluidContainer</ApiLink> type and consists of a collection of shared objects and APIs to manage the life cycle of those objects.
...
For example, the [Tinylicious library](/docs/testing/tinylicious) provides <PackageLink package="tinylicious-client">these APIs</PackageLink> for the Tinylicious Fluid service.
