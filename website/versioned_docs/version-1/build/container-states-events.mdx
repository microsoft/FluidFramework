...
Your code can test for the publication status with the <ApiLink package="fluid-static" api="IFluidContainer.attachState">container.AttachState</ApiLink> property which has an <ApiLink package="container-definitions" api="AttachState">AttachState</ApiLink> value.
...
-   A <ApiLink package="fluid-static" api="IFluidContainer.connectionState">container.connectionState</ApiLink> property of type `ConnectionState`. There are four possible values for the property:
