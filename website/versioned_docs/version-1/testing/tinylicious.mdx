...
You can use TinyliciousClient to create and load Fluid containers with Tinylicious. Check out the [DiceRoller tutorial](../start/tutorial) for an example setting up the Tinylicious client and server.
