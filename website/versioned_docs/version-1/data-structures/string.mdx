...
{/_ It might be worth adding a section about Tile markers and their use: setting ReferenceType.Tile and putting a label on [reservedTileLabelsKey] allows
efficient spatial querying of the nearest Marker to a given position. _/}

{/* markdown-magic:begin {"transform":"include","path":"../../../../packages/dds/sequence/README.md","start":612,"end":627} */}
