...
:::caution[Use SharedTree for new applications]

Use [SharedTree](/docs/data-structures/tree/index.mdx) instead of sequence distributed data structures for new applications.

:::

{/* markdown-magic:begin {"transform":"include","path":"../../../../packages/dds/sequence/README.md","start":40,"end":531} */}
...
Its main export is [SharedString](https://github.com/microsoft/FluidFramework/blob/main/packages/dds/sequence/src/sharedString.ts), a DDS for storing and simultaneously editing a sequence of text.
...
serializable data and have the same merge behavior as a [SharedMap](https://fluidframework.com/docs/data-structures/map/) (last writer wins). Annotate takes a start and end
...
See the [SharedString examples](./string.mdx#examples).
