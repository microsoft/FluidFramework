...
-   Add the missing <ApiLink package="container-loader" api="ConnectionState" /> export to `fluid-framework`

## @fluidframework/azure-client

-   Fix <ApiLink package="azure-client" api="AzureClient" /> issue where the second user could not connect in `local` mode
...
-   <ApiLink package="azure-client" api="AzureClient.getContainerVersions">
    	`getContainerVersions(id, options)`
    </ApiLink>
-   <ApiLink package="azure-client" api="AzureClient.copyContainer">
