...
The <ApiLink packageName="fluid-framework" apiName="Tree" apiType="Variable">`Tree`</ApiLink> singleton provides <ApiLink packageName="fluid-framework" apiName="TreeNodeApi">APIs for working with nodes</ApiLink>
