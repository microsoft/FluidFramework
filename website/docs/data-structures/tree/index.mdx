...
The `SharedTree` distributed data structure (DDS) stores your application's shared data in a hierarchical structure.
...
For a comprehensive view of the `SharedTree` package's API documentation, see <PackageLink package="fluid-framework">the `fluid-framework` API docs</PackageLink>.
