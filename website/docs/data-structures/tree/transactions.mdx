...
Transactions are started via [runTransaction](../../api/fluid-framework/treebranchalpha-interface#runtransaction-methodsignature) on any [UntypedTreeViewAlpha](../../api/fluid-framework/treebranchalpha-interface)

```typescript
import { TreeAlpha } from "@fluidframework/tree/alpha";

// Looking up the context for a node:
