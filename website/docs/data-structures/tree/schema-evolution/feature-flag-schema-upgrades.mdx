...
- <ApiLink packageName="fluid-framework" apiName="TreeViewAlpha" apiType="Interface" headingId="upgradeschema-methodsignature">`upgradeSchema()`</ApiLink> includes them when upgrading an existing document.
