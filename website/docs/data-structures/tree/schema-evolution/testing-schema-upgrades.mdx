...
- **Combine with** <ApiLink package="fluid-framework" api="snapshotSchemaCompatibility">**`snapshotSchemaCompatibility`**</ApiLink> tests to catch regressions when your schema changes across releases.
