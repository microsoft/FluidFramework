...
- **Combine with** <ApiLink packageName="fluid-framework" apiName="snapshotSchemaCompatibility">**`snapshotSchemaCompatibility`**</ApiLink> tests to catch regressions when your schema changes across releases.
