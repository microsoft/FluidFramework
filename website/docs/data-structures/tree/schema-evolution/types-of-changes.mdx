...
Writing a test using <ApiLink packageName="fluid-framework" apiName="snapshotSchemaCompatibility">`snapshotSchemaCompatibility`</ApiLink> is highly recommended to ensure any schema changes maintain your compatibility requirements.
...
To ensure [forwards compatibility](./index.mdx#understanding-compatibility), use <ApiLink packageName="fluid-framework" apiName="ObjectSchemaOptions.allowUnknownOptionalFields">`allowUnknownOptionalFields`</ApiLink> to handle new optional fields added by newer clients.
