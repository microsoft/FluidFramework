...
Your code can test for the publication status with the <ApiLink package="fluid-framework" api="IFluidContainer.attachState">container.AttachState</ApiLink> property which has an <ApiLink package="fluid-framework" api="AttachState">AttachState</ApiLink> value.
...
-   A <ApiLink package="fluid-framework" api="IFluidContainer.connectionState">container.connectionState</ApiLink> property of type `ConnectionState`. There are four possible values for the property:
