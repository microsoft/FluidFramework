...
The `"2.0.0"` argument specifies the oldest Fluid Framework client version that the application supports collaborating with.
New applications should specify the highest version supported by every collaborating client.
