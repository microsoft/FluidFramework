...
In Fluid Framework 2.x, the <ApiLink packageName="azure-client" apiName="AzureClient.createContainer">createContainer</ApiLink> and getContainer APIs on <PackageLink packageName="azure-client">AzureClient</PackageLink> and <PackageLink packageName="tinylicious-client">TinyliciousClient</PackageLink> have a new parameter compatibilityMode which may be set to "1" or "2".
