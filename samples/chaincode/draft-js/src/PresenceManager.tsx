...
export const getCoauthPresenceDecorator = (presenceManager: PresenceManager) => {
  const CoauthorIndicator = (props) => {
    ...
    // Replace the placeholder char with some UI
    // If this block is empty (except for the placeholder char) add a <br /> after because that's what Draft
    // does to preserve spacing in empty blocks, and we're turning this into an empty block by removing the placeholder.
    return <>
