...
export class Runtime extends EventEmitter implements IHostRuntime {
    ...
    // I think we don't need the following two things.
    private async prepareOperation(message: ISequencedDocumentMessage, local: boolean): Promise<ISequencedDocumentMessage> {
        return message;
    }
