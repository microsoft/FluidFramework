...
export class Model implements BaseModel {
    ...
    // public saveAuthorizationCode(code: OAuth2Server.AuthorizationCode, client: OAuth2Server.Client, user: OAuth2Server.User, callback?: (err?: any, result?: OAuth2Server.AuthorizationCode) => void): Promise<OAuth2Server.AuthorizationCode> {
    //     throw new Error("Method not implemented.");
    // }

    // public generateRefreshToken?(client: OAuth2Server.Client, user: OAuth2Server.User, scope: string, callback?: (err?: any, result?: string) => void): Promise<string> {
    //     throw new Error("Method not implemented.");
    // }

    // public generateAuthorizationCode?(client: OAuth2Server.Client, user: OAuth2Server.User, scope: string, callback?: (err?: any, result?: string) => void): Promise<string> {
    //     throw new Error("Method not implemented.");
    // }

    // public validateScope?(user: OAuth2Server.User, client: OAuth2Server.Client, scope: string, callback?: (err?: any, result?: string | false | 0) => void): Promise<string | false | 0> {
    //     throw new Error("Method not implemented.");
    // }

    // public verifyScope(token: Token, scope: string, callback?: (err?: any, result?: boolean) => void): Promise<boolean> {
    //     throw new Error("Method not implemented.");
    // }
}
