...
Benchmark commands and output contracts are documented by the relevant harness. For the Rust snapshotted-stream harness, see [`../crates/benchmarks/README.md`](../crates/benchmarks/README.md). SharedTree evidence is produced by the benchmark tooling outside this directory and reviewed before retention.
...
```bash
node scripts/check-documentation.mjs benchmarks
```
