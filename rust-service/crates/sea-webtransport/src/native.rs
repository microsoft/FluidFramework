...
use crate::{
    CLOSE_CODE, TransportConfig, WebTransportError, connect_once, protocol, read_sea_stream_frame,
    read_sea_unary_frame, transport_error, write_frame,
};
...
impl NativeSeaClient {
    ...
    fn ensure_open(&self) -> Result<(), SeaClientError> {
