...
Snapshot coordination and content operations use their own authority-bound persistent streams.
Native and browser clients use the same frame codec, correlation, lifecycle, and logical-stream state machines.
