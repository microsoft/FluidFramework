...
See [`src/lib.rs`](src/lib.rs) for the format implementation and corruption tests. Shared laws come from [`../snapshotted-stream-conformance`](../snapshotted-stream-conformance/README.md).
