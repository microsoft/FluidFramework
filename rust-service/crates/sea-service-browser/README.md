...
This WASM-only crate adapts a memory-backed native Fluid service to the JavaScript transport contract consumed by `InjectedClient` in [`fluid-webtransport-browser`](../fluid-webtransport-browser/README.md).
