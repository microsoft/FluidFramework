...
This WASM-only crate adapts a memory-backed Sea service to the JavaScript transport contract consumed by `InjectedClient` in [`sea-webtransport-browser`](../sea-webtransport-browser/README.md).
