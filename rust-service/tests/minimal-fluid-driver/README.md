...
This harness adapts clients generated by `sea-webtransport` to the transport-neutral `SeaDriverClient` contract.
It owns generated WebAssembly (WASM) builds, local and browser transport setup, integration tests, and benchmarks.
