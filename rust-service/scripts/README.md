...
- [`check-documentation.mjs`](check-documentation.mjs) verifies README coverage and local Markdown links for supplied roots or this workstream's owned roots by default.
