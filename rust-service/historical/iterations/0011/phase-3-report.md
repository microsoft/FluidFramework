...
- **Tooling convergence:** improved. Absolute checkout guards reduce wrong-worktree evidence, and SharedTree typechecking passes against the root client workspace dependency graph. Isolated worktrees still require their own complete root workspace install before this check can run.
