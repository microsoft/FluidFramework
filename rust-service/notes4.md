...
This document sketches a target network protocol for the [native WebTransport adapter](crates/wrappers/webtransport-native/) and the [`fluid-sequencer`](crates/fluid-sequencer/).
