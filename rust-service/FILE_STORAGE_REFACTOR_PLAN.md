...
Keep stored-content deduplication in memory and preserve normal input validation; weak crash guarantees are not permission to reorder records or accept missing dependencies during healthy operation.
