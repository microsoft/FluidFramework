...
| Packages | Layer Dependencies |
| --- | --- |
| - [@fluid-internal/mock-logger](/packages/utils/mock-logger) (private)</br>- [@fluidframework/telemetry-utils](/packages/utils/telemetry-utils) | - [Base-Definitions](#Base-Definitions)</br>- [Base-Utils](#Base-Utils) |
