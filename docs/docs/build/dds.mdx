...
There are a number of shared objects built into the Fluid Framework. See [Distributed data structures](../data-structures/overview.mdx) for more information.
...
[documentation for each DDS](../data-structures/overview.mdx) for more details about the merge
strategy it uses.
...
-   [Fluid Framework architecture](../concepts/architecture.mdx)
...
see [Fluid handles](../concepts/handles.mdx).
...
-   Map nodes in a [SharedTree][] -- a hierarchical data structure with three kinds of complex nodes; maps (similar to [SharedMap][]), arrays, and JavaScript objects. There are also several kinds of leaf nodes, including boolean, string, number, null, and [Fluid handles](../concepts/handles.mdx).

### Array-like data

-   Array nodes in a [SharedTree][] -- a hierarchical data structure with three kinds of complex nodes; maps (similar to [SharedMap][]), arrays, and JavaScript objects. There are also several kinds of leaf nodes, including boolean, string, number, null, and [Fluid handles](../concepts/handles.mdx).

### Object data

-   Object nodes in a [SharedTree][] -- a hierarchical data structure with three kinds of complex nodes; maps (similar to [SharedMap][]), arrays, and JavaScript objects. There are also several kinds of leaf nodes, including boolean, string, number, null, and [Fluid handles](../concepts/handles.mdx).
