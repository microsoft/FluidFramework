...
<img src="https://fluidframework.blob.core.windows.net/static/assets/consoleLogger_telemetry_in_action.png" alt="The ConsoleLogger sends telemetry events to the browser console for display." />
...
![A screenshot of how to enable the Verbose logging level in the console](/assets/verbose-log-level.png)
