...
![A screenshot showing container information](https://fluidframework.blob.core.windows.net/static/assets/container_info.png)
...
![A screenshot showing container state changes](https://fluidframework.blob.core.windows.net/static/assets/container_states.png)
...
![A screenshot showing container data visualization](https://fluidframework.blob.core.windows.net/static/assets/container_data_viz.png)
...
![A screenshot showing container audience information](https://fluidframework.blob.core.windows.net/static/assets/container_audience_states.png)
...
![A screenshot showing container event logs](https://fluidframework.blob.core.windows.net/static/assets/container_events.png)
...
![A screenshot showing container latency telemetry](https://fluidframework.blob.core.windows.net/static/assets/container_latency.png)
