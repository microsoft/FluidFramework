...
const schemaA = SchemaFactoryBeta.optional([SchemeFactoryBeta.number]);
...
const schemaB = SchemeFactoryBeta.optional(SchemeFactoryBeta.types([
    SchemaFactoryBeta.number,
    SchemaFactoryBeta.staged(SchemeFactoryBeta.string),
]));
```
