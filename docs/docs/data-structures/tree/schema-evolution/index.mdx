...
When talking about compatibility, we're mainly concerned with:

- the ability of an app to load documents created or edited by earlier versions of the app
- the ability of an app to load documents created or edited by later versions of the app
...
When you make changes to your schema, you can upgrade existing documents to use the new schema using [`view.upgradeSchema()`](../../../api/fluid-framework/treeview-interface#upgradeschema-method):
