---
title: Same Compatibility Policies
sidebar_position: 3
---
...
## Policy 1: Enforce Exact Schema Match
...
- Deployment coupling: Schema changes require coordinated roll-outs
...
**Disadvantages:**
- Data loss risk: Old clients may lose optional field data during edits
...
if (view.compatibility.canUpgrade) {
    [`view.upgradeSchema()`](../../../api/fluid-framework/treeview-interface#upgradeschema-method);
}
