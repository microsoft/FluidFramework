...
![Logs on App Insights Portal](https://storage.fluidframework.com/static/assets/telemetry_1.png)
...
![Query result](https://storage.fluidframework.com/static/assets/telemetry_2.png)
...
![Total sessions over time period](https://storage.fluidframework.com/static/assets/telemetry_3.png)
...
![Average number of sessions over time period](https://storage.fluidframework.com/static/assets/telemetry_4.png)
...
![Average number of containers per session over time period](https://storage.fluidframework.com/static/assets/telemetry_5.png)
...
![Length of Individual Sessions in Minutes](https://storage.fluidframework.com/static/assets/telemetry_6.png)
...
1. Adjusting the date span of the query
    ...
    ![Adjusting date](https://storage.fluidframework.com/static/assets/telemetry_time_period.png)
