...
const apiReportsDirectoryPath = path.resolve(__dirname, "..", "_api-extractor-temp-lts", "_build");
const apiDocsDirectoryPath = path.resolve(__dirname, "..", "content", "docs", "apis-lts");
...
async function renderApiDocumentation() {
	...
	console.log("processing api reports");
