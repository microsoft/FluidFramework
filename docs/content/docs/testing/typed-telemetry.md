...
![Query result](images/telemetry_2.png)
...
![Total sessions over time period](images/telemetry_3.png)
...
![Average number of sessions over time period](images/telemetry_4.png)
...
![Average number of containers per session over time period](images/telemetry_5.png)
...
![Length of Individual Sessions in Minutes](images/telemetry_6.png)
