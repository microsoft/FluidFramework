...
[Packages](/docs/apis/) &gt; [@fluidframework/routerlicious-driver](/docs/apis/routerlicious-driver) &gt; [ITokenProvider](/docs/apis/routerlicious-driver/itokenprovider-interface)
...
<table class="table table-striped table-hover">
  ...
  <tbody>
    <tr>
      <td>
        <a href='/docs/apis/routerlicious-driver/itokenprovider-interface#documentpostcreatecallback-methodsignature'>documentPostCreateCallback</a>
      </td>
      <td>
        <code>optional</code>
      </td>
    ...
    <tr>
      <td>
        <a href='/docs/apis/routerlicious-driver/itokenprovider-interface#fetchorderertoken-methodsignature'>fetchOrdererToken</a>
      </td>
      <td>
      </td>
      <td>
    ...
    <tr>
      <td>
        <a href='/docs/apis/routerlicious-driver/itokenprovider-interface#fetchstoragetoken-methodsignature'>fetchStorageToken</a>
      </td>
      <td>
      </td>
      <td>
...
\* Any exceptions thrown in the callback would fail the creation workflow (see [createContainer](/docs/apis/routerlicious-driver/routerliciousdocumentservicefactory-class#createcontainer-method) for more details).
