...
[Packages](/docs/apis/) &gt; [@fluidframework/sequence](/docs/apis/sequence) &gt; [IntervalIndex](/docs/apis/sequence/intervalindex-interface)
...
<table class="table table-striped table-hover">
  ...
  <tbody>
    <tr>
      <td>
        <a href='/docs/apis/sequence/intervalindex-interface#add-methodsignature'>add</a>
      </td>
      <td>
        <span>void</span>
      </td>
    ...
    <tr>
      <td>
        <a href='/docs/apis/sequence/intervalindex-interface#remove-methodsignature'>remove</a>
      </td>
      <td>
        <span>void</span>
      </td>
