...
[Packages](/docs/apis/) &gt; [@fluid-experimental/tree](/docs/apis/tree) &gt; [NodeIdGenerator](/docs/apis/tree/nodeidgenerator-interface)
...
<table class="table table-striped table-hover">
  ...
  <tbody>
    <tr>
      <td>
        <a href='/docs/apis/tree/nodeidgenerator-interface#generatenodeid-methodsignature'>generateNodeId</a>
      </td>
      <td>
