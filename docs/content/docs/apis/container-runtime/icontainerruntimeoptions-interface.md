...
<table class="table table-striped table-hover">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <p>
          If the op payload needs to be chunked in order to work around the maximum size of the batch, this value represents how large the individual chunks will be. This is only supported when compression is enabled. If after compression, the batch size exceeds this value, it will be chunked into smaller ops of this size.
        </p>
        <p>
          If unspecified, if a batch exceeds <code>maxBatchSizeInBytes</code> after compression, the container will close with an instance of <code>GenericError</code> with the <code>BatchTooLarge</code> message.
        </p>
        <p>
          Not ready for use.
        </p>
...
### enableRuntimeIdCompressor {#enableruntimeidcompressor-propertysignature}
