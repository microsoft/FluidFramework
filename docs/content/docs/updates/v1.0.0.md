...
```js
import { ConnectionState } from "fluid-framework/internal";
...
import { LOCAL_MODE_TENANT_ID } from "@fluidframework/azure-client/internal";
const connection = {
...
```js
// New Remote Syntax
import { AzureRemoteConnectionConfig } from "@fluidframework/azure-client/internal";
...
// New Local Syntax
import { AzureLocalConnectionConfig } from "@fluidframework/azure-client/internal";
