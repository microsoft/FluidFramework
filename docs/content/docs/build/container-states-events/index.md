...
Your code can test for the publication status with the [container.AttachState]({{< relref "/docs/api/v1/fluid-static/ifluidcontainer-interface.md#attachstate-property" >}}) property which has an [AttachState]({{< relref "/docs/api/v1/container-definitions.md#attachstate-enum" >}}) value.
...
-   A [container.connectionState]({{< relref "/docs/api/v1/fluid-static/ifluidcontainer-interface.md#connectionstate-propertysignature" >}}) property of type `ConnectionState`. There are four possible values for the property:
