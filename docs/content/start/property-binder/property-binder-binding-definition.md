...
Delaying the activation of *DataBindings* is mostly useful when the application needs to activate a number of
...
Note that when a call to [activateDataBinding()]({{< ref
