_Note: this is currently only enforced for the build-tools release group. But you can follow this style elsewhere!_

We use the [conventional commit format](https://conventionalcommits.org/) in the build-tools release group. This lets us autogenerate changelogs and more easily write release notes.
