...
Please go to the [repo](https://github.com/microsoft/FluidFramework) and click "Fork". Then choose your personal account.
...
You can also optionally set a different branch to track the official repo, if you'd like to keep your personal `main` separate. But you will need to remember to merge with that branch prior to submitting any changes to the official repo.
...
Alternatively, you can also navigate to [Pull Requests](https://github.com/microsoft/FluidFramework/pulls). Here, click "New Pull Request" and you will see this.
