...
1. **Builds the site** using the PR changes and the latest API reference docs.
    ...
    Source: [/.github/workflows/website-validation.yml#L14-L34](https://github.com/microsoft/FluidFramework/tree/main/.github/workflows/website-validation.yml#L14-L34)
...
2. Checks the built site for **broken internal links**. Internal means links within the site itself. Links to other sites are not checked.
    ...
    Source: [.github/workflows/website-validation.yml#L36-L61](https://github.com/microsoft/FluidFramework/tree/main/.github/workflows/website-validation.yml#L36-L61)
...
Source: [.github/workflows/linkcheck-reporter.yml](https://github.com/microsoft/FluidFramework/tree/main/.github/workflows/linkcheck-reporter.yml)
