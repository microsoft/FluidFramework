...
const links: CommunityLinkItem[] = [
	{
	  ...
	  description: (
		<>
			We welcome code and documentation contributions from the community.
		</>
	  ),
	...
	},
	{
	  ...
	  Icon: require('@site/static/img/community-discussion.svg').default,
	  description: (
		<>
			Our GitHub Discussions are a great way to participate. Feel free to ask questions or, if you can, give us a hand by answering some.
		</>
	  ),
	...
	{
	  title: 'Report Issues',
	  Icon: require('@site/static/img/community-report-issues.svg').default,
	  description: (
		<>
			Found something not working as expected? Please file a GitHub issue, so we can take a look together.
		</>
	  ),
