...
const openSourceText = "We believe that an open, inclusive, and respectful community will help shape a better future for this project. That's why Fluid Framework is made available for FREE as an Open Source project under the MIT license.";
...
function KeyFeatureCard(props: { imageSrc: string; imageAltText: string; bodyLabel: string; bodyText: string; footerHref: string; }): JSX.Element {
	return <div className="keyFeatureCard">
		<KeyFeatureImage src={props.imageSrc} alt={props.imageAltText} />
		<KeyFeatureCardContents label={props.bodyLabel} text={props.bodyText} href={props.footerHref} />
	</div>;
}

function KeyFeatureImage(props: { src: string, alt: string }): JSX.Element {
	return <div className="keyFeatureCardImageContainer">
...
function KeyFeatureCardContents(props: { label: string; text: string; href: string }): JSX.Element {
	return (<div className="keyFeatureCardContents">
...
function KeyFeatureCardBody(props: { label: string; text: string }): JSX.Element {
	return (<div className="keyFeatureCardBody">
...
function KeyFeatureCardFooter(props: { href: string }): JSX.Element {
	return (<div className="keyFeatureCardFooter">
		<div className="keyFeatureCardFooterContent">
			<div className="keyFeatureCardFooterLink">
				<div className="keyFeatureCardFooterLinkButton">
					{">"}
				</div>
